...
// Function for MATLAB Function: '<S60>/Apply Differential Correction Mask1'
void DDRTCM::DDRTCM_do_vectors_lj(const uint16_T a_data[], const int32_T *a_size,
...
void DDRTCM::DDRTCM_binary_expand_op_fpl(real_T in1_data[], int32_T *in1_size,
...
void DDRTCM::DDRTCM_binary_expand_op_fp(real_T in1_data[], int32_T *in1_size,
  const GNSS_Measurement *in2, const int32_T in4_data[], const int32_T *in4_size,
  const real_T in5[40], const int32_T in7_data[], const int32_T *in7_size)
{
  int32_T loop_ub;
...
//    '<S187>/Apply Differential Correction Mask1'
//
void DDRTCM::ApplyDifferentialCorrectionMask(const GNSS_Measurement
  ...
  *localDW)
{
  ...
  *rty_MeasurementCorrected = true;
  if ((*rtu_diffCorrAvailableSvidS1_DIM > 3) && rtu_enableDiffCorrection) {
    int32_T tmp;
    DDRTCM_do_vectors_lj(rtu_diffCorrAvailableSvid,
    ...
    if (iib_size == iia_size) {
      ...
      DDRTCM_binary_expand_op_fpl(localB->tmp_data,
    ...
    if (iib_size == iia_size) {
      ...
      DDRTCM_binary_expand_op_fp(localB->tmp_data,
        &rtu_GpsMeasurementBus_DIMS1_idx, rtu_GpsMeasurementBus,
        localB->iib_data, &iib_size, rtu_diffPseudorangeCorrections,
        localB->iia_data, &iia_size);
    }
