...
//
// File: CalculateDifferentialCorrecti_f.cpp
//
...
#include "CalculateDifferentialCorrecti_f.h"

// Function for MATLAB Function: '<S75>/Calculate Differential Corrections'
void DDRTCM::DDRTCM_merge_b(int32_T idx_data[], uint16_T x_data[], int32_T
  offset, int32_T np, int32_T nq, int32_T iwork_data[], uint16_T xwork_data[],
...
// Function for MATLAB Function: '<S75>/Calculate Differential Corrections'
void DDRTCM::DDRTCM_sort_a(uint16_T x_data[], const int32_T *x_size, int32_T
  idx_data[], int32_T *idx_size, B_CalculateDifferentialCorr_b_T *localB)
{
  localB->dim = 0;
  if (*x_size != 1) {
    localB->dim = -1;
  ...
  *idx_size = *x_size;
  ...
  for (localB->dim = 0; localB->dim < localB->vstride_o; localB->dim++) {
    for (localB->nDone = 0; localB->nDone <= localB->b; localB->nDone++) {
      localB->vwork_data[localB->nDone] = x_data[localB->nDone *
        localB->vstride_o + localB->dim];
    }

    localB->b_x_size = localB->vwork_size_idx_0;
    if (localB->vwork_size_idx_0 - 1 >= 0) {
      std::memcpy(&localB->b_x_data[0], &localB->vwork_data[0],
                  static_cast<uint32_T>(localB->vwork_size_idx_0) * sizeof
                  (uint16_T));
    }

    localB->nLeft = static_cast<int8_T>(localB->vwork_size_idx_0);
    if (localB->nLeft - 1 >= 0) {
      std::memset(&localB->b_idx_data[0], 0, static_cast<uint32_T>(localB->nLeft)
                  * sizeof(int32_T));
    }
    ...
    if (localB->vwork_size_idx_0 != 0) {
      localB->nLeft = static_cast<int8_T>(localB->vwork_size_idx_0);
      if (localB->nLeft - 1 >= 0) {
        std::memset(&localB->b_idx_data[0], 0, static_cast<uint32_T>
                    (localB->nLeft) * sizeof(int32_T));
      }
      ...
      for (localB->nLeft = 0; localB->nLeft < localB->nQuartets_tmp;
           localB->nLeft++) {
        uint16_T x4_tmp;
        uint16_T x4_tmp_0;
        uint16_T x4_tmp_1;
      ...
      if (localB->vwork_size_idx_0 > 1) {
        ...
        std::memset(&localB->vwork_data[0], 0, static_cast<uint32_T>
                    (localB->vwork_size_idx_0) * sizeof(uint16_T));
        ...
        while (localB->nLeft > 1) {
          if ((static_cast<uint32_T>(localB->nLeft) & 1U) != 0U) {
            ...
            if (localB->b_i > localB->nDone) {
              DDRTCM_merge_b(localB->b_idx_data, localB->b_x_data, localB->i1_b,
                             localB->nDone, localB->b_i - localB->nDone,
                             localB->iwork_data, localB->vwork_data, localB);
            }
          }
          ...
          for (localB->i1_b = 0; localB->i1_b < localB->nLeft; localB->i1_b++) {
            DDRTCM_merge_b(localB->b_idx_data, localB->b_x_data, localB->i1_b *
                           localB->b_i, localB->nDone, localB->nDone,
                           localB->iwork_data, localB->vwork_data, localB);
          }
        ...
        if (localB->vwork_size_idx_0 > localB->nDone) {
          DDRTCM_merge_b(localB->b_idx_data, localB->b_x_data, 0, localB->nDone,
                         localB->vwork_size_idx_0 - localB->nDone,
                         localB->iwork_data, localB->vwork_data, localB);
        }
      }
    ...
    if (localB->nLeft - 1 >= 0) {
      std::memcpy(&localB->vwork_data[0], &localB->b_x_data[0],
                  static_cast<uint32_T>(localB->nLeft) * sizeof(uint16_T));
    }
...
// Function for MATLAB Function: '<S75>/Calculate Differential Corrections'
void DDRTCM::DDRTCM_do_vectors_o(const uint16_T a_data[], const int32_T *a_size,
  const real_T b_data[], const int32_T *b_size, uint16_T c_data[], int32_T
...
void DDRTCM::DDR_binary_expand_op_olyqzrqpqm(real_T in1_data[], int32_T
  in1_size[2], const real_T in2_data[], const int32_T in2_size[2], const
  gnssops_navigation_data *in3, const real_T in5_data[], const int32_T *in5_size)
{
  int32_T loop_ub;
  int32_T stride_0_1;
  int32_T stride_1_1;
...
void DDRTCM::DDRTCM_minus_da(real_T in1_data[], int32_T in1_size[2], const
...
real_T DDRTCM::DDRTCM_rt_powd_snf_d(real_T u0, real_T u1,
  B_CalculateDifferentialCorr_b_T *localB)
{
  real_T y;
...
void DDRTCM::DDRT_binary_expand_op_olyqzrqpq(real_T in1_data[], int32_T
  ...
  in4_size[2], B_CalculateDifferentialCorr_b_T *localB)
{
  ...
  for (localB->i20 = 0; localB->i20 < loop_ub; localB->i20++) {
    ...
    localB->in2_data_jz[localB->i20] = ((localB->in2_tmp - static_cast<real_T>
      (localB->in2_tmp > 302400.0) * 604800.0) + static_cast<real_T>
      (localB->in2_tmp < -302400.0) * 604800.0) * (in1_data[localB->i20 *
      localB->stride_1_1_g] + in3_data[localB->i20 * stride_2_1]) +
      in2_data[localB->i20 * localB->stride_0_1_d];
  }

  in1_size[0] = 1;
  in1_size[1] = in2_size_idx_1;
  if (in2_size_idx_1 - 1 >= 0) {
    std::memcpy(&in1_data[0], &localB->in2_data_jz[0], static_cast<uint32_T>
                (in2_size_idx_1) * sizeof(real_T));
  }
}

void DDRTCM::DDRTC_binary_expand_op_olyqzrqp(real_T in1_data[], int32_T
  in1_size[2], const real_T in2_data[], const int32_T in2_size[2], const real_T
  in3_data[], const int32_T in3_size[2], B_CalculateDifferentialCorr_b_T *localB)
{
  in1_size[0] = 1;
  ...
  localB->loop_ub_h = (in3_size[1] == 1 ? in2_size[1] : in3_size[1]) == 1 ?
    in2_size[1] : in3_size[1] == 1 ? in2_size[1] : in3_size[1];
  for (localB->i22 = 0; localB->i22 < localB->loop_ub_h; localB->i22++) {
    in1_data[localB->i22] = static_cast<real_T>(in2_data[localB->i22 *
      localB->stride_0_1_db] > 0.8) * 3.1415926535897931 + static_cast<real_T>
      (in2_data[localB->i22 * localB->stride_1_1_j] <= 0.8) * in3_data
      [localB->i22 * localB->stride_2_1_i3];
  }
}

// Function for MATLAB Function: '<S75>/Calculate Differential Corrections'
boolean_T DDRTCM::DDRTCM_any_f(const boolean_T x_data[], const int32_T x_size[2],
  B_CalculateDifferentialCorr_b_T *localB)
{
  boolean_T exitg1;
  boolean_T y;
...
void DDRTCM::DDRTCM_binary_expand_op_oly(real_T in1_data[], int32_T in1_size[2],
  ...
  const int32_T in3_size[2], B_CalculateDifferentialCorr_b_T *localB)
{
  ...
  localB->loop_ub_m = (in1_size[1] == 1 ? in3_size[1] : in1_size[1]) == 1 ?
    in2_size[1] : in1_size[1] == 1 ? in3_size[1] : in1_size[1];
  for (localB->i1 = 0; localB->i1 < localB->loop_ub_m; localB->i1++) {
    localB->in2_data[localB->i1] = in3_data[localB->i1 * localB->stride_1_1_h] *
...
void DDRTCM::DDRTCM_minus_d(real_T in1_data[], int32_T in1_size[2], const real_T
  in2_data[], const int32_T in2_size[2], B_CalculateDifferentialCorr_b_T *localB)
{
  ...
  for (localB->i8 = 0; localB->i8 < localB->loop_ub_a; localB->i8++) {
    localB->in2_data_b[localB->i8] = in2_data[localB->i8 * localB->stride_0_1_a]
      - in1_data[localB->i8 * localB->stride_1_1_d];
  }
...
void DDRTCM::DDRTCM_binary_expand_op_olyqzrq(real_T in1_data[], int32_T
  in1_size[2], const gnssops_navigation_data *in2, const real_T in4_data[],
  const int32_T *in4_size, const real_T in5_data[], const int32_T in5_size[2],
  const real_T in6_data[], const int32_T in6_size[2], const real_T in7_data[],
  const int32_T in7_size[2], B_CalculateDifferentialCorr_b_T *localB)
{
  int32_T in2_size_idx_1;
  int32_T loop_ub;
  int32_T stride_6_1;
  ...
  for (localB->i18 = 0; localB->i18 < loop_ub; localB->i18++) {
    ...
    localB->in2_data_j[localB->i18] = ((in2->A_f1[static_cast<int32_T>
      (in4_data[localB->i18 * localB->stride_1_1_m1]) - 1] * in1_data
      [localB->i18 * localB->stride_2_1_jp] + in2->A_f0[static_cast<int32_T>
      (in4_data[localB->i18 * localB->stride_0_1_cj]) - 1]) + in2->A_f2[
      static_cast<int32_T>(in4_data[localB->i18 * localB->stride_3_1_kn]) - 1] *
      (localB->varargin_1_c * localB->varargin_1_c)) + in5_data[localB->i18 *
      localB->stride_5_1_p] * -4.44280763339306E-10 * in6_data[localB->i18 *
      stride_6_1] * in7_data[localB->i18 * stride_7_1];
  }

  in1_size[0] = 1;
  in1_size[1] = in2_size_idx_1;
  if (in2_size_idx_1 - 1 >= 0) {
    std::memcpy(&in1_data[0], &localB->in2_data_j[0], static_cast<uint32_T>
                (in2_size_idx_1) * sizeof(real_T));
  }
}

// Function for MATLAB Function: '<S75>/Calculate Differential Corrections'
void DDRTCM::correct_Gps_Time_At_Week_Cros_g(real_T b_time_data[], int32_T
  b_time_size[2])
{
  int32_T loop_ub;
  b_time_size[0] = 1;
...
void DDRTCM::DDRTCM_plus_f(real_T in1_data[], int32_T in1_size[2], const real_T
  in2_data[], const int32_T in2_size[2], B_CalculateDifferentialCorr_b_T *localB)
{
  ...
  for (localB->i9 = 0; localB->i9 < localB->loop_ub_n; localB->i9++) {
    localB->in1_data_ln[localB->i9] = in1_data[localB->i9 *
      localB->stride_0_1_ms] + in2_data[localB->i9 * localB->stride_1_1_o];
  }

  in1_size[0] = 1;
  in1_size[1] = localB->in1_size_idx_1_l;
  if (localB->in1_size_idx_1_l - 1 >= 0) {
    std::memcpy(&in1_data[0], &localB->in1_data_ln[0], static_cast<uint32_T>
                (localB->in1_size_idx_1_l) * sizeof(real_T));
  }
}

void DDRTCM::DDRTCM_binary_expand_op_cl(real_T in1_data[], int32_T in1_size[2],
  const real_T in2_data[], const int32_T in2_size[2], const real_T in3_data[],
  ...
  B_CalculateDifferentialCorr_b_T *localB)
{
  ...
  localB->loop_ub_b = (in4_size[1] == 1 ? in3_size[1] : in4_size[1]) == 1 ?
    in2_size[1] : in4_size[1] == 1 ? in3_size[1] : in4_size[1];
  for (localB->i23 = 0; localB->i23 < localB->loop_ub_b; localB->i23++) {
    in1_data[localB->i23] = in3_data[localB->i23 * localB->stride_1_1_o3] *
      in4_data[localB->i23 * localB->stride_2_1_ch] + in2_data[localB->i23 *
      localB->stride_0_1_nm];
  }
}

void DDRTCM::DDRTCM_binary_expand_op_ko(real_T in1_data[], int32_T in1_size[2],
  const real_T in2_data[], const int32_T in2_size[2], const real_T in3_data[],
  const int32_T in3_size[2], B_CalculateDifferentialCorr_b_T *localB)
{
  localB->in1_size_idx_1 = (in3_size[1] == 1 ? in2_size[1] : in3_size[1]) == 1 ?
    in1_size[1] : in3_size[1] == 1 ? in2_size[1] : in3_size[1];
  localB->stride_0_1_f = (in1_size[1] != 1);
  localB->stride_1_1_h2 = (in2_size[1] != 1);
  localB->stride_2_1_e = (in3_size[1] != 1);
  localB->loop_ub_ch = (in3_size[1] == 1 ? in2_size[1] : in3_size[1]) == 1 ?
    in1_size[1] : in3_size[1] == 1 ? in2_size[1] : in3_size[1];
  for (localB->i7 = 0; localB->i7 < localB->loop_ub_ch; localB->i7++) {
    localB->in1_data_nu[localB->i7] = in1_data[localB->i7 * localB->stride_0_1_f]
      / (1.0 - in2_data[localB->i7 * localB->stride_1_1_h2] * in3_data
         [localB->i7 * localB->stride_2_1_e]);
  }

  in1_size[0] = 1;
  in1_size[1] = localB->in1_size_idx_1;
  if (localB->in1_size_idx_1 - 1 >= 0) {
    std::memcpy(&in1_data[0], &localB->in1_data_nu[0], static_cast<uint32_T>
                (localB->in1_size_idx_1) * sizeof(real_T));
  }
}

// Function for MATLAB Function: '<S75>/Calculate Differential Corrections'
void DDRTCM::Get_Kepler_Eccentric_Anomaly_p(const real_T t_k_data[], const
  ...
  *localB)
{
  ...
  if (Ephemeris_SQRT_A_size[1] == Ephemeris_DELTA_N_size[1]) {
    ...
    for (localB->varargin_1_tmp = 0; localB->varargin_1_tmp <=
         localB->vectorUB_h; localB->varargin_1_tmp += 2) {
      tmp_0 = _mm_loadu_pd(&E_k_Dot_data[localB->varargin_1_tmp]);
      _mm_storeu_pd(&E_k_Dot_data[localB->varargin_1_tmp], _mm_add_pd(tmp_0,
        _mm_loadu_pd(&Ephemeris_DELTA_N_data[localB->varargin_1_tmp])));
    }

    for (localB->varargin_1_tmp = localB->scalarLB_o; localB->varargin_1_tmp <=
         localB->loop_ub_e; localB->varargin_1_tmp++) {
      E_k_Dot_data[localB->varargin_1_tmp] += Ephemeris_DELTA_N_data
        [localB->varargin_1_tmp];
    }
  } else {
    DDRTCM_plus_f(E_k_Dot_data, E_k_Dot_size, Ephemeris_DELTA_N_data,
  ...
  if ((E_k_Dot_size[1] == t_k_size[1]) && ((E_k_Dot_size[1] == 1 ? t_k_size[1] :
    ...
    for (localB->varargin_1_tmp = localB->scalarLB_o; localB->varargin_1_tmp <
         localB->loop_ub_e; localB->varargin_1_tmp++) {
      localB->M_k_data[localB->varargin_1_tmp] = E_k_Dot_data
        [localB->varargin_1_tmp] * t_k_data[localB->varargin_1_tmp] +
        Ephemeris_M_0_data[localB->varargin_1_tmp];
    }
  } else {
    DDRTCM_binary_expand_op_cl(localB->M_k_data, localB->M_k_size,
      Ephemeris_M_0_data, Ephemeris_M_0_size, E_k_Dot_data, E_k_Dot_size,
  ...
  if ((Ephemeris_E_size[1] == localB->M_k_size[1]) && ((Ephemeris_E_size[1] == 1
    ...
    for (localB->varargin_1_tmp = 0; localB->varargin_1_tmp < localB->loop_ub_e;
      ...
      E_k_data[localB->varargin_1_tmp] = static_cast<real_T>
        (localB->varargin_1_m > 0.8) * 3.1415926535897931 + static_cast<real_T>
        (localB->varargin_1_m <= 0.8) * localB->M_k_data[localB->varargin_1_tmp];
    }
  } else {
    DDRTC_binary_expand_op_olyqzrqp(E_k_data, E_k_size, Ephemeris_E_data,
  ...
  do {
    ...
    for (localB->varargin_1_tmp = 0; localB->varargin_1_tmp <
      ...
      localB->eps_data_i[localB->varargin_1_tmp] = (localB->eps_data
        [localB->varargin_1_tmp] > 1.0E-15);
    }

    if (DDRTCM_any_f(localB->eps_data_i, localB->eps_size, localB) &&
        (localB->i_p < 20)) {
      localB->E_k_old_size_c[0] = 1;
      localB->E_k_old_size_c[1] = E_k_size[1];
      localB->loop_ub_e = E_k_size[1];
      if (localB->loop_ub_e - 1 >= 0) {
        std::memcpy(&localB->E_k_old_data_d[0], &E_k_data[0],
                    static_cast<uint32_T>(localB->loop_ub_e) * sizeof(real_T));
      }

      localB->scalarLB_o = E_k_size[1];
      for (localB->vectorUB_h = 0; localB->vectorUB_h < localB->scalarLB_o;
           localB->vectorUB_h++) {
      ...
      if ((Ephemeris_E_size[1] == E_k_size[1]) && ((Ephemeris_E_size[1] == 1 ?
        ...
        DDRTCM_binary_expand_op_oly(E_k_data, E_k_size, localB->M_k_data,
      ...
      if (E_k_size[1] == localB->E_k_old_size_c[1]) {
        ...
        for (localB->varargin_1_tmp = 0; localB->varargin_1_tmp <=
          ...
          _mm_storeu_pd(&localB->E_k_old_data_d[localB->varargin_1_tmp],
                        _mm_sub_pd(tmp_0, tmp));
        }

        for (localB->varargin_1_tmp = localB->scalarLB_o; localB->varargin_1_tmp
             <= localB->loop_ub_e; localB->varargin_1_tmp++) {
          localB->E_k_old_data_d[localB->varargin_1_tmp] = E_k_data
            [localB->varargin_1_tmp] - localB->E_k_old_data_d
            [localB->varargin_1_tmp];
        }
      } else {
        DDRTCM_minus_d(localB->E_k_old_data_d, localB->E_k_old_size_c, E_k_data,
                       E_k_size, localB);
      }
      ...
      for (localB->vectorUB_h = 0; localB->vectorUB_h < localB->scalarLB_o;
           localB->vectorUB_h++) {
        localB->eps_data[localB->vectorUB_h] = std::abs(localB->
          E_k_old_data_d[localB->vectorUB_h]);
      }
  ...
  localB->loop_ub_e = E_k_size[1];
  if (localB->loop_ub_e - 1 >= 0) {
    std::memcpy(&localB->M_k_data[0], &E_k_data[0], static_cast<uint32_T>
                (localB->loop_ub_e) * sizeof(real_T));
  }

  localB->i_p = E_k_size[1];
  for (localB->scalarLB_o = 0; localB->scalarLB_o < localB->i_p;
       localB->scalarLB_o++) {
    localB->M_k_data[localB->scalarLB_o] = std::cos(localB->M_k_data
      [localB->scalarLB_o]);
  }
  ...
  if ((Ephemeris_E_size[1] == E_k_size[1]) && ((Ephemeris_E_size[1] == 1 ?
    ...
    for (localB->varargin_1_tmp = localB->scalarLB_o; localB->varargin_1_tmp <=
         localB->loop_ub_e; localB->varargin_1_tmp++) {
      E_k_Dot_data[localB->varargin_1_tmp] /= 1.0 - Ephemeris_E_data
        [localB->varargin_1_tmp] * localB->M_k_data[localB->varargin_1_tmp];
    }
  } else {
    DDRTCM_binary_expand_op_ko(E_k_Dot_data, E_k_Dot_size, Ephemeris_E_data,
      Ephemeris_E_size, localB->M_k_data, localB->M_k_size, localB);
  }
}

// Function for MATLAB Function: '<S75>/Calculate Differential Corrections'
void DDRTCM::DDRTCM_cos_e3(real_T x_data[], const int32_T x_size[2])
{
  int32_T b;
  b = x_size[1];
...
// Function for MATLAB Function: '<S75>/Calculate Differential Corrections'
void DDRTCM::DDRTCM_sin_m(real_T x_data[], const int32_T x_size[2])
{
  int32_T b;
  b = x_size[1];
  for (int32_T k{0}; k < b; k++) {
...
void DDRTCM::DDRTCM_times_jf(real_T in1_data[], int32_T in1_size[2], const
  real_T in2_data[], const int32_T in2_size[2], const real_T in3_data[], const
  int32_T in3_size[2])
{
  int32_T loop_ub;
...
// Function for MATLAB Function: '<S75>/Calculate Differential Corrections'
void DDRTCM::DDRTCM_sqrt_h(real_T x_data[], const int32_T x_size[2],
  B_CalculateDifferentialCorr_b_T *localB)
{
  localB->b_f = x_size[1];
...
real_T DDRTCM::DDRTCM_rt_atan2d_snf_i(real_T u0, real_T u1,
  B_CalculateDifferentialCorr_b_T *localB)
{
  real_T y;
  if (std::isnan(u0) || std::isnan(u1)) {
...
// Function for MATLAB Function: '<S75>/Calculate Differential Corrections'
void DDRTCM::DDRTCM_expand_atan2_f(const real_T a_data[], const int32_T a_size[2],
  ...
  c_size[2], B_CalculateDifferentialCorr_b_T *localB)
{
  ...
  if (localB->csz_idx_1 != 0) {
    ...
    for (localB->k_p = 0; localB->k_p <= localB->f; localB->k_p++) {
      c_data[localB->k_p] = DDRTCM_rt_atan2d_snf_i(a_data[localB->d_i *
        localB->k_p], b_data[localB->e * localB->k_p], localB);
    }
  }
}

// Function for MATLAB Function: '<S75>/Calculate Differential Corrections'
void DDRTCM::DDRTCM_atan2_o(const real_T y_data[], const int32_T y_size[2],
  const real_T x_data[], const int32_T x_size[2], real_T r_data[], int32_T
  r_size[2], B_CalculateDifferentialCorr_b_T *localB)
{
  if (y_size[1] == x_size[1]) {
    r_size[0] = 1;
    r_size[1] = y_size[1];
    localB->loop_ub_p = y_size[1];
    for (localB->r_data_tmp = 0; localB->r_data_tmp < localB->loop_ub_p;
         localB->r_data_tmp++) {
      r_data[localB->r_data_tmp] = DDRTCM_rt_atan2d_snf_i(y_data
        [localB->r_data_tmp], x_data[localB->r_data_tmp], localB);
    }
  } else {
    DDRTCM_expand_atan2_f(y_data, y_size, x_data, x_size, r_data, r_size, localB);
  }
}

void DDRTCM::DD_binary_expand_op_olyqzrqpqml(real_T in1_data[], int32_T
  in1_size[2], const real_T in2_data[], const int32_T in2_size[2], const real_T
  in3_data[], const int32_T in3_size[2], const real_T in4_data[], const int32_T
  in4_size[2], const real_T in5_data[], const int32_T in5_size[2], const real_T
  in6_data[], const int32_T in6_size[2], B_CalculateDifferentialCorr_b_T *localB)
{
  localB->in2_size_l[0] = 1;
  localB->in2_size_l[1] = in4_size[1] == 1 ? in3_size[1] == 1 ? in2_size[1] :
    in3_size[1] : in4_size[1];
  localB->stride_0_1_p = (in2_size[1] != 1);
  localB->stride_1_1_a = (in3_size[1] != 1);
  localB->stride_2_1_j = (in4_size[1] != 1);
  localB->loop_ub_ek = in4_size[1] == 1 ? in3_size[1] == 1 ? in2_size[1] :
    in3_size[1] : in4_size[1];
  for (localB->i5 = 0; localB->i5 < localB->loop_ub_ek; localB->i5++) {
    localB->in2_data_o[localB->i5] = in2_data[localB->i5 * localB->stride_0_1_p]
      * in3_data[localB->i5 * localB->stride_1_1_a] / in4_data[localB->i5 *
      localB->stride_2_1_j];
  }

  localB->in5_size_m[0] = 1;
  localB->in5_size_m[1] = in4_size[1] == 1 ? in6_size[1] == 1 ? in5_size[1] :
    in6_size[1] : in4_size[1];
  localB->stride_0_1_p = (in5_size[1] != 1);
  localB->stride_1_1_a = (in6_size[1] != 1);
  localB->stride_2_1_j = (in4_size[1] != 1);
  localB->loop_ub_ek = in4_size[1] == 1 ? in6_size[1] == 1 ? in5_size[1] :
    in6_size[1] : in4_size[1];
  for (localB->i5 = 0; localB->i5 < localB->loop_ub_ek; localB->i5++) {
    localB->in5_data_b[localB->i5] = (in5_data[localB->i5 * localB->stride_0_1_p]
      - in6_data[localB->i5 * localB->stride_1_1_a]) / in4_data[localB->i5 *
      localB->stride_2_1_j];
  }

  DDRTCM_atan2_o(localB->in2_data_o, localB->in2_size_l, localB->in5_data_b,
                 localB->in5_size_m, in1_data, in1_size, localB);
}

void DDRTCM::DDRTCM_binary_expand_op_gf(real_T in1_data[], int32_T in1_size[2],
  const real_T in2_data[], const int32_T in2_size[2], const real_T in3_data[],
  const int32_T in3_size[2], const real_T in4_data[], const int32_T in4_size[2],
  ...
  B_CalculateDifferentialCorr_b_T *localB)
{
  ...
  localB->loop_ub_k = in4_size[1] == 1 ? in3_size[1] == 1 ? in2_size[1] :
    in3_size[1] : in4_size[1];
  for (localB->i2 = 0; localB->i2 < localB->loop_ub_k; localB->i2++) {
    localB->in2_data_d[localB->i2] = in2_data[localB->i2 * localB->stride_0_1_m]
      * in3_data[localB->i2 * localB->stride_1_1_h3] / in4_data[localB->i2 *
      localB->stride_2_1_c];
  }
  ...
  localB->stride_2_1_c = (in4_size[1] != 1);
  localB->loop_ub_k = in4_size[1] == 1 ? in6_size[1] == 1 ? in5_size[1] :
    in6_size[1] : in4_size[1];
  for (localB->i2 = 0; localB->i2 < localB->loop_ub_k; localB->i2++) {
    localB->in5_data[localB->i2] = (in5_data[localB->i2 * localB->stride_0_1_m]
      - in6_data[localB->i2 * localB->stride_1_1_h3]) / in4_data[localB->i2 *
      localB->stride_2_1_c];
  }

  DDRTCM_atan2_o(localB->in2_data_d, localB->in2_size, localB->in5_data,
                 localB->in5_size, localB->tmp_data_l, localB->tmp_size_o,
                 localB);
  in1_size[0] = 1;
  ...
  for (localB->i2 = 0; localB->i2 < localB->loop_ub_k; localB->i2++) {
    in1_data[localB->i2] = localB->tmp_data_l[localB->i2 * localB->stride_0_1_m]
      + in7_data[localB->i2 * localB->stride_1_1_h3];
  }
}

void DDRTCM::DDRTCM_binary_expand_op_p4(real_T in1_data[], int32_T in1_size[2],
  const real_T in2_data[], const int32_T in2_size[2], const real_T in3_data[],
  const int32_T in3_size[2], const real_T in4_data[], const int32_T in4_size[2],
  const real_T in5_data[], const int32_T in5_size[2],
  B_CalculateDifferentialCorr_b_T *localB)
{
  localB->in1_size_idx_1_f = ((in5_size[1] == 1 ? in4_size[1] : in5_size[1]) ==
    1 ? in3_size[1] == 1 ? in2_size[1] : in3_size[1] : in5_size[1] == 1 ?
    in4_size[1] : in5_size[1]) == 1 ? in1_size[1] : (in5_size[1] == 1 ?
    in4_size[1] : in5_size[1]) == 1 ? in3_size[1] == 1 ? in2_size[1] : in3_size
    [1] : in5_size[1] == 1 ? in4_size[1] : in5_size[1];
  ...
  localB->loop_ub_cu = ((in5_size[1] == 1 ? in4_size[1] : in5_size[1]) == 1 ?
  ...
  for (localB->i11 = 0; localB->i11 < localB->loop_ub_cu; localB->i11++) {
    localB->in1_data_b[localB->i11] = (in2_data[localB->i11 *
      localB->stride_1_1_k] * in3_data[localB->i11 * localB->stride_2_1_i] +
      in4_data[localB->i11 * localB->stride_3_1_o] * in5_data[localB->i11 *
  ...
  if (localB->in1_size_idx_1_f - 1 >= 0) {
    std::memcpy(&in1_data[0], &localB->in1_data_b[0], static_cast<uint32_T>
                (localB->in1_size_idx_1_f) * sizeof(real_T));
  }
}

void DDRTCM::DDRTCM_binary_expand_op_gn(real_T in1_data[], int32_T in1_size[2],
  const real_T in2_data[], const int32_T in2_size[2], const real_T in3_data[],
  const int32_T in3_size[2], const real_T in4_data[], const int32_T in4_size[2],
  const real_T in5_data[], const int32_T in5_size[2], const real_T in6_data[],
  const int32_T in6_size[2], const real_T in7_data[], const int32_T in7_size[2],
  B_CalculateDifferentialCorr_b_T *localB)
{
  ...
  localB->loop_ub_c5 = ((in7_size[1] == 1 ? in6_size[1] : in7_size[1]) == 1 ?
                        in5_size[1] == 1 ? in4_size[1] : in5_size[1] : in7_size
                        [1] == 1 ? in6_size[1] : in7_size[1]) == 1 ? in3_size[1]
    == 1 ? in2_size[1] : in3_size[1] : (in7_size[1] == 1 ? in6_size[1] :
    in7_size[1]) == 1 ? in5_size[1] == 1 ? in4_size[1] : in5_size[1] : in7_size
    [1] == 1 ? in6_size[1] : in7_size[1];
  for (localB->i26 = 0; localB->i26 < localB->loop_ub_c5; localB->i26++) {
    localB->varargin_1_m3 = in2_data[localB->i26 * localB->stride_0_1_dk];
    in1_data[localB->i26] = (1.0 - in3_data[localB->i26 * localB->stride_1_1_oi])
      * (localB->varargin_1_m3 * localB->varargin_1_m3) + (in4_data[localB->i26 *
      localB->stride_2_1_jr] * in5_data[localB->i26 * localB->stride_3_1_c] +
      in6_data[localB->i26 * localB->stride_4_1_h] * in7_data[localB->i26 *
      localB->stride_5_1_d]);
  }
}

void DDRTCM::DDRTCM_binary_expand_op_aty(real_T in1_data[], int32_T in1_size[2],
  const real_T in2_data[], const int32_T in2_size[2], const real_T in3_data[],
  const int32_T in3_size[2], const real_T in4_data[], const int32_T in4_size[2],
  const real_T in5_data[], const int32_T in5_size[2], const real_T in6_data[],
  const int32_T in6_size[2], const real_T in7_data[], const int32_T in7_size[2],
  ...
  B_CalculateDifferentialCorr_b_T *localB)
{
  ...
  localB->loop_ub_l = (in8_size[1] == 1 ? in7_size[1] : in8_size[1]) == 1 ?
    ((in6_size[1] == 1 ? in5_size[1] : in6_size[1]) == 1 ? in4_size[1] == 1 ?
     in3_size[1] : in4_size[1] : in6_size[1] == 1 ? in5_size[1] : in6_size[1]) ==
    1 ? in2_size[1] : (in6_size[1] == 1 ? in5_size[1] : in6_size[1]) == 1 ?
    in4_size[1] == 1 ? in3_size[1] : in4_size[1] : in6_size[1] == 1 ? in5_size[1]
  ...
  for (localB->i27 = 0; localB->i27 < localB->loop_ub_l; localB->i27++) {
    in1_data[localB->i27] = ((in3_data[localB->i27 * localB->stride_1_1_pi] *
      in4_data[localB->i27 * localB->stride_2_1_a4] + in5_data[localB->i27 *
      localB->stride_3_1_ow] * in6_data[localB->i27 * localB->stride_4_1_j]) +
      in2_data[localB->i27 * localB->stride_0_1_pw]) + in7_data[localB->i27 *
      localB->stride_5_1_pi] * in8_data[localB->i27 * localB->stride_6_1_o];
  }
}

void DDRTCM::DDRTCM_binary_expand_op_es(real_T in1_data[], int32_T in1_size[2],
  const real_T in2_data[], const int32_T in2_size[2], const real_T in3_data[],
  const int32_T in3_size[2], const real_T in4_data[], const int32_T in4_size[2],
  B_CalculateDifferentialCorr_b_T *localB)
{
  localB->in2_size_idx_1_g = in4_size[1] == 1 ? (in1_size[1] == 1 ? in3_size[1] :
  ...
  localB->loop_ub_a5 = in4_size[1] == 1 ? (in1_size[1] == 1 ? in3_size[1] :
    in1_size[1]) == 1 ? in2_size[1] : in1_size[1] == 1 ? in3_size[1] : in1_size
    [1] : in4_size[1];
  for (localB->i14 = 0; localB->i14 < localB->loop_ub_a5; localB->i14++) {
    localB->in2_data_bj[localB->i14] = (in3_data[localB->i14 *
      localB->stride_1_1_m0] * in1_data[localB->i14 * localB->stride_2_1_jg] +
      in2_data[localB->i14 * localB->stride_0_1_mv]) - in4_data[localB->i14 *
  ...
  if (localB->in2_size_idx_1_g - 1 >= 0) {
    std::memcpy(&in1_data[0], &localB->in2_data_bj[0], static_cast<uint32_T>
                (localB->in2_size_idx_1_g) * sizeof(real_T));
  }
}

void DDRTCM::DDRTCM_times_jfq(real_T in1_data[], int32_T in1_size[2], const
  real_T in2_data[], const int32_T in2_size[2], B_CalculateDifferentialCorr_b_T *
  localB)
{
  ...
  for (localB->i17 = 0; localB->i17 < localB->loop_ub_g; localB->i17++) {
    localB->in1_data_a[localB->i17] = in1_data[localB->i17 *
      localB->stride_0_1_n3] * in2_data[localB->i17 * localB->stride_1_1_oy];
  }

  in1_size[0] = 1;
  in1_size[1] = localB->in1_size_idx_1_c;
  if (localB->in1_size_idx_1_c - 1 >= 0) {
    std::memcpy(&in1_data[0], &localB->in1_data_a[0], static_cast<uint32_T>
                (localB->in1_size_idx_1_c) * sizeof(real_T));
  }
}

void DDRTCM::DDRTCM_binary_expand_op_ml(real_T in1_data[], const real_T
...
void DDRTCM::DDRTCM_binary_expand_op_i4(real_T in1_data[], const int32_T
  in1_size[2], const real_T in2_data[], const int32_T in2_size[2], const real_T
  in3_data[], const int32_T in3_size[2], const real_T in4_data[], const int32_T
...
void DDRTCM::DDRTCM_binary_expand_op_kn(real_T in1_data[], int32_T in1_size[2],
  const real_T in2_data[], const int32_T in2_size[2], const real_T in3_data[],
  const int32_T in3_size[2], B_CalculateDifferentialCorr_b_T *localB)
{
  localB->in1_size_idx_1_fx = in3_size[1] == 1 ? in2_size[1] == 1 ? in1_size[1] :
    in2_size[1] : in3_size[1];
  localB->stride_0_1_n = (in1_size[1] != 1);
  localB->stride_1_1_d3 = (in2_size[1] != 1);
  localB->stride_2_1_n = (in3_size[1] != 1);
  localB->loop_ub_cg = in3_size[1] == 1 ? in2_size[1] == 1 ? in1_size[1] :
    in2_size[1] : in3_size[1];
  for (localB->i15 = 0; localB->i15 < localB->loop_ub_cg; localB->i15++) {
    localB->in1_data_jz[localB->i15] = in1_data[localB->i15 *
      localB->stride_0_1_n] * in2_data[localB->i15 * localB->stride_1_1_d3] /
      in3_data[localB->i15 * localB->stride_2_1_n];
  }

  in1_size[0] = 1;
  in1_size[1] = localB->in1_size_idx_1_fx;
  if (localB->in1_size_idx_1_fx - 1 >= 0) {
    std::memcpy(&in1_data[0], &localB->in1_data_jz[0], static_cast<uint32_T>
                (localB->in1_size_idx_1_fx) * sizeof(real_T));
  }
}

void DDRTCM::DDRTCM_binary_expand_op_d(real_T in1_data[], int32_T in1_size[2],
  const real_T in2_data[], const int32_T in2_size[2], const real_T in3_data[],
  const int32_T in3_size[2], const real_T in4_data[], const int32_T in4_size[2],
  const real_T in5_data[], const int32_T in5_size[2], const real_T in6_data[],
...
void DDRTCM::DDRTCM_binary_expand_op_at(real_T in1_data[], int32_T in1_size[2],
  const real_T in2_data[], const int32_T in2_size[2], const real_T in3_data[],
  const int32_T in3_size[2], const real_T in4_data[], const int32_T in4_size[2],
  const real_T in5_data[], const int32_T in5_size[2], const real_T in6_data[],
  const int32_T in6_size[2], const real_T in7_data[], const int32_T in7_size[2],
  const real_T in8_data[], const int32_T in8_size[2], const real_T in9_data[],
  const int32_T in9_size[2], const real_T in10_data[], const int32_T in10_size[2],
  B_CalculateDifferentialCorr_b_T *localB)
{
  in1_size[0] = 1;
  ...
  localB->loop_ub_f = (in10_size[1] == 1 ? in9_size[1] == 1 ? in8_size[1] == 1 ?
  ...
  for (localB->i21 = 0; localB->i21 < localB->loop_ub_f; localB->i21++) {
    ...
    in1_data[localB->i21] = (in2_data[localB->i21 * localB->stride_0_1_c3] *
      in3_data[localB->i21 * localB->stride_1_1_c] - in4_data[localB->i21 *
      localB->stride_2_1_if] * in5_data[localB->i21 * localB->stride_3_1_d]) *
      2.0 * in6_data[localB->i21 * localB->stride_4_1_g] + localB->varargin_1_md
      * localB->varargin_1_md * in8_data[localB->i21 * localB->stride_6_1] *
      in9_data[localB->i21 * localB->stride_7_1] * in10_data[localB->i21 *
      localB->stride_8_1];
  }
}

void DDRTCM::DDRTCM_binary_expand_op_c4(real_T in1_data[], int32_T in1_size[2],
  const real_T in2_data[], const int32_T in2_size[2], const real_T in3_data[],
  const int32_T in3_size[2], const real_T in4_data[], const int32_T in4_size[2],
  const real_T in5_data[], const int32_T in5_size[2], const real_T in6_data[],
  const int32_T in6_size[2], B_CalculateDifferentialCorr_b_T *localB)
{
  localB->tmp_size_idx_1 = in6_size[1] == 1 ? in5_size[1] == 1 ? (in4_size[1] ==
  ...
  localB->loop_ub_i = in6_size[1] == 1 ? in5_size[1] == 1 ? (in4_size[1] == 1 ?
  ...
  for (localB->i10 = 0; localB->i10 < localB->loop_ub_i; localB->i10++) {
    localB->tmp_data_h[localB->i10] = (in2_data[localB->i10 *
      localB->stride_0_1_pe] * in1_data[localB->i10 * localB->stride_1_1_p] -
      in3_data[localB->i10 * localB->stride_2_1_f] * in4_data[localB->i10 *
      localB->stride_3_1]) * 2.0 * in5_data[localB->i10 * localB->stride_4_1] +
      in6_data[localB->i10 * localB->stride_5_1];
  }

  in1_size[0] = 1;
  in1_size[1] = localB->tmp_size_idx_1;
  if (localB->tmp_size_idx_1 - 1 >= 0) {
    std::memcpy(&in1_data[0], &localB->tmp_data_h[0], static_cast<uint32_T>
                (localB->tmp_size_idx_1) * sizeof(real_T));
  }
}

void DDRTCM::DDRTCM_binary_expand_op_pf(real_T in1_data[], int32_T in1_size[2],
  const real_T in2_data[], const int32_T in2_size[2], const real_T in3_data[],
  const int32_T in3_size[2], const real_T in4_data[], const int32_T in4_size[2],
  B_CalculateDifferentialCorr_b_T *localB)
{
  localB->in2_size_idx_1_e = (in4_size[1] == 1 ? in3_size[1] : in4_size[1]) == 1
    ? in1_size[1] == 1 ? in2_size[1] : in1_size[1] : in4_size[1] == 1 ?
    in3_size[1] : in4_size[1];
  ...
  localB->loop_ub_j = (in4_size[1] == 1 ? in3_size[1] : in4_size[1]) == 1 ?
    in1_size[1] == 1 ? in2_size[1] : in1_size[1] : in4_size[1] == 1 ? in3_size[1]
    : in4_size[1];
  for (localB->i13 = 0; localB->i13 < localB->loop_ub_j; localB->i13++) {
    localB->in2_data_e[localB->i13] = in2_data[localB->i13 *
      localB->stride_0_1_c] * in1_data[localB->i13 * localB->stride_1_1_n] -
      in3_data[localB->i13 * localB->stride_2_1_ij] * in4_data[localB->i13 *
      localB->stride_3_1_m];
  }
  ...
  if (localB->in2_size_idx_1_e - 1 >= 0) {
    std::memcpy(&in1_data[0], &localB->in2_data_e[0], static_cast<uint32_T>
                (localB->in2_size_idx_1_e) * sizeof(real_T));
  }
}

void DDRTCM::DDRTCM_binary_expand_op_i1(real_T in1_data[], int32_T in1_size[2],
  const real_T in2_data[], const int32_T in2_size[2], const real_T in3_data[],
  const int32_T in3_size[2], const real_T in4_data[], const int32_T in4_size[2],
  B_CalculateDifferentialCorr_b_T *localB)
{
  localB->in1_size_idx_1_b = (in4_size[1] == 1 ? in3_size[1] : in4_size[1]) == 1
  ...
  localB->loop_ub_pc = (in4_size[1] == 1 ? in3_size[1] : in4_size[1]) == 1 ?
    in2_size[1] == 1 ? in1_size[1] : in2_size[1] : in4_size[1] == 1 ? in3_size[1]
    : in4_size[1];
  for (localB->i12 = 0; localB->i12 < localB->loop_ub_pc; localB->i12++) {
    localB->in1_data_da[localB->i12] = in1_data[localB->i12 *
      localB->stride_0_1_h] * in2_data[localB->i12 * localB->stride_1_1_m] +
      in3_data[localB->i12 * localB->stride_2_1_a] * in4_data[localB->i12 *
      localB->stride_3_1_k];
  }
  ...
  if (localB->in1_size_idx_1_b - 1 >= 0) {
    std::memcpy(&in1_data[0], &localB->in1_data_da[0], static_cast<uint32_T>
                (localB->in1_size_idx_1_b) * sizeof(real_T));
  }
}

void DDRTCM::DDRTCM_times_j(real_T in1_data[], int32_T in1_size[2], const real_T
  in2_data[], const int32_T in2_size[2], B_CalculateDifferentialCorr_b_T *localB)
{
  ...
  for (localB->i16 = 0; localB->i16 < localB->loop_ub_nj; localB->i16++) {
    localB->in2_data_f[localB->i16] = in2_data[localB->i16 *
      localB->stride_0_1_pm] * in1_data[localB->i16 * localB->stride_1_1_p2];
  }

  in1_size[0] = 1;
  in1_size[1] = localB->in2_size_idx_1_k;
  if (localB->in2_size_idx_1_k - 1 >= 0) {
    std::memcpy(&in1_data[0], &localB->in2_data_f[0], static_cast<uint32_T>
                (localB->in2_size_idx_1_k) * sizeof(real_T));
  }
}

void DDRTCM::binary_expand_o_olyqzrqpqmlmbao(real_T in1_data[], const real_T
  in2_data[], const int32_T in2_size[2], const real_T in3_data[], const int32_T
  in3_size[2], const real_T in4_data[], const int32_T in4_size[2], const real_T
  ...
  in9_size[2], B_CalculateDifferentialCorr_b_T *localB)
{
  ...
  for (localB->i25 = 0; localB->i25 < localB->in2_idx_0; localB->i25++) {
    in1_data[localB->i25] = ((in2_data[localB->i25 * localB->stride_0_0_e] *
      in3_data[localB->i25 * localB->stride_1_0_d] - in4_data[localB->i25 *
      localB->stride_2_0_i] * in5_data[localB->i25 * localB->stride_3_0_g]) +
      in6_data[localB->i25 * localB->stride_4_0_n] * in5_data[localB->i25 *
      localB->stride_5_0_l] * in7_data[localB->i25 * localB->stride_6_0_c]) -
      in8_data[localB->i25 * localB->stride_7_0_n + in8_size[0]] *
      in9_data[localB->i25 * localB->stride_8_0_p];
  }
}

void DDRTCM::binary_expand_op_olyqzrqpqmlmba(real_T in1_data[], const int32_T
  in1_size[2], const real_T in2_data[], const int32_T in2_size[2], const real_T
  in3_data[], const int32_T in3_size[2], const real_T in4_data[], const int32_T
  in4_size[2], const real_T in5_data[], const int32_T in5_size[2], const real_T
  ...
  in9_data[], const int32_T in9_size[2], B_CalculateDifferentialCorr_b_T *localB)
{
  ...
  for (localB->i24 = 0; localB->i24 < localB->in1_idx_0; localB->i24++) {
    in1_data[localB->i24 + in1_size[0]] = ((in2_data[localB->i24 *
      localB->stride_0_0] * in3_data[localB->i24 * localB->stride_1_0] +
      in4_data[localB->i24 * localB->stride_2_0] * in5_data[localB->i24 *
      localB->stride_3_0]) - in6_data[localB->i24 * localB->stride_4_0] *
      in5_data[localB->i24 * localB->stride_5_0] * in7_data[localB->i24 *
      localB->stride_6_0]) + in8_data[localB->i24 * localB->stride_7_0] *
      in9_data[localB->i24 * localB->stride_8_0];
  }
}

void DDRTCM::binary_expand_op_olyqzrqpqmlmb(real_T in1_data[], const int32_T
  in1_size[2], const real_T in2_data[], const int32_T in2_size[2], const real_T
  in3_data[], const int32_T in3_size[2], const real_T in4_data[], const int32_T
  in4_size[2], const real_T in5_data[], const int32_T in5_size[2])
{
...
// Function for MATLAB Function: '<S75>/Calculate Differential Corrections'
void DDRTCM::DDRTCM_sqrt_hy(real_T x_data[], const int32_T *x_size,
  B_CalculateDifferentialCorr_b_T *localB)
{
  localB->b_k = *x_size;
...
// Function for MATLAB Function: '<S75>/Calculate Differential Corrections'
void DDRTCM::Get_Kepler_Satellite_Position_j(const real_T Ephemeris_C_rs_data[],
  ...
  B_CalculateDifferentialCorr_b_T *localB)
{
  ...
  if (T_emission_size[1] == Ephemeris_T_oe_size[1]) {
    ...
    for (localB->t_k_data_tmp = 0; localB->t_k_data_tmp <= localB->vectorUB;
      ...
      _mm_storeu_pd(&localB->t_k_data_l[localB->t_k_data_tmp], _mm_sub_pd
                    (_mm_loadu_pd(&T_emission_data[localB->t_k_data_tmp]),
                     _mm_loadu_pd(&Ephemeris_T_oe_data[localB->t_k_data_tmp])));
    }

    for (localB->t_k_data_tmp = localB->scalarLB_f; localB->t_k_data_tmp <
         localB->loop_ub_c; localB->t_k_data_tmp++) {
      localB->t_k_data_l[localB->t_k_data_tmp] = T_emission_data
        [localB->t_k_data_tmp] - Ephemeris_T_oe_data[localB->t_k_data_tmp];
    }
  } else {
    DDRTCM_minus_da(localB->t_k_data_l, localB->t_k_size_g, T_emission_data,
                    T_emission_size, Ephemeris_T_oe_data, Ephemeris_T_oe_size);
  }

  correct_Gps_Time_At_Week_Cros_g(localB->t_k_data_l, localB->t_k_size_g);
  Get_Kepler_Eccentric_Anomaly_p(localB->t_k_data_l, localB->t_k_size_g,
  ...
  DDRTCM_cos_e3(localB->cosinus_E_k_data, localB->cosinus_E_k_size);
  DDRTCM_sin_m(localB->sinus_E_k_data, localB->sinus_E_k_size);
  if (Ephemeris_E_size[1] == localB->cosinus_E_k_size[1]) {
    ...
    for (localB->t_k_data_tmp = 0; localB->t_k_data_tmp <= localB->vectorUB;
      ...
      _mm_storeu_pd(&localB->r_k_Dot_data[localB->t_k_data_tmp], _mm_mul_pd
    ...
    for (localB->t_k_data_tmp = localB->scalarLB_f; localB->t_k_data_tmp <
         localB->loop_ub_c; localB->t_k_data_tmp++) {
      localB->r_k_Dot_data[localB->t_k_data_tmp] = Ephemeris_E_data
        [localB->t_k_data_tmp] * localB->cosinus_E_k_data[localB->t_k_data_tmp];
    }
  } else {
    DDRTCM_times_jf(localB->r_k_Dot_data, localB->r_k_Dot_size, Ephemeris_E_data,
  ...
  for (localB->t_k_data_tmp = 0; localB->t_k_data_tmp <= localB->vectorUB;
    ...
    _mm_storeu_pd(&localB->y_tmp_data[localB->t_k_data_tmp], _mm_sub_pd
                  (_mm_set1_pd(1.0), tmp_6));
  }

  for (localB->t_k_data_tmp = localB->scalarLB_f; localB->t_k_data_tmp <
       localB->loop_ub_c; localB->t_k_data_tmp++) {
    localB->y_tmp_data[localB->t_k_data_tmp] = 1.0 - localB->r_k_Dot_data
      [localB->t_k_data_tmp];
  }
  ...
  DDRTCM_sqrt_h(localB->f_data, localB->f_size, localB);
  if ((localB->f_size[1] != localB->sinus_E_k_size[1]) || ((localB->f_size[1] ==
        1 ? localB->sinus_E_k_size[1] : localB->f_size[1]) !=
       localB->r_k_Dot_size[1]) || (localB->cosinus_E_k_size[1] !=
       Ephemeris_E_size[1]) || ((localB->cosinus_E_k_size[1] == 1 ?
        Ephemeris_E_size[1] : localB->cosinus_E_k_size[1]) !=
       localB->r_k_Dot_size[1])) {
    DD_binary_expand_op_olyqzrqpqml(localB->tmp_data, localB->tmp_size,
      localB->f_data, localB->f_size, localB->sinus_E_k_data,
      localB->sinus_E_k_size, localB->y_tmp_data, localB->y_tmp_size,
  ...
  if ((localB->f_size[1] == localB->sinus_E_k_size[1]) && ((localB->f_size[1] ==
       ...
       Ephemeris_E_size[1]) && ((localB->cosinus_E_k_size[1] == 1 ?
        Ephemeris_E_size[1] : localB->cosinus_E_k_size[1]) ==
       localB->r_k_Dot_size[1]) && (localB->tmp_size[1] == Ephemeris_omega_size
       [1])) {
    ...
    for (localB->t_k_data_tmp = 0; localB->t_k_data_tmp <= localB->vectorUB;
      ...
      _mm_storeu_pd(&localB->PHI_k_data[localB->t_k_data_tmp], _mm_div_pd
                    (_mm_mul_pd(tmp_6, tmp_4), tmp_5));
    }

    for (localB->t_k_data_tmp = localB->scalarLB_f; localB->t_k_data_tmp <
         localB->loop_ub_c; localB->t_k_data_tmp++) {
      localB->PHI_k_data[localB->t_k_data_tmp] = localB->f_data
        [localB->t_k_data_tmp] * localB->sinus_E_k_data[localB->t_k_data_tmp] /
        localB->y_tmp_data[localB->t_k_data_tmp];
    }
    ...
    for (localB->t_k_data_tmp = 0; localB->t_k_data_tmp <= localB->vectorUB;
      ...
      _mm_storeu_pd(&localB->f_data[localB->t_k_data_tmp], _mm_div_pd(_mm_sub_pd
        (tmp_6, _mm_loadu_pd(&Ephemeris_E_data[localB->t_k_data_tmp])), tmp_4));
    }

    for (localB->t_k_data_tmp = localB->scalarLB_f; localB->t_k_data_tmp <
         localB->loop_ub_c; localB->t_k_data_tmp++) {
      localB->f_data[localB->t_k_data_tmp] = (localB->cosinus_E_k_data
        [localB->t_k_data_tmp] - Ephemeris_E_data[localB->t_k_data_tmp]) /
        localB->y_tmp_data[localB->t_k_data_tmp];
    }

    DDRTCM_atan2_o(localB->PHI_k_data, localB->PHI_k_size, localB->f_data,
                   localB->f_size, localB->tmp_data, localB->tmp_size, localB);
    localB->PHI_k_size[0] = 1;
    ...
    for (localB->t_k_data_tmp = 0; localB->t_k_data_tmp <= localB->vectorUB;
      ...
      _mm_storeu_pd(&localB->PHI_k_data[localB->t_k_data_tmp], _mm_add_pd(tmp_6,
        _mm_loadu_pd(&Ephemeris_omega_data[localB->t_k_data_tmp])));
    }

    for (localB->t_k_data_tmp = localB->scalarLB_f; localB->t_k_data_tmp <
         localB->loop_ub_c; localB->t_k_data_tmp++) {
      localB->PHI_k_data[localB->t_k_data_tmp] = localB->tmp_data
        [localB->t_k_data_tmp] + Ephemeris_omega_data[localB->t_k_data_tmp];
    }
  } else {
    DDRTCM_binary_expand_op_gf(localB->PHI_k_data, localB->PHI_k_size,
      localB->f_data, localB->f_size, localB->sinus_E_k_data,
      localB->sinus_E_k_size, localB->y_tmp_data, localB->y_tmp_size,
      localB->cosinus_E_k_data, localB->cosinus_E_k_size, Ephemeris_E_data,
      Ephemeris_E_size, Ephemeris_omega_data, Ephemeris_omega_size, localB);
  }
  ...
  for (localB->t_k_data_tmp = 0; localB->t_k_data_tmp <= localB->vectorUB;
    ...
    _mm_storeu_pd(&localB->cosinus_E_k_data[localB->t_k_data_tmp], _mm_mul_pd
                  (_mm_set1_pd(2.0), tmp_6));
  }

  for (localB->t_k_data_tmp = localB->scalarLB_f; localB->t_k_data_tmp <
       localB->loop_ub_c; localB->t_k_data_tmp++) {
    localB->cosinus_E_k_data[localB->t_k_data_tmp] = 2.0 * localB->
      PHI_k_data[localB->t_k_data_tmp];
  }
  ...
  localB->loop_ub_c = localB->PHI_k_size[1];
  if (localB->loop_ub_c - 1 >= 0) {
    std::memcpy(&localB->sin2PHI_k_data[0], &localB->cosinus_E_k_data[0],
                static_cast<uint32_T>(localB->loop_ub_c) * sizeof(real_T));
  }

  DDRTCM_sin_m(localB->sin2PHI_k_data, localB->sin2PHI_k_size);
  localB->cos2PHI_k_size[0] = 1;
  localB->cos2PHI_k_size[1] = localB->PHI_k_size[1];
  localB->loop_ub_c = localB->PHI_k_size[1];
  if (localB->loop_ub_c - 1 >= 0) {
    std::memcpy(&localB->cos2PHI_k_data[0], &localB->cosinus_E_k_data[0],
                static_cast<uint32_T>(localB->loop_ub_c) * sizeof(real_T));
  }

  DDRTCM_cos_e3(localB->cos2PHI_k_data, localB->cos2PHI_k_size);
  if ((Ephemeris_C_us_size[1] == localB->sin2PHI_k_size[1]) &&
    ...
    for (localB->t_k_data_tmp = 0; localB->t_k_data_tmp <= localB->vectorUB;
      ...
      _mm_storeu_pd(&localB->PHI_k_data[localB->t_k_data_tmp], _mm_add_pd
    ...
    for (localB->t_k_data_tmp = localB->scalarLB_f; localB->t_k_data_tmp <=
         localB->loop_ub_c; localB->t_k_data_tmp++) {
      localB->PHI_k_data[localB->t_k_data_tmp] += Ephemeris_C_us_data
    ...
    DDRTCM_binary_expand_op_p4(localB->PHI_k_data, localB->PHI_k_size,
  ...
  for (localB->t_k_data_tmp = 0; localB->t_k_data_tmp <= localB->vectorUB;
    ...
    _mm_storeu_pd(&localB->tmp_data[localB->t_k_data_tmp], _mm_mul_pd(tmp_6,
      tmp_6));
  }
  ...
  if ((Ephemeris_SQRT_A_size[1] == localB->r_k_Dot_size[1]) &&
      (Ephemeris_C_rs_size[1] == localB->sin2PHI_k_size[1]) &&
      (Ephemeris_C_rc_size[1] == localB->cos2PHI_k_size[1]) &&
      ((Ephemeris_C_rs_size[1] == 1 ? localB->sin2PHI_k_size[1] :
        Ephemeris_C_rs_size[1]) == (Ephemeris_C_rc_size[1] == 1 ?
        localB->cos2PHI_k_size[1] : Ephemeris_C_rc_size[1])) &&
      (((Ephemeris_C_rs_size[1] == 1 ? localB->sin2PHI_k_size[1] :
         Ephemeris_C_rs_size[1]) == 1 ? Ephemeris_C_rc_size[1] == 1 ?
        localB->cos2PHI_k_size[1] : Ephemeris_C_rc_size[1] :
        Ephemeris_C_rs_size[1] == 1 ? localB->sin2PHI_k_size[1] :
        Ephemeris_C_rs_size[1]) == (Ephemeris_SQRT_A_size[1] == 1 ?
        localB->r_k_Dot_size[1] : Ephemeris_SQRT_A_size[1]))) {
    localB->r_k_size[0] = 1;
    ...
    for (localB->t_k_data_tmp = localB->scalarLB_tmp; localB->t_k_data_tmp <
      ...
      localB->r_k_data[localB->t_k_data_tmp] = localB->N * localB->N * (1.0 -
        localB->r_k_Dot_data[localB->t_k_data_tmp]) +
        (Ephemeris_C_rs_data[localB->t_k_data_tmp] * localB->
         sin2PHI_k_data[localB->t_k_data_tmp] + Ephemeris_C_rc_data
         [localB->t_k_data_tmp] * localB->cos2PHI_k_data[localB->t_k_data_tmp]);
    }
  } else {
    DDRTCM_binary_expand_op_gn(localB->r_k_data, localB->r_k_size,
      Ephemeris_SQRT_A_data, Ephemeris_SQRT_A_size, localB->r_k_Dot_data,
      localB->r_k_Dot_size, Ephemeris_C_rs_data, Ephemeris_C_rs_size,
      localB->sin2PHI_k_data, localB->sin2PHI_k_size, Ephemeris_C_rc_data,
      Ephemeris_C_rc_size, localB->cos2PHI_k_data, localB->cos2PHI_k_size,
      localB);
  }
  ...
  if ((Ephemeris_C_is_size[1] == localB->sin2PHI_k_size[1]) &&
      ...
      (Ephemeris_IDOT_size[1] == localB->t_k_size_g[1]) && ((Ephemeris_I_0_size
        [1] == 1 ? (Ephemeris_C_is_size[1] == 1 ? localB->sin2PHI_k_size[1] :
                    Ephemeris_C_is_size[1]) == 1 ? Ephemeris_C_ic_size[1] == 1 ?
        localB->cos2PHI_k_size[1] : Ephemeris_C_ic_size[1] :
        Ephemeris_C_is_size[1] == 1 ? localB->sin2PHI_k_size[1] :
        Ephemeris_C_is_size[1] : Ephemeris_I_0_size[1]) == (Ephemeris_IDOT_size
        [1] == 1 ? localB->t_k_size_g[1] : Ephemeris_IDOT_size[1]))) {
    localB->i_k_size[0] = 1;
    ...
    DDRTCM_binary_expand_op_aty(localB->i_k_data, localB->i_k_size,
      ...
      localB->t_k_data_l, localB->t_k_size_g, localB);
  }
  ...
  if ((Ephemeris_OMEGADOT_size[1] == localB->t_k_size_g[1]) &&
      ((Ephemeris_OMEGADOT_size[1] == 1 ? localB->t_k_size_g[1] :
        Ephemeris_OMEGADOT_size[1]) == Ephemeris_OMEGA_0_size[1]) &&
      ((Ephemeris_OMEGA_0_size[1] == 1 ? Ephemeris_OMEGADOT_size[1] == 1 ?
        localB->t_k_size_g[1] : Ephemeris_OMEGADOT_size[1] :
    ...
    for (localB->t_k_data_tmp = localB->scalarLB_f; localB->t_k_data_tmp <=
         localB->loop_ub_c; localB->t_k_data_tmp++) {
      localB->t_k_data_l[localB->t_k_data_tmp] = (localB->f_data
        [localB->t_k_data_tmp] * localB->t_k_data_l[localB->t_k_data_tmp] +
        Ephemeris_OMEGA_0_data[localB->t_k_data_tmp]) - 7.2921151467E-5 *
        Ephemeris_T_oe_data[localB->t_k_data_tmp];
    }
  } else {
    DDRTCM_binary_expand_op_es(localB->t_k_data_l, localB->t_k_size_g,
  ...
  localB->loop_ub_c = localB->PHI_k_size[1];
  if (localB->loop_ub_c - 1 >= 0) {
    std::memcpy(&localB->cosinus_u_k_data[0], &localB->PHI_k_data[0],
                static_cast<uint32_T>(localB->loop_ub_c) * sizeof(real_T));
  }

  DDRTCM_cos_e3(localB->cosinus_u_k_data, localB->cosinus_u_k_size);
  DDRTCM_sin_m(localB->PHI_k_data, localB->PHI_k_size);
  ...
  DDRTCM_cos_e3(localB->cosinus_i_k_data, localB->cosinus_i_k_size);
  DDRTCM_sin_m(localB->i_k_data, localB->i_k_size);
  localB->sinus_lambda_k_size[0] = 1;
  localB->sinus_lambda_k_size[1] = localB->t_k_size_g[1];
  localB->loop_ub_c = localB->t_k_size_g[1];
  if (localB->loop_ub_c - 1 >= 0) {
    std::memcpy(&localB->sinus_lambda_k_data[0], &localB->t_k_data_l[0],
                static_cast<uint32_T>(localB->loop_ub_c) * sizeof(real_T));
  }

  DDRTCM_sin_m(localB->sinus_lambda_k_data, localB->sinus_lambda_k_size);
  DDRTCM_cos_e3(localB->t_k_data_l, localB->t_k_size_g);
  if (localB->r_k_size[1] == localB->cosinus_u_k_size[1]) {
    ...
    DDRTCM_times_jf(localB->X_k_tmp_data, localB->X_k_tmp_size, localB->r_k_data,
  ...
  if (localB->r_k_size[1] == localB->PHI_k_size[1]) {
    ...
    for (localB->t_k_data_tmp = localB->scalarLB_f; localB->t_k_data_tmp <=
         localB->loop_ub_c; localB->t_k_data_tmp++) {
      localB->r_k_data[localB->t_k_data_tmp] *= localB->PHI_k_data
        [localB->t_k_data_tmp];
    }
  } else {
    DDRTCM_times_jfq(localB->r_k_data, localB->r_k_size, localB->PHI_k_data,
                     localB->PHI_k_size, localB);
  }
  ...
  if (localB->loop_ub_c - 1 >= 0) {
    std::memset(&sv_pos_data[0], 0, static_cast<uint32_T>(localB->loop_ub_c) *
                sizeof(real_T));
  }
  ...
  if (localB->r_k_size[1] == localB->cosinus_i_k_size[1]) {
    ...
    DDRTCM_times_jf(localB->c_data, localB->c_size, localB->r_k_data,
                    localB->r_k_size, localB->cosinus_i_k_data,
                    localB->cosinus_i_k_size);
  }

  if ((localB->X_k_tmp_size[1] == localB->t_k_size_g[1]) && (localB->c_size[1] ==
       localB->sinus_lambda_k_size[1]) && ((localB->X_k_tmp_size[1] == 1 ?
        localB->t_k_size_g[1] : localB->X_k_tmp_size[1]) == (localB->c_size[1] ==
    ...
    DDRTCM_binary_expand_op_ml(sv_pos_data, localB->X_k_tmp_data,
      localB->X_k_tmp_size, localB->t_k_data_l, localB->t_k_size_g,
      localB->c_data, localB->c_size, localB->sinus_lambda_k_data,
      localB->sinus_lambda_k_size);
  }

  if ((localB->X_k_tmp_size[1] == localB->sinus_lambda_k_size[1]) &&
      (localB->c_size[1] == localB->t_k_size_g[1]) && ((localB->X_k_tmp_size[1] ==
    ...
    DDRTCM_binary_expand_op_i4(sv_pos_data, sv_pos_size, localB->X_k_tmp_data,
      localB->X_k_tmp_size, localB->sinus_lambda_k_data,
      localB->sinus_lambda_k_size, localB->c_data, localB->c_size,
      localB->t_k_data_l, localB->t_k_size_g);
  }
  ...
  if (localB->r_k_size[1] == localB->i_k_size[1]) {
    ...
    DDRTCM_times_jf(localB->d_data, localB->d_size, localB->r_k_data,
                    localB->r_k_size, localB->i_k_data, localB->i_k_size);
  }

  localB->loop_ub_c = sv_pos_size[0];
  for (localB->t_k_data_tmp = 0; localB->t_k_data_tmp < localB->loop_ub_c;
       localB->t_k_data_tmp++) {
  ...
  for (localB->t_k_data_tmp = 0; localB->t_k_data_tmp <= localB->vectorUB;
    ...
    _mm_storeu_pd(&localB->PHI_k_Dot_data[localB->t_k_data_tmp], _mm_sub_pd
                  (_mm_set1_pd(1.0), _mm_mul_pd(tmp_6, tmp_6)));
  }
  ...
  DDRTCM_sqrt_h(localB->PHI_k_Dot_data, localB->PHI_k_Dot_size, localB);
  if ((localB->PHI_k_Dot_size[1] == localB->E_k_Dot_size[1]) &&
      ((localB->PHI_k_Dot_size[1] == 1 ? localB->E_k_Dot_size[1] :
        localB->PHI_k_Dot_size[1]) == localB->r_k_Dot_size[1])) {
    ...
    for (localB->t_k_data_tmp = localB->scalarLB_f; localB->t_k_data_tmp <=
         localB->loop_ub_c; localB->t_k_data_tmp++) {
      localB->PHI_k_Dot_data[localB->t_k_data_tmp] = localB->
        PHI_k_Dot_data[localB->t_k_data_tmp] * localB->E_k_Dot_data
        [localB->t_k_data_tmp] / localB->y_tmp_data[localB->t_k_data_tmp];
    }
  } else {
    DDRTCM_binary_expand_op_kn(localB->PHI_k_Dot_data, localB->PHI_k_Dot_size,
      localB->E_k_Dot_data, localB->E_k_Dot_size, localB->y_tmp_data,
      localB->y_tmp_size, localB);
  }
  ...
  if ((Ephemeris_C_us_size[1] == localB->cos2PHI_k_size[1]) &&
    ...
    for (localB->t_k_data_tmp = localB->scalarLB_f; localB->t_k_data_tmp <
         localB->loop_ub_c; localB->t_k_data_tmp++) {
      localB->cosinus_E_k_data[localB->t_k_data_tmp] = ((2.0 *
    ...
    DDRTCM_binary_expand_op_d(localB->cosinus_E_k_data, localB->cosinus_E_k_size,
  ...
  for (localB->t_k_data_tmp = 0; localB->t_k_data_tmp <= localB->vectorUB;
       localB->t_k_data_tmp += 2) {
    tmp_6 = _mm_loadu_pd(&Ephemeris_SQRT_A_data[localB->t_k_data_tmp]);
    _mm_storeu_pd(&localB->y_tmp_data[localB->t_k_data_tmp], _mm_mul_pd(tmp_6,
      tmp_6));
  }
  ...
  if ((Ephemeris_C_rs_size[1] == localB->cos2PHI_k_size[1]) &&
    ...
    for (localB->t_k_data_tmp = 0; localB->t_k_data_tmp <= localB->vectorUB;
      ...
      _mm_storeu_pd(&localB->r_k_Dot_data[localB->t_k_data_tmp], _mm_add_pd
    ...
    for (localB->t_k_data_tmp = localB->scalarLB_f; localB->t_k_data_tmp <
         localB->loop_ub_c; localB->t_k_data_tmp++) {
      localB->N = Ephemeris_SQRT_A_data[localB->t_k_data_tmp];
      localB->r_k_Dot_data[localB->t_k_data_tmp] = (Ephemeris_C_rs_data
        [localB->t_k_data_tmp] * localB->cos2PHI_k_data[localB->t_k_data_tmp] -
    ...
    DDRTCM_binary_expand_op_at(localB->r_k_Dot_data, localB->r_k_Dot_size,
      Ephemeris_C_rs_data, Ephemeris_C_rs_size, localB->cos2PHI_k_data,
      localB->cos2PHI_k_size, Ephemeris_C_rc_data, Ephemeris_C_rc_size,
      localB->sin2PHI_k_data, localB->sin2PHI_k_size, localB->PHI_k_Dot_data,
      localB->PHI_k_Dot_size, Ephemeris_SQRT_A_data, Ephemeris_SQRT_A_size,
      Ephemeris_E_data, Ephemeris_E_size, localB->sinus_E_k_data,
      localB->sinus_E_k_size, localB->E_k_Dot_data, localB->E_k_Dot_size, localB);
  }
  ...
  if ((Ephemeris_C_is_size[1] == localB->cos2PHI_k_size[1]) &&
    ...
    DDRTCM_binary_expand_op_c4(localB->cos2PHI_k_data, localB->cos2PHI_k_size,
      Ephemeris_C_is_data, Ephemeris_C_is_size, Ephemeris_C_ic_data,
      Ephemeris_C_ic_size, localB->sin2PHI_k_data, localB->sin2PHI_k_size,
      localB->PHI_k_Dot_data, localB->PHI_k_Dot_size, Ephemeris_IDOT_data,
      Ephemeris_IDOT_size, localB);
  }

  if ((localB->r_k_Dot_size[1] == localB->cosinus_u_k_size[1]) &&
      (localB->r_k_size[1] == localB->cosinus_E_k_size[1]) &&
      ((localB->r_k_Dot_size[1] == 1 ? localB->cosinus_u_k_size[1] :
        localB->r_k_Dot_size[1]) == (localB->r_k_size[1] == 1 ?
    ...
    for (localB->t_k_data_tmp = localB->scalarLB_f; localB->t_k_data_tmp <=
      ...
      localB->cosinus_u_k_data[localB->t_k_data_tmp] = localB->
        r_k_Dot_data[localB->t_k_data_tmp] * localB->cosinus_u_k_data
        [localB->t_k_data_tmp] - localB->r_k_data[localB->t_k_data_tmp] *
        localB->cosinus_E_k_data[localB->t_k_data_tmp];
    }
  } else {
    DDRTCM_binary_expand_op_pf(localB->cosinus_u_k_data,
      localB->cosinus_u_k_size, localB->r_k_Dot_data, localB->r_k_Dot_size,
      localB->r_k_data, localB->r_k_size, localB->cosinus_E_k_data,
      localB->cosinus_E_k_size, localB);
  }

  if ((localB->r_k_Dot_size[1] == localB->PHI_k_size[1]) &&
      (localB->X_k_tmp_size[1] == localB->cosinus_E_k_size[1]) &&
      ((localB->r_k_Dot_size[1] == 1 ? localB->PHI_k_size[1] :
        localB->r_k_Dot_size[1]) == (localB->X_k_tmp_size[1] == 1 ?
        localB->cosinus_E_k_size[1] : localB->X_k_tmp_size[1]))) {
    localB->loop_ub_c = localB->r_k_Dot_size[1] - 1;
    localB->r_k_Dot_size[0] = 1;
    localB->scalarLB_f = (localB->r_k_Dot_size[1] / 2) << 1;
    localB->vectorUB = localB->scalarLB_f - 2;
    ...
    for (localB->t_k_data_tmp = localB->scalarLB_f; localB->t_k_data_tmp <=
         localB->loop_ub_c; localB->t_k_data_tmp++) {
      localB->r_k_Dot_data[localB->t_k_data_tmp] = localB->r_k_Dot_data
        [localB->t_k_data_tmp] * localB->PHI_k_data[localB->t_k_data_tmp] +
        localB->X_k_tmp_data[localB->t_k_data_tmp] * localB->
        cosinus_E_k_data[localB->t_k_data_tmp];
    }
  } else {
    DDRTCM_binary_expand_op_i1(localB->r_k_Dot_data, localB->r_k_Dot_size,
      localB->PHI_k_data, localB->PHI_k_size, localB->X_k_tmp_data,
      localB->X_k_tmp_size, localB->cosinus_E_k_data, localB->cosinus_E_k_size,
      localB);
  }
  ...
  if (localB->loop_ub_c - 1 >= 0) {
    std::memset(&sv_vel_data[0], 0, static_cast<uint32_T>(localB->loop_ub_c) *
                sizeof(real_T));
  }
  ...
  if (localB->r_k_Dot_size[1] == localB->cosinus_i_k_size[1]) {
    ...
    for (localB->t_k_data_tmp = localB->scalarLB_f; localB->t_k_data_tmp <=
      ...
      localB->cosinus_i_k_data[localB->t_k_data_tmp] *= localB->
        r_k_Dot_data[localB->t_k_data_tmp];
    }
  } else {
    DDRTCM_times_j(localB->cosinus_i_k_data, localB->cosinus_i_k_size,
                   localB->r_k_Dot_data, localB->r_k_Dot_size, localB);
  }

  if ((localB->cosinus_u_k_size[1] == localB->t_k_size_g[1]) &&
      (localB->cosinus_i_k_size[1] == localB->sinus_lambda_k_size[1]) &&
      ((localB->cosinus_u_k_size[1] == 1 ? localB->t_k_size_g[1] :
      ...
      (localB->d_size[1] == localB->sinus_lambda_k_size[1]) && ((localB->d_size
       ...
       localB->cos2PHI_k_size[1]) && (((localB->cosinus_u_k_size[1] == 1 ?
         localB->t_k_size_g[1] : localB->cosinus_u_k_size[1]) == 1 ?
        localB->cosinus_i_k_size[1] == 1 ? localB->sinus_lambda_k_size[1] :
        localB->cosinus_i_k_size[1] : localB->cosinus_u_k_size[1] == 1 ?
        localB->t_k_size_g[1] : localB->cosinus_u_k_size[1]) == ((localB->
         d_size[1] == 1 ? localB->sinus_lambda_k_size[1] : localB->d_size[1]) ==
        1 ? localB->cos2PHI_k_size[1] : localB->d_size[1] == 1 ?
    ...
    binary_expand_o_olyqzrqpqmlmbao(sv_vel_data, localB->cosinus_u_k_data,
      localB->cosinus_u_k_size, localB->t_k_data_l, localB->t_k_size_g,
  ...
  if ((localB->cosinus_u_k_size[1] == localB->sinus_lambda_k_size[1]) &&
      (localB->cosinus_i_k_size[1] == localB->t_k_size_g[1]) &&
      ((localB->cosinus_u_k_size[1] == 1 ? localB->sinus_lambda_k_size[1] :
        localB->cosinus_u_k_size[1]) == (localB->cosinus_i_k_size[1] == 1 ?
        localB->t_k_size_g[1] : localB->cosinus_i_k_size[1])) && (localB->
       d_size[1] == localB->t_k_size_g[1]) && ((localB->d_size[1] == 1 ?
        localB->t_k_size_g[1] : localB->d_size[1]) == localB->cos2PHI_k_size[1])
      && (((localB->cosinus_u_k_size[1] == 1 ? localB->sinus_lambda_k_size[1] :
            localB->cosinus_u_k_size[1]) == 1 ? localB->cosinus_i_k_size[1] == 1
           ? localB->t_k_size_g[1] : localB->cosinus_i_k_size[1] :
           localB->cosinus_u_k_size[1] == 1 ? localB->sinus_lambda_k_size[1] :
           localB->cosinus_u_k_size[1]) == ((localB->d_size[1] == 1 ?
         localB->t_k_size_g[1] : localB->d_size[1]) == 1 ?
        localB->cos2PHI_k_size[1] : localB->d_size[1] == 1 ? localB->t_k_size_g
        [1] : localB->d_size[1])) && (sv_pos_size[0] == Ephemeris_OMEGADOT_size
       [1]) && ((((localB->cosinus_u_k_size[1] == 1 ?
                   localB->sinus_lambda_k_size[1] : localB->cosinus_u_k_size[1])
                  == 1 ? localB->cosinus_i_k_size[1] == 1 ? localB->t_k_size_g[1]
                  : localB->cosinus_i_k_size[1] : localB->cosinus_u_k_size[1] ==
                  1 ? localB->sinus_lambda_k_size[1] : localB->cosinus_u_k_size
                  [1]) == 1 ? (localB->d_size[1] == 1 ? localB->t_k_size_g[1] :
         localB->d_size[1]) == 1 ? localB->cos2PHI_k_size[1] : localB->d_size[1]
                 == 1 ? localB->t_k_size_g[1] : localB->d_size[1] :
                 (localB->cosinus_u_k_size[1] == 1 ? localB->
                  sinus_lambda_k_size[1] : localB->cosinus_u_k_size[1]) == 1 ?
                 localB->cosinus_i_k_size[1] == 1 ? localB->t_k_size_g[1] :
                 localB->cosinus_i_k_size[1] : localB->cosinus_u_k_size[1] == 1 ?
                 localB->sinus_lambda_k_size[1] : localB->cosinus_u_k_size[1]) ==
                (sv_pos_size[0] == 1 ? Ephemeris_OMEGADOT_size[1] : sv_pos_size
                 [0]))) {
    ...
    binary_expand_op_olyqzrqpqmlmba(sv_vel_data, sv_vel_size,
      localB->cosinus_u_k_data, localB->cosinus_u_k_size,
      localB->sinus_lambda_k_data, localB->sinus_lambda_k_size,
      localB->cosinus_i_k_data, localB->cosinus_i_k_size, localB->t_k_data_l,
      localB->t_k_size_g, localB->d_data, localB->d_size, localB->cos2PHI_k_data,
      localB->cos2PHI_k_size, sv_pos_data, sv_pos_size, localB->f_data,
      localB->f_size, localB);
  }

  if ((localB->r_k_Dot_size[1] == localB->i_k_size[1]) && (localB->c_size[1] ==
       localB->cos2PHI_k_size[1]) && ((localB->r_k_Dot_size[1] == 1 ?
        localB->i_k_size[1] : localB->r_k_Dot_size[1]) == (localB->c_size[1] ==
    ...
    for (localB->t_k_data_tmp = localB->scalarLB_f; localB->t_k_data_tmp <
      ...
      sv_vel_data[localB->t_k_data_tmp + (sv_vel_size[0] << 1)] =
        localB->r_k_Dot_data[localB->t_k_data_tmp] * localB->i_k_data
        [localB->t_k_data_tmp] + localB->c_data[localB->t_k_data_tmp] *
        localB->cos2PHI_k_data[localB->t_k_data_tmp];
    }
  } else {
    binary_expand_op_olyqzrqpqmlmb(sv_vel_data, sv_vel_size,
      localB->r_k_Dot_data, localB->r_k_Dot_size, localB->i_k_data,
  ...
  for (localB->t_k_data_tmp = 0; localB->t_k_data_tmp <= localB->vectorUB;
    ...
    _mm_storeu_pd(&localB->t_k_data_l[localB->t_k_data_tmp], _mm_add_pd
                  (_mm_add_pd(_mm_mul_pd(tmp_6, tmp_6), _mm_mul_pd(tmp_4, tmp_4)),
                   _mm_mul_pd(tmp_5, tmp_5)));
  }
  ...
  for (localB->t_k_data_tmp = localB->scalarLB_tmp; localB->t_k_data_tmp <
    ...
    localB->varargin_1 = sv_pos_data[localB->t_k_data_tmp + sv_pos_size[0]] -
      localB->y_user;
    localB->varargin_1_n = sv_pos_data[(sv_pos_size[0] << 1) +
      localB->t_k_data_tmp] - localB->z_user;
    localB->t_k_data_l[localB->t_k_data_tmp] = (localB->N * localB->N +
      localB->varargin_1 * localB->varargin_1) + localB->varargin_1_n *
      localB->varargin_1_n;
  }

  DDRTCM_sqrt_hy(localB->t_k_data_l, &localB->transport_angle_size, localB);
  ...
  for (localB->t_k_data_tmp = 0; localB->t_k_data_tmp <= localB->vectorUB;
    ...
    _mm_storeu_pd(&localB->t_k_data_l[localB->t_k_data_tmp], _mm_mul_pd
                  (_mm_div_pd(tmp_6, _mm_set1_pd(2.99792458E+8)), _mm_set1_pd
                   (-7.2921151467E-5)));
  }

  for (localB->t_k_data_tmp = localB->scalarLB_f; localB->t_k_data_tmp <
       localB->loop_ub_c; localB->t_k_data_tmp++) {
    localB->t_k_data_l[localB->t_k_data_tmp] = localB->t_k_data_l
  ...
  for (localB->vectorUB = 0; localB->vectorUB < localB->scalarLB_f;
       localB->vectorUB++) {
    ...
    for (localB->t_k_data_tmp = 0; localB->t_k_data_tmp <= 0;
      ...
      _mm_storeu_pd(&localB->sv_pos_tmp_o[localB->t_k_data_tmp], _mm_add_pd
    ...
    for (localB->t_k_data_tmp = 2; localB->t_k_data_tmp < 3;
         localB->t_k_data_tmp++) {
      localB->sv_pos_tmp_o[localB->t_k_data_tmp] = sv_pos_data[(sv_pos_size[0] <<
    ...
    for (localB->t_k_data_tmp = 2; localB->t_k_data_tmp < 3;
         localB->t_k_data_tmp++) {
      localB->sv_pos_tmp_o[localB->t_k_data_tmp] = sv_vel_data[(sv_vel_size[0] <<
...
void DDRTCM::DDRTCM_binary_expand_op_olyqzr(const gnssops_navigation_data *in1,
  const real_T in3_data[], const int32_T *in3_size, const real_T in4_data[],
  const int32_T in4_size[2], const real_T in5_data[], const int32_T in5_size[2],
  const real_T in6_data[], const int32_T in6_size[2], const real_T in7_data[],
  ...
  const int32_T in10_size[2], const real_T in11[3], real_T in12_data[], int32_T
  in12_size[2], real_T in13_data[], int32_T in13_size[2],
  B_CalculateDifferentialCorr_b_T *localB)
{
  localB->in1_size[0] = 1;
  ...
  for (localB->i_m = 0; localB->i_m < localB->loop_ub; localB->i_m++) {
    localB->in1_data_c[localB->i_m] = in1->C_rs[static_cast<int32_T>
      (in3_data[localB->i_m]) - 1];
  }
  ...
  localB->loop_ub = *in3_size;
  for (localB->i_m = 0; localB->i_m < localB->loop_ub; localB->i_m++) {
    localB->in1_data_f[localB->i_m] = in1->C_uc[static_cast<int32_T>
      (in3_data[localB->i_m]) - 1];
  }
  ...
  localB->loop_ub = *in3_size;
  for (localB->i_m = 0; localB->i_m < localB->loop_ub; localB->i_m++) {
    localB->in1_data_g[localB->i_m] = in1->C_us[static_cast<int32_T>
      (in3_data[localB->i_m]) - 1];
  }
  ...
  localB->loop_ub = *in3_size;
  for (localB->i_m = 0; localB->i_m < localB->loop_ub; localB->i_m++) {
    localB->in1_data_g1[localB->i_m] = in1->C_ic[static_cast<int32_T>
      (in3_data[localB->i_m]) - 1];
  }
  ...
  localB->loop_ub = *in3_size;
  for (localB->i_m = 0; localB->i_m < localB->loop_ub; localB->i_m++) {
    localB->in1_data_m[localB->i_m] = in1->OMEGA_0[static_cast<int32_T>
      (in3_data[localB->i_m]) - 1];
  }
  ...
  localB->loop_ub = *in3_size;
  for (localB->i_m = 0; localB->i_m < localB->loop_ub; localB->i_m++) {
    localB->in1_data_n[localB->i_m] = in1->C_is[static_cast<int32_T>
      (in3_data[localB->i_m]) - 1];
  }
  ...
  localB->loop_ub = *in3_size;
  for (localB->i_m = 0; localB->i_m < localB->loop_ub; localB->i_m++) {
    localB->in1_data_p[localB->i_m] = in1->I_0[static_cast<int32_T>
      (in3_data[localB->i_m]) - 1];
  }
  ...
  localB->loop_ub = *in3_size;
  for (localB->i_m = 0; localB->i_m < localB->loop_ub; localB->i_m++) {
    localB->in1_data_l[localB->i_m] = in1->C_rc[static_cast<int32_T>
      (in3_data[localB->i_m]) - 1];
  }
  ...
  localB->loop_ub = *in3_size;
  for (localB->i_m = 0; localB->i_m < localB->loop_ub; localB->i_m++) {
    localB->in1_data_j[localB->i_m] = in1->omega[static_cast<int32_T>
      (in3_data[localB->i_m]) - 1];
  }
  ...
  localB->loop_ub = *in3_size;
  for (localB->i_m = 0; localB->i_m < localB->loop_ub; localB->i_m++) {
    localB->in1_data_d[localB->i_m] = in1->OMEGADOT[static_cast<int32_T>
      (in3_data[localB->i_m]) - 1];
  }
  ...
  localB->loop_ub = *in3_size;
  for (localB->i_m = 0; localB->i_m < localB->loop_ub; localB->i_m++) {
    localB->in1_data_gu[localB->i_m] = in1->IDOT[static_cast<int32_T>
      (in3_data[localB->i_m]) - 1];
  }
  ...
  for (localB->i_m = 0; localB->i_m < localB->loop_ub; localB->i_m++) {
    localB->in9_data[localB->i_m] = in9_data[localB->i_m * localB->stride_0_1] -
      in10_data[localB->i_m * localB->stride_1_1];
  }

  Get_Kepler_Satellite_Position_j(localB->in1_data_c, localB->in1_size, in4_data,
    in4_size, in5_data, in5_size, localB->in1_data_f, localB->in1_size_a,
    in6_data, in6_size, localB->in1_data_g, localB->in1_size_as, in7_data,
    in7_size, in8_data, in8_size, localB->in1_data_g1, localB->in1_size_i,
    localB->in1_data_m, localB->in1_size_l, localB->in1_data_n,
    localB->in1_size_o, localB->in1_data_p, localB->in1_size_o2,
    localB->in1_data_l, localB->in1_size_ip, localB->in1_data_j,
    localB->in1_size_f, localB->in1_data_d, localB->in1_size_iz,
    localB->in1_data_gu, localB->in1_size_ff, localB->in9_data, localB->in9_size,
    in11, in12_data, in12_size, in13_data, in13_size, localB);
}

void DDRTCM::DDRTCM_binary_expand_op_olyqz(real_T in1_data[], int32_T *in1_size,
...
void DDRTCM::DDRTCM_binary_expand_op_olyq(real_T in1_data[], int32_T *in1_size,
  ...
  B_CalculateDifferentialCorr_b_T *localB)
{
  ...
  for (localB->i19 = 0; localB->i19 < loop_ub; localB->i19++) {
    localB->in1_data[localB->i19] = in2_data[localB->i19 * stride_1_0] *
      2.99792458E+8 + in1_data[localB->i19 * stride_0_0];
  }

  *in1_size = in1_size_idx_0;
  if (in1_size_idx_0 - 1 >= 0) {
    std::memcpy(&in1_data[0], &localB->in1_data[0], static_cast<uint32_T>
...
//    '<S202>/Calculate Differential Corrections'
//
void DDRTCM::CalculateDifferentialCor_l_Init(DW_CalculateDifferentialCor_h_T
  *localDW)
{
...
//    '<S202>/Calculate Differential Corrections'
//
void DDRTCM::CalculateDifferentialCorrecti_f(const GNSS_Measurement
  ...
  DW_CalculateDifferentialCor_h_T *localDW)
{
  ...
  if ((rtu_GalMeasurementB->time_receive > localDW->old_t) ||
    ...
    localB->a_size = rtu_GalMeasurementB_DIMS1->PRN;
    localB->vstride = rtu_GalMeasurementB_DIMS1->PRN;
    if (localB->vstride - 1 >= 0) {
      std::memcpy(&localB->a_data[0], &rtu_GalMeasurementB->PRN[0], static_cast<
                  uint32_T>(localB->vstride) * sizeof(uint16_T));
    }

    DDRTCM_sort_a(localB->a_data, &localB->a_size, localB->iidx_data,
                  &localB->iidx_size, localB);
    localB->rtu_gpsNavDataBusL1_DIMS1 = rtu_gpsNavDataBusL1_DIMS1->SVID;
    DDRTCM_do_vectors_o(localB->a_data, &localB->a_size,
                        rtu_gpsNavDataBusL1->SVID,
                        &localB->rtu_gpsNavDataBusL1_DIMS1, localDW->PRNs.data,
                        &localDW->PRNs.size, localB->iia_data, &localB->iia_size,
                        localB->iib_data, &localB->iib_size);
    ...
    localB->vstride = localB->iib_size;
    for (localB->k = 0; localB->k < localB->vstride; localB->k++) {
      localB->navdata_DELTA_N_data[localB->k] = rtu_gpsNavDataBusL1->DELTA_N[
    ...
    localB->vstride = localB->iib_size;
    for (localB->k = 0; localB->k < localB->vstride; localB->k++) {
      localB->navdata_M_0_data[localB->k] = rtu_gpsNavDataBusL1->M_0[
        static_cast<int32_T>(localB->real_range_data[localB->k]) - 1];
    }
    ...
    localB->vstride = localB->iib_size;
    for (localB->k = 0; localB->k < localB->vstride; localB->k++) {
      localB->navdata_E_data[localB->k] = rtu_gpsNavDataBusL1->E
        [static_cast<int32_T>(localB->real_range_data[localB->k]) - 1];
    }
    ...
    localB->vstride = localB->iib_size;
    for (localB->k = 0; localB->k < localB->vstride; localB->k++) {
      localB->navdata_SQRT_A_data[localB->k] = rtu_gpsNavDataBusL1->SQRT_A[
        static_cast<int32_T>(localB->real_range_data[localB->k]) - 1];
    }
    ...
    localB->vstride = localB->iib_size;
    for (localB->k = 0; localB->k < localB->vstride; localB->k++) {
      localB->navdata_T_oe_data[localB->k] = rtu_gpsNavDataBusL1->T_oe[
        static_cast<int32_T>(localB->real_range_data[localB->k]) - 1];
    }

    localB->vstride = localB->iidx_size;
    for (localB->k = 0; localB->k < localB->vstride; localB->k++) {
      localB->b_data[localB->k] = rtu_GalMeasurementB->pseudorange
        [localB->iidx_data[localB->k] - 1];
    }
    ...
    for (localB->k = 0; localB->k < localB->vstride; localB->k++) {
      localB->t_sv_emission_data[localB->k] = rtu_GalMeasurementB->time_receive
        - localB->b_data[localB->iia_data[localB->k] - 1] / 2.99792458E+8;
    }
    ...
    if (localB->iib_size == localB->iia_size) {
      ...
      for (localB->k = 0; localB->k < localB->vstride; localB->k++) {
        localB->t_d_data[localB->k] = localB->t_sv_emission_data[localB->k] -
          rtu_gpsNavDataBusL1->T_oc[static_cast<int32_T>(localB->
          real_range_data[localB->k]) - 1];
      }
    } else {
      DDR_binary_expand_op_olyqzrqpqm(localB->t_d_data, localB->t_d_size,
        localB->t_sv_emission_data, localB->t_sv_emission_size,
        rtu_gpsNavDataBusL1, localB->real_range_data, &localB->real_range_size);
    }
    ...
    for (localB->k = 0; localB->k <= localB->vstride; localB->k++) {
      ...
      localB->t_d_data[localB->k] = (localB->t_d - static_cast<real_T>
    ...
    if (localB->iia_size == localB->iib_size) {
      ...
      for (localB->k = localB->scalarLB; localB->k < localB->vstride; localB->k
        ...
        localB->t_k_data[localB->k] = localB->t_sv_emission_data[localB->k] -
          localB->navdata_T_oe_data[localB->k];
      }
    } else {
      DDRTCM_minus_da(localB->t_k_data, localB->t_k_size,
                      localB->t_sv_emission_data, localB->t_sv_emission_size,
                      localB->navdata_T_oe_data, localB->navdata_T_oe_size);
    }
    ...
    for (localB->k = 0; localB->k < localB->vstride; localB->k++) {
      ...
      localB->n_0_data[localB->k] = 3.986005E+14 / DDRTCM_rt_powd_snf_d
        (localB->t_d * localB->t_d, 3.0, localB);
    }
    ...
    if ((localB->iib_size == localB->t_k_size[1]) && ((localB->iib_size == 1 ?
          localB->t_k_size[1] : localB->iib_size) == localB->iib_size)) {
      localB->vstride = localB->iib_size - 1;
      localB->n_0_size[0] = 1;
      localB->n_0_size[1] = localB->iib_size;
      for (localB->k = 0; localB->k <= localB->vstride; localB->k++) {
        localB->t_d = localB->t_k_data[localB->k];
        localB->n_0_data[localB->k] = ((localB->t_d - static_cast<real_T>
          (localB->t_d > 302400.0) * 604800.0) + static_cast<real_T>(localB->t_d
          < -302400.0) * 604800.0) * (localB->n_0_data[localB->k] +
          localB->navdata_DELTA_N_data[localB->k]) + localB->
          navdata_M_0_data[localB->k];
      }
    } else {
      DDRT_binary_expand_op_olyqzrqpq(localB->n_0_data, localB->n_0_size,
        localB->navdata_M_0_data, localB->navdata_M_0_size,
        localB->navdata_DELTA_N_data, localB->navdata_DELTA_N_size,
        localB->t_k_data, localB->t_k_size, localB);
    }

    if ((localB->iib_size == localB->n_0_size[1]) && ((localB->iib_size == 1 ?
          localB->n_0_size[1] : localB->iib_size) == localB->iib_size)) {
      localB->E_k_size[0] = 1;
      localB->E_k_size[1] = localB->iib_size;
      localB->vstride = localB->iib_size;
      for (localB->k = 0; localB->k < localB->vstride; localB->k++) {
        localB->t_d = localB->navdata_E_data[localB->k];
        localB->E_k_data[localB->k] = static_cast<real_T>(localB->t_d > 0.8) *
          3.1415926535897931 + static_cast<real_T>(localB->t_d <= 0.8) *
          localB->n_0_data[localB->k];
      }
    } else {
      DDRTC_binary_expand_op_olyqzrqp(localB->E_k_data, localB->E_k_size,
        localB->navdata_E_data, localB->navdata_E_size, localB->n_0_data,
        localB->n_0_size, localB);
    }
    ...
    do {
      ...
      if (DDRTCM_any_f(localB->t_k_data_n, localB->t_k_size_j, localB) &&
          (localB->i < 20)) {
        localB->E_k_old_size[0] = 1;
        localB->E_k_old_size[1] = localB->E_k_size[1];
        localB->vstride = localB->E_k_size[1];
        if (localB->vstride - 1 >= 0) {
          std::memcpy(&localB->E_k_old_data[0], &localB->E_k_data[0],
                      static_cast<uint32_T>(localB->vstride) * sizeof(real_T));
        }
        ...
        if ((localB->navdata_E_size[1] == localB->E_k_size[1]) &&
            ((localB->navdata_E_size[1] == 1 ? localB->E_k_size[1] :
              localB->navdata_E_size[1]) == localB->n_0_size[1])) {
          ...
          for (localB->k = localB->scalarLB; localB->k <= localB->vstride;
               localB->k++) {
            localB->E_k_data[localB->k] = localB->navdata_E_data[localB->k] *
              localB->E_k_data[localB->k] + localB->n_0_data[localB->k];
          }
        } else {
          DDRTCM_binary_expand_op_oly(localB->E_k_data, localB->E_k_size,
            localB->n_0_data, localB->n_0_size, localB->navdata_E_data,
            localB->navdata_E_size, localB);
        }
        ...
        if (localB->E_k_size[1] == localB->E_k_old_size[1]) {
          ...
          for (localB->k = 0; localB->k <= localB->acoef; localB->k += 2) {
            ...
            _mm_storeu_pd(&localB->E_k_old_data[localB->k], _mm_sub_pd(tmp_0,
              tmp_1));
          }

          for (localB->k = localB->scalarLB; localB->k <= localB->vstride;
               localB->k++) {
            localB->E_k_old_data[localB->k] = localB->E_k_data[localB->k] -
              localB->E_k_old_data[localB->k];
          }
        } else {
          DDRTCM_minus_d(localB->E_k_old_data, localB->E_k_old_size,
    ...
    if ((localB->iib_size == localB->t_d_size[1]) && ((localB->iib_size == 1 ?
          localB->t_d_size[1] : localB->iib_size) == localB->iib_size) &&
        (localB->iib_size == localB->t_d_size[1]) && ((localB->iib_size == 1 ?
          localB->iib_size == 1 ? localB->t_d_size[1] : localB->iib_size :
          localB->iib_size) == (localB->iib_size == 1 ? localB->t_d_size[1] :
          localB->iib_size)) && (localB->iib_size == localB->E_k_size[1]) &&
        (((localB->iib_size == 1 ? localB->iib_size == 1 ? localB->t_d_size[1] :
           localB->iib_size : localB->iib_size) == 1 ? localB->iib_size == 1 ?
          localB->t_d_size[1] : localB->iib_size : localB->iib_size == 1 ?
          localB->iib_size == 1 ? localB->t_d_size[1] : localB->iib_size :
          localB->iib_size) == (localB->iib_size == 1 ? localB->E_k_size[1] :
          localB->iib_size))) {
      localB->t_d_size[0] = 1;
      ...
      for (localB->k = 0; localB->k < localB->vstride; localB->k++) {
        localB->t_d = localB->t_d_data[localB->k];
        localB->scalarLB = static_cast<int32_T>(localB->real_range_data
          [localB->k]) - 1;
        localB->t_d_data[localB->k] = ((rtu_gpsNavDataBusL1->A_f1
          [localB->scalarLB] * localB->t_d + rtu_gpsNavDataBusL1->A_f0
          [localB->scalarLB]) + localB->t_d * localB->t_d *
          rtu_gpsNavDataBusL1->A_f2[localB->scalarLB]) + -4.44280763339306E-10 *
          localB->navdata_E_data[localB->k] * localB->navdata_SQRT_A_data
          [localB->k] * localB->E_k_data[localB->k];
      }
    } else {
      DDRTCM_binary_expand_op_olyqzrq(localB->t_d_data, localB->t_d_size,
        rtu_gpsNavDataBusL1, localB->real_range_data, &localB->real_range_size,
        localB->navdata_E_data, localB->navdata_E_size,
        localB->navdata_SQRT_A_data, localB->navdata_SQRT_A_size,
        localB->E_k_data, localB->E_k_size, localB);
    }
    ...
    if (localB->iia_size == localB->t_d_size[1]) {
      ...
      localB->vstride = localB->iib_size;
      for (localB->k = 0; localB->k < localB->vstride; localB->k++) {
        localB->E_k_data[localB->k] = rtu_gpsNavDataBusL1->C_rs
          [static_cast<int32_T>(localB->real_range_data[localB->k]) - 1];
      }
      ...
      localB->vstride = localB->iib_size;
      for (localB->k = 0; localB->k < localB->vstride; localB->k++) {
        localB->t_k_data[localB->k] = rtu_gpsNavDataBusL1->C_uc
          [static_cast<int32_T>(localB->real_range_data[localB->k]) - 1];
      }
      ...
      localB->vstride = localB->iib_size;
      for (localB->k = 0; localB->k < localB->vstride; localB->k++) {
        localB->n_0_data[localB->k] = rtu_gpsNavDataBusL1->C_us
          [static_cast<int32_T>(localB->real_range_data[localB->k]) - 1];
      }
      ...
      localB->vstride = localB->iib_size;
      for (localB->k = 0; localB->k < localB->vstride; localB->k++) {
        localB->E_k_old_data[localB->k] = rtu_gpsNavDataBusL1->C_ic[static_cast<
          int32_T>(localB->real_range_data[localB->k]) - 1];
      }
      ...
      localB->vstride = localB->iib_size;
      for (localB->k = 0; localB->k < localB->vstride; localB->k++) {
        localB->rtu_gpsNavDataBusL1_data[localB->k] =
          rtu_gpsNavDataBusL1->OMEGA_0[static_cast<int32_T>
      ...
      localB->vstride = localB->iib_size;
      for (localB->k = 0; localB->k < localB->vstride; localB->k++) {
        localB->rtu_gpsNavDataBusL1_data_m[localB->k] =
          rtu_gpsNavDataBusL1->C_is[static_cast<int32_T>(localB->
          real_range_data[localB->k]) - 1];
      }
      ...
      localB->vstride = localB->iib_size;
      for (localB->k = 0; localB->k < localB->vstride; localB->k++) {
        localB->rtu_gpsNavDataBusL1_data_c[localB->k] = rtu_gpsNavDataBusL1->
          I_0[static_cast<int32_T>(localB->real_range_data[localB->k]) - 1];
      }
      ...
      localB->vstride = localB->iib_size;
      for (localB->k = 0; localB->k < localB->vstride; localB->k++) {
        localB->rtu_gpsNavDataBusL1_data_k[localB->k] =
          rtu_gpsNavDataBusL1->C_rc[static_cast<int32_T>(localB->
          real_range_data[localB->k]) - 1];
      }
      ...
      localB->vstride = localB->iib_size;
      for (localB->k = 0; localB->k < localB->vstride; localB->k++) {
        localB->rtu_gpsNavDataBusL1_data_cx[localB->k] =
          rtu_gpsNavDataBusL1->omega[static_cast<int32_T>
          (localB->real_range_data[localB->k]) - 1];
      }
      ...
      localB->vstride = localB->iib_size;
      for (localB->k = 0; localB->k < localB->vstride; localB->k++) {
        localB->rtu_gpsNavDataBusL1_data_b[localB->k] =
          rtu_gpsNavDataBusL1->OMEGADOT[static_cast<int32_T>
          (localB->real_range_data[localB->k]) - 1];
      }
      ...
      localB->vstride = localB->iib_size;
      for (localB->k = 0; localB->k < localB->vstride; localB->k++) {
        localB->rtu_gpsNavDataBusL1_data_p[localB->k] =
          rtu_gpsNavDataBusL1->IDOT[static_cast<int32_T>(localB->
          real_range_data[localB->k]) - 1];
      }
      ...
      for (localB->k = 0; localB->k <= localB->acoef; localB->k += 2) {
        ...
        _mm_storeu_pd(&localB->real_range_data[localB->k], _mm_sub_pd(tmp_0,
          tmp_1));
      }

      for (localB->k = localB->scalarLB; localB->k < localB->vstride; localB->k
           ++) {
        localB->real_range_data[localB->k] = localB->t_sv_emission_data
          [localB->k] - localB->t_d_data[localB->k];
      }

      Get_Kepler_Satellite_Position_j(localB->E_k_data, localB->E_k_size,
        localB->navdata_DELTA_N_data, localB->navdata_DELTA_N_size,
        localB->navdata_M_0_data, localB->navdata_M_0_size, localB->t_k_data,
        localB->t_k_size, localB->navdata_E_data, localB->navdata_E_size,
        localB->n_0_data, localB->n_0_size, localB->navdata_SQRT_A_data,
        localB->navdata_SQRT_A_size, localB->navdata_T_oe_data,
        localB->navdata_T_oe_size, localB->E_k_old_data, localB->E_k_old_size,
        localB->rtu_gpsNavDataBusL1_data, localB->rtu_gpsNavDataBusL1_size,
        localB->rtu_gpsNavDataBusL1_data_m, localB->rtu_gpsNavDataBusL1_size_h,
        ...
        localB->rtu_gpsNavDataBusL1_data_p, localB->rtu_gpsNavDataBusL1_size_a,
        localB->real_range_data, localB->t_sv_emission_size_e, rtu_userPosLlh,
        localB->b_a_data, localB->t_k_size_j, localB->real_delta_data,
        localB->real_delta_size, localB);
    } else {
      DDRTCM_binary_expand_op_olyqzr(rtu_gpsNavDataBusL1,
        localB->real_range_data, &localB->real_range_size,
        localB->navdata_DELTA_N_data, localB->navdata_DELTA_N_size,
        localB->navdata_M_0_data, localB->navdata_M_0_size,
        localB->navdata_E_data, localB->navdata_E_size,
        localB->navdata_SQRT_A_data, localB->navdata_SQRT_A_size,
        localB->navdata_T_oe_data, localB->navdata_T_oe_size,
        localB->t_sv_emission_data, localB->t_sv_emission_size, localB->t_d_data,
        localB->t_d_size, rtu_userPosLlh, localB->b_a_data, localB->t_k_size_j,
    ...
    if (static_cast<int8_T>(localB->t_k_size_j[0]) != 0) {
      ...
      for (localB->k = 0; localB->k < 3; localB->k++) {
        ...
        for (localB->scalarLB = 0; localB->scalarLB <= localB->i;
             localB->scalarLB++) {
          localB->real_delta_data[localB->scalarLB + localB->real_delta_size[0] *
            localB->k] = localB->b_a_data[localB->acoef * localB->scalarLB +
            localB->t_k_size_j[0] * localB->k] -
            rtu_GalMeasurementB->base_position[localB->k];
        }
      }
    }
    ...
    if (static_cast<int8_T>(localB->t_k_size_j[0]) == 0) {
      ...
      std::memcpy(&localB->real_range_data[0], &localB->real_delta_data[0],
                  static_cast<uint32_T>(localB->scalarLB) * sizeof(real_T));
      for (localB->k = 0; localB->k < 2; localB->k++) {
        ...
        for (localB->i = 0; localB->i <= localB->acoef; localB->i += 2) {
          tmp_0 = _mm_loadu_pd(&localB->real_delta_data[localB->xoffset +
                               localB->i]);
          tmp_1 = _mm_loadu_pd(&localB->real_range_data[localB->i]);
          _mm_storeu_pd(&localB->real_range_data[localB->i], _mm_add_pd(tmp_0,
            tmp_1));
        }

        for (localB->i = localB->scalarLB; localB->i < localB->vstride;
             localB->i++) {
          localB->real_range_data[localB->i] += localB->real_delta_data
            [localB->xoffset + localB->i];
        }
      }
    }
    ...
    for (localB->k = localB->scalarLB; localB->k < localB->i; localB->k++) {
      localB->real_range_data[localB->k] = std::sqrt(localB->
        real_range_data[localB->k]);
    }
    ...
    if (localB->iia_size == localB->real_range_size) {
      ...
      localB->vstride = localB->iia_size;
      for (localB->k = 0; localB->k < localB->vstride; localB->k++) {
        localDW->delta_pr2.data[localB->k] = localB->b_data[localB->
          iia_data[localB->k] - 1] - localB->real_range_data[localB->k];
      }
    } else {
      DDRTCM_binary_expand_op_olyqz(localDW->delta_pr2.data,
        &localDW->delta_pr2.size, localB->b_data, localB->iia_data,
        &localB->iia_size, localB->real_range_data, &localB->real_range_size);
    }
    ...
    if (localDW->delta_pr2.size == localB->t_d_size[1]) {
      ...
      for (localB->k = 0; localB->k <= localB->acoef; localB->k += 2) {
        ...
        _mm_storeu_pd(&localDW->delta_pr2.data[localB->k], _mm_add_pd(_mm_mul_pd
          (tmp_0, _mm_set1_pd(2.99792458E+8)), tmp_1));
      }

      for (localB->k = localB->scalarLB; localB->k < localB->vstride; localB->k
           ++) {
        localDW->delta_pr2.data[localB->k] += localB->t_d_data[localB->k] *
          2.99792458E+8;
      }
    } else {
      DDRTCM_binary_expand_op_olyq(localDW->delta_pr2.data,
        &localDW->delta_pr2.size, localB->t_d_data, localB->t_d_size, localB);
    }
  ...
  if (localB->vstride - 1 >= 0) {
    std::memcpy(&localB->maskDiffCorr[0], &localDW->PRNs.data[0],
                static_cast<uint32_T>(localB->vstride) * sizeof(uint16_T));
  }
  ...
  if (localB->vstride - 1 >= 0) {
    std::memcpy(&localB->diffPseudorangeCorrection[0], &localDW->delta_pr2.data
                [0], static_cast<uint32_T>(localB->vstride) * sizeof(real_T));
  }
}
