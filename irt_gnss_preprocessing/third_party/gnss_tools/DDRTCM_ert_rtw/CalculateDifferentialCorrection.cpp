...
// Function for MATLAB Function: '<S28>/Calculate Differential Corrections'
void DDRTCM::DDRTCM_merge(int32_T idx_data[], uint16_T x_data[], int32_T offset,
...
// Function for MATLAB Function: '<S28>/Calculate Differential Corrections'
void DDRTCM::DDRTCM_sort(uint16_T x_data[], const int32_T *x_size, int32_T
  ...
  *idx_size = *x_size;
  ...
  for (localB->dim = 0; localB->dim < localB->vstride_o; localB->dim++) {
    ...
    if (localB->vwork_size_idx_0 - 1 >= 0) {
      std::memcpy(&localB->b_x_data[0], &localB->vwork_data[0], static_cast<
                  uint32_T>(localB->vwork_size_idx_0) * sizeof(uint16_T));
    }
    ...
    if (localB->vwork_size_idx_0 != 0) {
      ...
      if (localB->vwork_size_idx_0 > 1) {
        ...
        while (localB->nLeft > 1) {
          if ((static_cast<uint32_T>(localB->nLeft) & 1U) != 0U) {
            ...
            if (localB->b_i > localB->nDone) {
              DDRTCM_merge(localB->b_idx_data, localB->b_x_data, localB->i1_b,
        ...
        if (localB->vwork_size_idx_0 > localB->nDone) {
          DDRTCM_merge(localB->b_idx_data, localB->b_x_data, 0, localB->nDone,
                       localB->vwork_size_idx_0 - localB->nDone,
                       localB->iwork_data, localB->vwork_data, localB);
        }
      }
...
// Function for MATLAB Function: '<S28>/Calculate Differential Corrections'
void DDRTCM::DDRTCM_do_vectors(const uint16_T a_data[], const int32_T *a_size,
...
void DDRTCM::DDRTC_binary_expand_op_nh5as5ql(real_T in1_data[], int32_T
...
void DDRTCM::DDRTCM_minus_hi(real_T in1_data[], int32_T in1_size[2], const
...
real_T DDRTCM::DDRTCM_rt_powd_snf_ic(real_T u0, real_T u1,
  B_CalculateDifferentialCorrec_T *localB)
{
  real_T y;
...
void DDRTCM::DDRTCM_binary_expand_op_nh5as5q(real_T in1_data[], int32_T
...
void DDRTCM::DDRTCM_binary_expand_op_nh5as5(real_T in1_data[], int32_T in1_size
  [2], const real_T in2_data[], const int32_T in2_size[2], const real_T
  in3_data[], const int32_T in3_size[2], B_CalculateDifferentialCorrec_T *localB)
{
  in1_size[0] = 1;
...
// Function for MATLAB Function: '<S28>/Calculate Differential Corrections'
boolean_T DDRTCM::DDRTCM_any(const boolean_T x_data[], const int32_T x_size[2],
  B_CalculateDifferentialCorrec_T *localB)
{
  boolean_T exitg1;
  boolean_T y;
...
void DDRTCM::DDRTCM_binary_expand_op_n(real_T in1_data[], int32_T in1_size[2],
...
void DDRTCM::DDRTCM_minus_h(real_T in1_data[], int32_T in1_size[2], const real_T
...
void DDRTCM::DDRTCM_binary_expand_op_nh5as(real_T in1_data[], int32_T in1_size[2],
...
// Function for MATLAB Function: '<S28>/Calculate Differential Corrections'
void DDRTCM::correct_Gps_Time_At_Week_Cros_m(real_T b_time_data[], int32_T
  b_time_size[2])
{
  int32_T loop_ub;
  b_time_size[0] = 1;
...
void DDRTCM::DDRTCM_plus_o(real_T in1_data[], int32_T in1_size[2], const real_T
  in2_data[], const int32_T in2_size[2], B_CalculateDifferentialCorrec_T *localB)
{
...
void DDRTCM::DDRTCM_binary_expand_op_pi(real_T in1_data[], int32_T in1_size[2],
  const real_T in2_data[], const int32_T in2_size[2], const real_T in3_data[],
...
void DDRTCM::DDRTCM_binary_expand_op_o5(real_T in1_data[], int32_T in1_size[2],
  const real_T in2_data[], const int32_T in2_size[2], const real_T in3_data[],
  const int32_T in3_size[2], B_CalculateDifferentialCorrec_T *localB)
{
...
// Function for MATLAB Function: '<S28>/Calculate Differential Corrections'
void DDRTCM::Get_Kepler_Eccentric_Anomaly_b(const real_T t_k_data[], const
  ...
  *localB)
{
  ...
  for (localB->varargin_1_tmp = 0; localB->varargin_1_tmp < localB->loop_ub_e;
    ...
    E_k_Dot_data[localB->varargin_1_tmp] = 3.986005E+14 / DDRTCM_rt_powd_snf_ic
  ...
  if (Ephemeris_SQRT_A_size[1] == Ephemeris_DELTA_N_size[1]) {
    ...
    DDRTCM_plus_o(E_k_Dot_data, E_k_Dot_size, Ephemeris_DELTA_N_data,
  ...
  if ((E_k_Dot_size[1] == t_k_size[1]) && ((E_k_Dot_size[1] == 1 ? t_k_size[1] :
    ...
    DDRTCM_binary_expand_op_pi(localB->M_k_data, localB->M_k_size,
  ...
  if ((Ephemeris_E_size[1] == localB->M_k_size[1]) && ((Ephemeris_E_size[1] == 1
    ...
    DDRTCM_binary_expand_op_nh5as5(E_k_data, E_k_size, Ephemeris_E_data,
  ...
  do {
    ...
    if (DDRTCM_any(localB->eps_data_i, localB->eps_size, localB) && (localB->i_p
         < 20)) {
      ...
      if ((Ephemeris_E_size[1] == E_k_size[1]) && ((Ephemeris_E_size[1] == 1 ?
        ...
        DDRTCM_binary_expand_op_n(E_k_data, E_k_size, localB->M_k_data,
      ...
      if (E_k_size[1] == localB->E_k_old_size_c[1]) {
        ...
        DDRTCM_minus_h(localB->E_k_old_data_d, localB->E_k_old_size_c, E_k_data,
                       E_k_size, localB);
      }
  ...
  if ((Ephemeris_E_size[1] == E_k_size[1]) && ((Ephemeris_E_size[1] == 1 ?
    ...
    DDRTCM_binary_expand_op_o5(E_k_Dot_data, E_k_Dot_size, Ephemeris_E_data,
      Ephemeris_E_size, localB->M_k_data, localB->M_k_size, localB);
  }
}

// Function for MATLAB Function: '<S28>/Calculate Differential Corrections'
void DDRTCM::DDRTCM_cos_e(real_T x_data[], const int32_T x_size[2])
{
  int32_T b;
  b = x_size[1];
...
// Function for MATLAB Function: '<S28>/Calculate Differential Corrections'
void DDRTCM::DDRTCM_sin_l(real_T x_data[], const int32_T x_size[2])
{
  int32_T b;
  b = x_size[1];
  for (int32_T k{0}; k < b; k++) {
...
void DDRTCM::DDRTCM_times_cn(real_T in1_data[], int32_T in1_size[2], const
  real_T in2_data[], const int32_T in2_size[2], const real_T in3_data[], const
  int32_T in3_size[2])
{
  int32_T loop_ub;
...
// Function for MATLAB Function: '<S28>/Calculate Differential Corrections'
void DDRTCM::DDRTCM_sqrt_l(real_T x_data[], const int32_T x_size[2],
  B_CalculateDifferentialCorrec_T *localB)
{
  localB->b_f = x_size[1];
...
real_T DDRTCM::DDRTCM_rt_atan2d_snf_k(real_T u0, real_T u1,
  B_CalculateDifferentialCorrec_T *localB)
{
  real_T y;
  if (std::isnan(u0) || std::isnan(u1)) {
...
// Function for MATLAB Function: '<S28>/Calculate Differential Corrections'
void DDRTCM::DDRTCM_expand_atan2_h(const real_T a_data[], const int32_T a_size[2],
  ...
  c_size[2], B_CalculateDifferentialCorrec_T *localB)
{
  ...
  if (localB->csz_idx_1 != 0) {
    ...
    for (localB->k_p = 0; localB->k_p <= localB->f; localB->k_p++) {
      c_data[localB->k_p] = DDRTCM_rt_atan2d_snf_k(a_data[localB->d_i *
...
// Function for MATLAB Function: '<S28>/Calculate Differential Corrections'
void DDRTCM::DDRTCM_atan2_f(const real_T y_data[], const int32_T y_size[2],
  const real_T x_data[], const int32_T x_size[2], real_T r_data[], int32_T
  r_size[2], B_CalculateDifferentialCorrec_T *localB)
{
  if (y_size[1] == x_size[1]) {
    ...
    for (localB->r_data_tmp = 0; localB->r_data_tmp < localB->loop_ub_p;
         localB->r_data_tmp++) {
      r_data[localB->r_data_tmp] = DDRTCM_rt_atan2d_snf_k(y_data
        [localB->r_data_tmp], x_data[localB->r_data_tmp], localB);
    }
  } else {
    DDRTCM_expand_atan2_h(y_data, y_size, x_data, x_size, r_data, r_size, localB);
  }
}

void DDRTCM::DDRT_binary_expand_op_nh5as5qlw(real_T in1_data[], int32_T
  in1_size[2], const real_T in2_data[], const int32_T in2_size[2], const real_T
  in3_data[], const int32_T in3_size[2], const real_T in4_data[], const int32_T
  in4_size[2], const real_T in5_data[], const int32_T in5_size[2], const real_T
  in6_data[], const int32_T in6_size[2], B_CalculateDifferentialCorrec_T *localB)
{
  ...
  DDRTCM_atan2_f(localB->in2_data_o, localB->in2_size_l, localB->in5_data_b,
                 localB->in5_size_m, in1_data, in1_size, localB);
}

void DDRTCM::DDRTCM_binary_expand_op_hv(real_T in1_data[], int32_T in1_size[2],
  const real_T in2_data[], const int32_T in2_size[2], const real_T in3_data[],
  const int32_T in3_size[2], const real_T in4_data[], const int32_T in4_size[2],
  ...
  B_CalculateDifferentialCorrec_T *localB)
{
  ...
  DDRTCM_atan2_f(localB->in2_data_d, localB->in2_size, localB->in5_data,
...
void DDRTCM::DDRTCM_binary_expand_op_os(real_T in1_data[], int32_T in1_size[2],
  const real_T in2_data[], const int32_T in2_size[2], const real_T in3_data[],
  const int32_T in3_size[2], const real_T in4_data[], const int32_T in4_size[2],
...
void DDRTCM::DDRTCM_binary_expand_op_oq(real_T in1_data[], int32_T in1_size[2],
  const real_T in2_data[], const int32_T in2_size[2], const real_T in3_data[],
  const int32_T in3_size[2], const real_T in4_data[], const int32_T in4_size[2],
  const real_T in5_data[], const int32_T in5_size[2], const real_T in6_data[],
  const int32_T in6_size[2], const real_T in7_data[], const int32_T in7_size[2],
...
void DDRTCM::DDRTCM_binary_expand_op_e(real_T in1_data[], int32_T in1_size[2],
  const real_T in2_data[], const int32_T in2_size[2], const real_T in3_data[],
  const int32_T in3_size[2], const real_T in4_data[], const int32_T in4_size[2],
  const real_T in5_data[], const int32_T in5_size[2], const real_T in6_data[],
  const int32_T in6_size[2], const real_T in7_data[], const int32_T in7_size[2],
...
void DDRTCM::DDRTCM_binary_expand_op_hy(real_T in1_data[], int32_T in1_size[2],
  const real_T in2_data[], const int32_T in2_size[2], const real_T in3_data[],
  const int32_T in3_size[2], const real_T in4_data[], const int32_T in4_size[2],
  B_CalculateDifferentialCorrec_T *localB)
{
...
void DDRTCM::DDRTCM_times_cnz(real_T in1_data[], int32_T in1_size[2], const
  real_T in2_data[], const int32_T in2_size[2], B_CalculateDifferentialCorrec_T *
  localB)
{
...
void DDRTCM::DDRTCM_binary_expand_op_fq(real_T in1_data[], const real_T
...
void DDRTCM::DDRTCM_binary_expand_op_fk(real_T in1_data[], const int32_T
  in1_size[2], const real_T in2_data[], const int32_T in2_size[2], const real_T
  in3_data[], const int32_T in3_size[2], const real_T in4_data[], const int32_T
...
void DDRTCM::DDRTCM_binary_expand_op_ku(real_T in1_data[], int32_T in1_size[2],
  const real_T in2_data[], const int32_T in2_size[2], const real_T in3_data[],
  const int32_T in3_size[2], B_CalculateDifferentialCorrec_T *localB)
{
...
void DDRTCM::DDRTCM_binary_expand_op_o(real_T in1_data[], int32_T in1_size[2],
  const real_T in2_data[], const int32_T in2_size[2], const real_T in3_data[],
  const int32_T in3_size[2], const real_T in4_data[], const int32_T in4_size[2],
  const real_T in5_data[], const int32_T in5_size[2], const real_T in6_data[],
...
void DDRTCM::DDRTCM_binary_expand_op_i(real_T in1_data[], int32_T in1_size[2],
  const real_T in2_data[], const int32_T in2_size[2], const real_T in3_data[],
  const int32_T in3_size[2], const real_T in4_data[], const int32_T in4_size[2],
  const real_T in5_data[], const int32_T in5_size[2], const real_T in6_data[],
  const int32_T in6_size[2], const real_T in7_data[], const int32_T in7_size[2],
...
void DDRTCM::DDRTCM_binary_expand_op_ps(real_T in1_data[], int32_T in1_size[2],
  const real_T in2_data[], const int32_T in2_size[2], const real_T in3_data[],
  const int32_T in3_size[2], const real_T in4_data[], const int32_T in4_size[2],
  const real_T in5_data[], const int32_T in5_size[2], const real_T in6_data[],
...
void DDRTCM::binary_expand_o_nh5as5qlw05bzc3(real_T in1_data[], int32_T
  in1_size[2], const real_T in2_data[], const int32_T in2_size[2], const real_T
  in3_data[], const int32_T in3_size[2], const real_T in4_data[], const int32_T
  in4_size[2], B_CalculateDifferentialCorrec_T *localB)
{
...
void DDRTCM::binary_expand_op_nh5as5qlw05bzc(real_T in1_data[], int32_T
  in1_size[2], const real_T in2_data[], const int32_T in2_size[2], const real_T
  in3_data[], const int32_T in3_size[2], const real_T in4_data[], const int32_T
  in4_size[2], B_CalculateDifferentialCorrec_T *localB)
{
...
void DDRTCM::DDRTCM_times_c(real_T in1_data[], int32_T in1_size[2], const real_T
  in2_data[], const int32_T in2_size[2], B_CalculateDifferentialCorrec_T *localB)
{
...
void DDRTCM::binary_expand_op_nh5as5qlw05bz(real_T in1_data[], const real_T
  in2_data[], const int32_T in2_size[2], const real_T in3_data[], const int32_T
  in3_size[2], const real_T in4_data[], const int32_T in4_size[2], const real_T
  ...
  in9_size[2], B_CalculateDifferentialCorrec_T *localB)
{
...
void DDRTCM::D_binary_expand_op_nh5as5qlw05b(real_T in1_data[], const int32_T
  in1_size[2], const real_T in2_data[], const int32_T in2_size[2], const real_T
  in3_data[], const int32_T in3_size[2], const real_T in4_data[], const int32_T
  in4_size[2], const real_T in5_data[], const int32_T in5_size[2], const real_T
  in6_data[], const int32_T in6_size[2], const real_T in7_data[], const int32_T
...
void DDRTCM::DD_binary_expand_op_nh5as5qlw05(real_T in1_data[], const int32_T
  in1_size[2], const real_T in2_data[], const int32_T in2_size[2], const real_T
  in3_data[], const int32_T in3_size[2], const real_T in4_data[], const int32_T
  in4_size[2], const real_T in5_data[], const int32_T in5_size[2])
{
...
// Function for MATLAB Function: '<S28>/Calculate Differential Corrections'
void DDRTCM::DDRTCM_sqrt_lb(real_T x_data[], const int32_T *x_size,
  B_CalculateDifferentialCorrec_T *localB)
{
  localB->b_k = *x_size;
...
// Function for MATLAB Function: '<S28>/Calculate Differential Corrections'
void DDRTCM::Get_Kepler_Satellite_Position_b(const real_T Ephemeris_C_rs_data[],
  ...
  B_CalculateDifferentialCorrec_T *localB)
{
  ...
  if (T_emission_size[1] == Ephemeris_T_oe_size[1]) {
    ...
    DDRTCM_minus_hi(localB->t_k_data_l, localB->t_k_size_g, T_emission_data,
                    T_emission_size, Ephemeris_T_oe_data, Ephemeris_T_oe_size);
  }

  correct_Gps_Time_At_Week_Cros_m(localB->t_k_data_l, localB->t_k_size_g);
  Get_Kepler_Eccentric_Anomaly_b(localB->t_k_data_l, localB->t_k_size_g,
  ...
  DDRTCM_cos_e(localB->cosinus_E_k_data, localB->cosinus_E_k_size);
  DDRTCM_sin_l(localB->sinus_E_k_data, localB->sinus_E_k_size);
  if (Ephemeris_E_size[1] == localB->cosinus_E_k_size[1]) {
    ...
    DDRTCM_times_cn(localB->r_k_Dot_data, localB->r_k_Dot_size, Ephemeris_E_data,
  ...
  DDRTCM_sqrt_l(localB->f_data, localB->f_size, localB);
  if ((localB->f_size[1] != localB->sinus_E_k_size[1]) || ((localB->f_size[1] ==
    ...
    DDRT_binary_expand_op_nh5as5qlw(localB->tmp_data, localB->tmp_size,
  ...
  if ((localB->f_size[1] == localB->sinus_E_k_size[1]) && ((localB->f_size[1] ==
    ...
    DDRTCM_atan2_f(localB->PHI_k_data, localB->PHI_k_size, localB->f_data,
    ...
    DDRTCM_binary_expand_op_hv(localB->PHI_k_data, localB->PHI_k_size,
      localB->f_data, localB->f_size, localB->sinus_E_k_data,
      localB->sinus_E_k_size, localB->y_tmp_data, localB->y_tmp_size,
      localB->cosinus_E_k_data, localB->cosinus_E_k_size, Ephemeris_E_data,
  ...
  DDRTCM_sin_l(localB->sin2PHI_k_data, localB->sin2PHI_k_size);
  ...
  DDRTCM_cos_e(localB->cos2PHI_k_data, localB->cos2PHI_k_size);
  if ((Ephemeris_C_us_size[1] == localB->sin2PHI_k_size[1]) &&
    ...
    DDRTCM_binary_expand_op_os(localB->PHI_k_data, localB->PHI_k_size,
  ...
  if ((Ephemeris_SQRT_A_size[1] == localB->r_k_Dot_size[1]) &&
    ...
    DDRTCM_binary_expand_op_oq(localB->r_k_data, localB->r_k_size,
  ...
  if ((Ephemeris_C_is_size[1] == localB->sin2PHI_k_size[1]) &&
    ...
    DDRTCM_binary_expand_op_e(localB->i_k_data, localB->i_k_size,
  ...
  if ((Ephemeris_OMEGADOT_size[1] == localB->t_k_size_g[1]) &&
    ...
    DDRTCM_binary_expand_op_hy(localB->t_k_data_l, localB->t_k_size_g,
  ...
  DDRTCM_cos_e(localB->cosinus_u_k_data, localB->cosinus_u_k_size);
  DDRTCM_sin_l(localB->PHI_k_data, localB->PHI_k_size);
  ...
  DDRTCM_cos_e(localB->cosinus_i_k_data, localB->cosinus_i_k_size);
  DDRTCM_sin_l(localB->i_k_data, localB->i_k_size);
  ...
  DDRTCM_sin_l(localB->sinus_lambda_k_data, localB->sinus_lambda_k_size);
  DDRTCM_cos_e(localB->t_k_data_l, localB->t_k_size_g);
  if (localB->r_k_size[1] == localB->cosinus_u_k_size[1]) {
    ...
    DDRTCM_times_cn(localB->X_k_tmp_data, localB->X_k_tmp_size, localB->r_k_data,
  ...
  if (localB->r_k_size[1] == localB->PHI_k_size[1]) {
    ...
    DDRTCM_times_cnz(localB->r_k_data, localB->r_k_size, localB->PHI_k_data,
  ...
  if (localB->r_k_size[1] == localB->cosinus_i_k_size[1]) {
    ...
    DDRTCM_times_cn(localB->c_data, localB->c_size, localB->r_k_data,
  ...
  if ((localB->X_k_tmp_size[1] == localB->t_k_size_g[1]) && (localB->c_size[1] ==
    ...
    DDRTCM_binary_expand_op_fq(sv_pos_data, localB->X_k_tmp_data,
  ...
  if ((localB->X_k_tmp_size[1] == localB->sinus_lambda_k_size[1]) &&
    ...
    DDRTCM_binary_expand_op_fk(sv_pos_data, sv_pos_size, localB->X_k_tmp_data,
  ...
  if (localB->r_k_size[1] == localB->i_k_size[1]) {
    ...
    DDRTCM_times_cn(localB->d_data, localB->d_size, localB->r_k_data,
  ...
  DDRTCM_sqrt_l(localB->PHI_k_Dot_data, localB->PHI_k_Dot_size, localB);
  if ((localB->PHI_k_Dot_size[1] == localB->E_k_Dot_size[1]) &&
    ...
    DDRTCM_binary_expand_op_ku(localB->PHI_k_Dot_data, localB->PHI_k_Dot_size,
  ...
  if ((Ephemeris_C_us_size[1] == localB->cos2PHI_k_size[1]) &&
    ...
    DDRTCM_binary_expand_op_o(localB->cosinus_E_k_data, localB->cosinus_E_k_size,
  ...
  if ((Ephemeris_C_rs_size[1] == localB->cos2PHI_k_size[1]) &&
    ...
    DDRTCM_binary_expand_op_i(localB->r_k_Dot_data, localB->r_k_Dot_size,
  ...
  if ((Ephemeris_C_is_size[1] == localB->cos2PHI_k_size[1]) &&
    ...
    DDRTCM_binary_expand_op_ps(localB->cos2PHI_k_data, localB->cos2PHI_k_size,
  ...
  if ((localB->r_k_Dot_size[1] == localB->cosinus_u_k_size[1]) &&
    ...
    binary_expand_o_nh5as5qlw05bzc3(localB->cosinus_u_k_data,
  ...
  if ((localB->r_k_Dot_size[1] == localB->PHI_k_size[1]) &&
    ...
    binary_expand_op_nh5as5qlw05bzc(localB->r_k_Dot_data, localB->r_k_Dot_size,
  ...
  if (localB->r_k_Dot_size[1] == localB->cosinus_i_k_size[1]) {
    ...
    DDRTCM_times_c(localB->cosinus_i_k_data, localB->cosinus_i_k_size,
  ...
  if ((localB->cosinus_u_k_size[1] == localB->t_k_size_g[1]) &&
    ...
    binary_expand_op_nh5as5qlw05bz(sv_vel_data, localB->cosinus_u_k_data,
  ...
  if ((localB->cosinus_u_k_size[1] == localB->sinus_lambda_k_size[1]) &&
    ...
    D_binary_expand_op_nh5as5qlw05b(sv_vel_data, sv_vel_size,
  ...
  if ((localB->r_k_Dot_size[1] == localB->i_k_size[1]) && (localB->c_size[1] ==
    ...
    DD_binary_expand_op_nh5as5qlw05(sv_vel_data, sv_vel_size,
  ...
  DDRTCM_sqrt_lb(localB->t_k_data_l, &localB->transport_angle_size, localB);
...
void DDRTCM::DDRTCM_binary_expand_op_nh5a(const gnssops_navigation_data *in1,
  ...
  B_CalculateDifferentialCorrec_T *localB)
{
  ...
  Get_Kepler_Satellite_Position_b(localB->in1_data_c, localB->in1_size, in4_data,
...
void DDRTCM::DDRTCM_binary_expand_op_nh5(real_T in1_data[], int32_T *in1_size,
...
void DDRTCM::DDRTCM_binary_expand_op_nh(real_T in1_data[], int32_T *in1_size,
...
//    '<S155>/Calculate Differential Corrections'
//
void DDRTCM::CalculateDifferentialCorre_Init(DW_CalculateDifferentialCorre_T
  *localDW)
{
...
//    '<S155>/Calculate Differential Corrections'
//
void DDRTCM::CalculateDifferentialCorrection(const GNSS_Measurement
  ...
  DW_CalculateDifferentialCorre_T *localDW)
{
  ...
  if ((rtu_GpsMeasurementB->time_receive > localDW->old_t) ||
      (rtu_GpsMeasurementB->time_receive - localDW->old_t < -100.0)) {
    __m128d tmp_0;
    __m128d tmp_1;
    ...
    if (localB->vstride - 1 >= 0) {
      std::memcpy(&localB->a_data[0], &rtu_GpsMeasurementB->PRN[0], static_cast<
                  uint32_T>(localB->vstride) * sizeof(uint16_T));
    }

    DDRTCM_sort(localB->a_data, &localB->a_size, localB->iidx_data,
                &localB->iidx_size, localB);
    localB->rtu_gpsNavDataBusL1_DIMS1 = rtu_gpsNavDataBusL1_DIMS1->SVID;
    DDRTCM_do_vectors(localB->a_data, &localB->a_size, rtu_gpsNavDataBusL1->SVID,
    ...
    for (localB->k = 0; localB->k < localB->vstride; localB->k++) {
      localB->b_data[localB->k] = rtu_GpsMeasurementB->pseudorange
    ...
    for (localB->k = 0; localB->k < localB->vstride; localB->k++) {
      localB->t_sv_emission_data[localB->k] = rtu_GpsMeasurementB->time_receive
    ...
    if (localB->iib_size == localB->iia_size) {
      ...
      DDRTC_binary_expand_op_nh5as5ql(localB->t_d_data, localB->t_d_size,
    ...
    if (localB->iia_size == localB->iib_size) {
      ...
      DDRTCM_minus_hi(localB->t_k_data, localB->t_k_size,
                      localB->t_sv_emission_data, localB->t_sv_emission_size,
    ...
    for (localB->k = 0; localB->k < localB->vstride; localB->k++) {
      ...
      localB->n_0_data[localB->k] = 3.986005E+14 / DDRTCM_rt_powd_snf_ic
    ...
    if ((localB->iib_size == localB->t_k_size[1]) && ((localB->iib_size == 1 ?
      ...
      DDRTCM_binary_expand_op_nh5as5q(localB->n_0_data, localB->n_0_size,
    ...
    if ((localB->iib_size == localB->n_0_size[1]) && ((localB->iib_size == 1 ?
      ...
      DDRTCM_binary_expand_op_nh5as5(localB->E_k_data, localB->E_k_size,
    ...
    do {
      ...
      if (DDRTCM_any(localB->t_k_data_n, localB->t_k_size_j, localB) &&
          (localB->i < 20)) {
        ...
        if ((localB->navdata_E_size[1] == localB->E_k_size[1]) &&
          ...
          DDRTCM_binary_expand_op_n(localB->E_k_data, localB->E_k_size,
        ...
        if (localB->E_k_size[1] == localB->E_k_old_size[1]) {
          ...
          DDRTCM_minus_h(localB->E_k_old_data, localB->E_k_old_size,
    ...
    if ((localB->iib_size == localB->t_d_size[1]) && ((localB->iib_size == 1 ?
      ...
      DDRTCM_binary_expand_op_nh5as(localB->t_d_data, localB->t_d_size,
        rtu_gpsNavDataBusL1, localB->real_range_data, &localB->real_range_size,
    ...
    if (localB->iia_size == localB->t_d_size[1]) {
      ...
      Get_Kepler_Satellite_Position_b(localB->E_k_data, localB->E_k_size,
        localB->navdata_DELTA_N_data, localB->navdata_DELTA_N_size,
      ...
      DDRTCM_binary_expand_op_nh5a(rtu_gpsNavDataBusL1, localB->real_range_data,
        &localB->real_range_size, localB->navdata_DELTA_N_data,
        localB->navdata_DELTA_N_size, localB->navdata_M_0_data,
        localB->navdata_M_0_size, localB->navdata_E_data, localB->navdata_E_size,
        localB->navdata_SQRT_A_data, localB->navdata_SQRT_A_size,
        localB->navdata_T_oe_data, localB->navdata_T_oe_size,
    ...
    if (localB->iia_size == localB->real_range_size) {
      ...
      DDRTCM_binary_expand_op_nh5(localDW->delta_pr2.data,
    ...
    if (localDW->delta_pr2.size == localB->t_d_size[1]) {
      ...
      DDRTCM_binary_expand_op_nh(localDW->delta_pr2.data,
