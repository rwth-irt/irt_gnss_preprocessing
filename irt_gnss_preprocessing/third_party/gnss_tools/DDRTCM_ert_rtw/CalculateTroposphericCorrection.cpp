...
// Function for MATLAB Function: '<S28>/Calculate Tropospheric Corrections'
real_T DDRTCM::DDRTCM_interp1(const real_T varargin_1[5], const real_T
...
real_T DDRTCM::DDRTCM_rt_powd_snf_c(real_T u0, real_T u1,
...
// Function for MATLAB Function: '<S28>/Calculate Tropospheric Corrections'
void DDRTCM::DDRTCM_expand_power(const real_T a_data[], const int32_T *a_size,
  ...
  *c_size = csz_idx_0;
  if (csz_idx_0 != 0) {
    ...
    for (int32_T k{0}; k <= f; k++) {
      c_data[k] = DDRTCM_rt_powd_snf_c(a_data[d * k], b_data[e * k], localB);
    }
  }
}

void DDRTCM::DDRTCM_binary_expand_op_nf(real_T in1_data[], int32_T *in1_size,
...
//    '<S155>/Calculate Tropospheric Corrections'
//
void DDRTCM::CalculateTroposphericCorrection(real_T rtu_dayOfYear, boolean_T
  rtu_enableTroposphericCorrectio, const real_T rtu_userPosLlh[3], const real_T
  ...
  if (rtu_enableTroposphericCorrectio) {
    ...
    for (localB->SFunction_DIMS2_tmp_tmp = 0; localB->SFunction_DIMS2_tmp_tmp < *
      ...
      if (localB->latitude < 15.0) {
        ...
        localB->pressure_data[localB->SFunction_DIMS2_tmp_tmp] = DDRTCM_interp1
          (localB->dv, j, localB->latitude, localB) - DDRTCM_interp1(localB->dv1,
          l, localB->latitude, localB) * localB->cosinus_day;
        for (localB->k = 0; localB->k < 5; localB->k++) {
          localB->d = 15.0 * static_cast<real_T>(localB->k) + 15.0;
          localB->dv[localB->k] = localB->d;
          localB->dv1[localB->k] = localB->d;
        ...
        localB->temperature_data[localB->SFunction_DIMS2_tmp_tmp] =
          DDRTCM_interp1(localB->dv, m, localB->latitude, localB) -
          DDRTCM_interp1(localB->dv1, n, localB->latitude, localB) *
          localB->cosinus_day;
        for (localB->k = 0; localB->k < 5; localB->k++) {
          localB->d = 15.0 * static_cast<real_T>(localB->k) + 15.0;
          localB->dv[localB->k] = localB->d;
        ...
        localB->water_vapour_pressure_data[localB->SFunction_DIMS2_tmp_tmp] =
          DDRTCM_interp1(localB->dv, o, localB->latitude, localB) -
          DDRTCM_interp1(localB->dv1, p, localB->latitude, localB) *
          localB->cosinus_day;
        for (localB->k = 0; localB->k < 5; localB->k++) {
          localB->d = 15.0 * static_cast<real_T>(localB->k) + 15.0;
          localB->dv[localB->k] = localB->d;
        ...
        localB->beta_data[localB->SFunction_DIMS2_tmp_tmp] = DDRTCM_interp1
          (localB->dv, q, localB->latitude, localB) - DDRTCM_interp1(localB->dv1,
          r, localB->latitude, localB) * localB->cosinus_day;
        for (localB->k = 0; localB->k < 5; localB->k++) {
          localB->d = 15.0 * static_cast<real_T>(localB->k) + 15.0;
          localB->dv[localB->k] = localB->d;
          localB->dv1[localB->k] = localB->d;
        ...
        localB->lambda_data[localB->SFunction_DIMS2_tmp_tmp] = DDRTCM_interp1
          (localB->dv, s, localB->latitude, localB) - DDRTCM_interp1(localB->dv1,
          t, localB->latitude, localB) * localB->cosinus_day;
      }
    }
    ...
    if (localB->x_tmp_size == localB->b_b_size) {
      ...
      for (localB->k = 0; localB->k < localB->loop_ub; localB->k++) {
        localB->d_data[localB->k] = DDRTCM_rt_powd_snf_c(localB->
      ...
      DDRTCM_expand_power(localB->x_tmp_data, &localB->x_tmp_size,
    ...
    if ((localDW->SFunction_DIMS2 == static_cast<int8_T>
      ...
      DDRTCM_binary_expand_op_nf(localB->pressure_data, &localB->pressure_size,
