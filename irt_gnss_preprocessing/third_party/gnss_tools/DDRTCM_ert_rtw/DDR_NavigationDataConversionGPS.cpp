...
//
// File: DDR_NavigationDataConversionGPS.cpp
//
...
#include <emmintrin.h>
#include "rtwtypes.h"
#include "DDR_NavigationDataConversionGPS.h"

//
// Output and update for atomic system:
//    '<S16>/Navigation Data Conversion GPS'
//    '<S143>/Navigation Data Conversion GPS'
//
void DDRTCM::DDR_NavigationDataConversionGPS(const gnssraw_gps_nav_t
