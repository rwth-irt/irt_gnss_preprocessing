...
// Function for MATLAB Function: '<S17>/Simplify and Mask GAL Measurement Bus'
void DDRTCM::DDRTCM_any_lh(const boolean_T x[200], boolean_T y[40])
{
  int32_T i2;
  i2 = 1;
...
// Function for MATLAB Function: '<S17>/Simplify and Mask GAL Measurement Bus'
void DDRTCM::DDRTCM_eml_find_d(const boolean_T x[5], int32_T i_data[], int32_T
  i_size[2])
{
  int32_T idx;
  int32_T ii;
...
// Function for MATLAB Function: '<S17>/Simplify and Mask GAL Measurement Bus'
void DDRTCM::DDRTCM_merge_o(int32_T idx_data[], uint16_T x_data[], int32_T
...
// Function for MATLAB Function: '<S17>/Simplify and Mask GAL Measurement Bus'
void DDRTCM::DDRTCM_sort_k(uint16_T x_data[], int32_T x_size[2], int32_T
  idx_data[], int32_T idx_size[2], B_SimplifyandMaskGALMeasureme_T *localB)
{
  ...
  nLeft = x_size[1];
  if (nLeft - 1 >= 0) {
    std::memcpy(&localB->b_x_data[0], &x_data[0], static_cast<uint32_T>(nLeft) *
                sizeof(uint16_T));
  }
  ...
  if (x_size[1] != 0) {
    ...
    if (x_size[1] > 1) {
      nLeft = x_size[1];
      if (nLeft - 1 >= 0) {
        std::memset(&localB->iwork_data[0], 0, static_cast<uint32_T>(nLeft) *
                    sizeof(int32_T));
      }

      nLeft = x_size[1];
      if (nLeft - 1 >= 0) {
        std::memset(&localB->xwork_data[0], 0, static_cast<uint32_T>(nLeft) *
                    sizeof(uint16_T));
      }
      ...
      while (nLeft > 1) {
        if ((static_cast<uint32_T>(nLeft) & 1U) != 0U) {
          ...
          i = x_size[1] - i2;
          if (i > nDone) {
            DDRTCM_merge_o(idx_data, localB->b_x_data, i2, nDone, i - nDone,
        ...
        nLeft >>= 1;
        for (i2 = 0; i2 < nLeft; i2++) {
          DDRTCM_merge_o(idx_data, localB->b_x_data, i2 * i, nDone, nDone,
                         localB->iwork_data, localB->xwork_data);
        }
      ...
      if (x_size[1] > nDone) {
        DDRTCM_merge_o(idx_data, localB->b_x_data, 0, nDone, x_size[1] - nDone,
                       localB->iwork_data, localB->xwork_data);
      }
    }
  }
  ...
  if (nLeft - 1 >= 0) {
    std::memcpy(&x_data[0], &localB->b_x_data[0], static_cast<uint32_T>(nLeft) *
                sizeof(uint16_T));
  }
}

// Function for MATLAB Function: '<S17>/Simplify and Mask GAL Measurement Bus'
boolean_T DDRTCM::DDRTCM_any_lhp(const boolean_T x_data[], const int32_T *x_size)
{
  int32_T ix;
  boolean_T exitg1;
  boolean_T y;
...
void DDRTCM::DDRTCM_binary_expand_op_bnq(real_T in1_data[], int32_T in1_size[2],
  const gnssraw_measurement_t *in2, const int8_T in3_data[], const int32_T
  in3_size[2], const real_T in4_data[], const int32_T in4_size[2], const int32_T
  ...
  B_SimplifyandMaskGALMeasureme_T *localB)
{
  ...
  for (int32_T i_0{0}; i_0 < loop_ub; i_0++) {
    for (int32_T i{0}; i < 5; i++) {
      localB->in2_data[i + 5 * i_0] = -in2->Doppler[(in3_data[aux_0_1] - 1) * 5
        + i] * 2.99792458E+8 / in4_data[5 * aux_1_1 + i];
    }
  ...
  for (int32_T i_0{0}; i_0 < loop_ub; i_0++) {
    for (int32_T i{0}; i < 5; i++) {
      in1_data[i + 5 * i_0] = localB->in2_data[(in5_data[in6_data[i_0] - 1] - 1)
        * 5 + i];
    }
  }
}
...
// Function for MATLAB Function: '<S17>/Simplify and Mask GAL Measurement Bus'
void DDRTCM::DDRTCM_any_lhpl(const boolean_T x_data[], const int32_T x_size[2],
...
void DDRTCM::emxConvertDynamicMatrixToEmx__d(emxArray_real_T_37_DDRTCM_T *emx,
...
void DDRTCM::emxConvertStructToEmx_gnssops_b(emxArray__gnssops_navigation__T
  *emx, const gnssops_navigation_data *data, const gnssops_navigation_data_size *
  size)
{
  emxConvertDynamicMatrixToEmx__d(&emx->TOW, data->TOW, &size->TOW);
  emxConvertDynamicMatrixToEmx__d(&emx->WNc, data->WNc, &size->WNc);
  emxConvertDynamicMatrixToEmx__d(&emx->SVID, data->SVID, &size->SVID);
  emxConvertDynamicMatrixToEmx__d(&emx->T_gd, data->T_gd, &size->T_gd);
  emxConvertDynamicMatrixToEmx__d(&emx->T_oc, data->T_oc, &size->T_oc);
  emxConvertDynamicMatrixToEmx__d(&emx->A_f2, data->A_f2, &size->A_f2);
  emxConvertDynamicMatrixToEmx__d(&emx->A_f1, data->A_f1, &size->A_f1);
  emxConvertDynamicMatrixToEmx__d(&emx->A_f0, data->A_f0, &size->A_f0);
  emxConvertDynamicMatrixToEmx__d(&emx->C_rs, data->C_rs, &size->C_rs);
  emxConvertDynamicMatrixToEmx__d(&emx->DELTA_N, data->DELTA_N, &size->DELTA_N);
  emxConvertDynamicMatrixToEmx__d(&emx->M_0, data->M_0, &size->M_0);
  emxConvertDynamicMatrixToEmx__d(&emx->C_uc, data->C_uc, &size->C_uc);
  emxConvertDynamicMatrixToEmx__d(&emx->E, data->E, &size->E);
  emxConvertDynamicMatrixToEmx__d(&emx->C_us, data->C_us, &size->C_us);
  emxConvertDynamicMatrixToEmx__d(&emx->SQRT_A, data->SQRT_A, &size->SQRT_A);
  emxConvertDynamicMatrixToEmx__d(&emx->T_oe, data->T_oe, &size->T_oe);
  emxConvertDynamicMatrixToEmx__d(&emx->C_ic, data->C_ic, &size->C_ic);
  emxConvertDynamicMatrixToEmx__d(&emx->OMEGA_0, data->OMEGA_0, &size->OMEGA_0);
  emxConvertDynamicMatrixToEmx__d(&emx->C_is, data->C_is, &size->C_is);
  emxConvertDynamicMatrixToEmx__d(&emx->I_0, data->I_0, &size->I_0);
  emxConvertDynamicMatrixToEmx__d(&emx->C_rc, data->C_rc, &size->C_rc);
  emxConvertDynamicMatrixToEmx__d(&emx->omega, data->omega, &size->omega);
  emxConvertDynamicMatrixToEmx__d(&emx->OMEGADOT, data->OMEGADOT,
    &size->OMEGADOT);
  emxConvertDynamicMatrixToEmx__d(&emx->IDOT, data->IDOT, &size->IDOT);
}

void DDRTCM::DDRTCM_binary_expand_op_bn(boolean_T in1_data[], int32_T *in1_size,
...
// Function for MATLAB Function: '<S17>/Simplify and Mask GAL Measurement Bus'
void DDRTCM::DDRTCM_select_navigation_data_d(const
  emxArray__gnssops_navigation__T *navigation_data, const boolean_T mask_data[],
  const int32_T *mask_size, b_gnssops_navigation_data_DDR_T
  *navigation_data_selected, B_SimplifyandMaskGALMeasureme_T *localB)
{
  ...
  for (trueCount = 0; trueCount < b_size_idx_0; trueCount++) {
    navigation_data_selected->TOW.data[trueCount] = navigation_data->
      TOW.data[localB->b_data[trueCount] - 1];
  }
  ...
  for (trueCount = 0; trueCount < b_size_idx_0; trueCount++) {
    navigation_data_selected->WNc.data[trueCount] = navigation_data->
      WNc.data[localB->c_data[trueCount] - 1];
  }
  ...
  for (trueCount = 0; trueCount < b_size_idx_0; trueCount++) {
    navigation_data_selected->SVID.data[trueCount] = navigation_data->
      SVID.data[localB->d_data[trueCount] - 1];
  }
  ...
  for (trueCount = 0; trueCount < b_size_idx_0; trueCount++) {
    navigation_data_selected->T_gd.data[trueCount] = navigation_data->
      T_gd.data[localB->e_data[trueCount] - 1];
  }
  ...
  for (trueCount = 0; trueCount < b_size_idx_0; trueCount++) {
    navigation_data_selected->T_oc.data[trueCount] = navigation_data->
      T_oc.data[localB->f_data_m[trueCount] - 1];
  }
  ...
  for (trueCount = 0; trueCount < b_size_idx_0; trueCount++) {
    navigation_data_selected->A_f2.data[trueCount] = navigation_data->
      A_f2.data[localB->g_data[trueCount] - 1];
  }
  ...
  for (trueCount = 0; trueCount < b_size_idx_0; trueCount++) {
    navigation_data_selected->A_f1.data[trueCount] = navigation_data->
      A_f1.data[localB->h_data_c[trueCount] - 1];
  }
  ...
  for (trueCount = 0; trueCount < b_size_idx_0; trueCount++) {
    navigation_data_selected->A_f0.data[trueCount] = navigation_data->
      A_f0.data[localB->i_data[trueCount] - 1];
  }
  ...
  for (trueCount = 0; trueCount < b_size_idx_0; trueCount++) {
    navigation_data_selected->C_rs.data[trueCount] = navigation_data->
      C_rs.data[localB->j_data[trueCount] - 1];
  }
  ...
  for (trueCount = 0; trueCount < b_size_idx_0; trueCount++) {
    navigation_data_selected->DELTA_N.data[trueCount] =
      navigation_data->DELTA_N.data[localB->k_data[trueCount] - 1];
  }
  ...
  for (trueCount = 0; trueCount < b_size_idx_0; trueCount++) {
    navigation_data_selected->M_0.data[trueCount] = navigation_data->
      M_0.data[localB->l_data_k[trueCount] - 1];
  }
  ...
  for (trueCount = 0; trueCount < b_size_idx_0; trueCount++) {
    navigation_data_selected->C_uc.data[trueCount] = navigation_data->
      C_uc.data[localB->m_data[trueCount] - 1];
  }
  ...
  for (trueCount = 0; trueCount < b_size_idx_0; trueCount++) {
    navigation_data_selected->E.data[trueCount] = navigation_data->E.data
      [localB->n_data_c[trueCount] - 1];
  }
  ...
  for (trueCount = 0; trueCount < b_size_idx_0; trueCount++) {
    navigation_data_selected->C_us.data[trueCount] = navigation_data->
      C_us.data[localB->o_data[trueCount] - 1];
  }
  ...
  for (trueCount = 0; trueCount < b_size_idx_0; trueCount++) {
    navigation_data_selected->SQRT_A.data[trueCount] =
      navigation_data->SQRT_A.data[localB->p_data_b[trueCount] - 1];
  }
  ...
  for (trueCount = 0; trueCount < b_size_idx_0; trueCount++) {
    navigation_data_selected->T_oe.data[trueCount] = navigation_data->
      T_oe.data[localB->q_data_p[trueCount] - 1];
  }
  ...
  for (trueCount = 0; trueCount < b_size_idx_0; trueCount++) {
    navigation_data_selected->C_ic.data[trueCount] = navigation_data->
      C_ic.data[localB->r_data_c[trueCount] - 1];
  }
  ...
  for (trueCount = 0; trueCount < b_size_idx_0; trueCount++) {
    navigation_data_selected->OMEGA_0.data[trueCount] =
      navigation_data->OMEGA_0.data[localB->s_data_f[trueCount] - 1];
  }
  ...
  for (trueCount = 0; trueCount < b_size_idx_0; trueCount++) {
    navigation_data_selected->C_is.data[trueCount] = navigation_data->
      C_is.data[localB->t_data_g[trueCount] - 1];
  }
  ...
  for (trueCount = 0; trueCount < b_size_idx_0; trueCount++) {
    navigation_data_selected->I_0.data[trueCount] = navigation_data->
      I_0.data[localB->u_data_g[trueCount] - 1];
  }
  ...
  for (trueCount = 0; trueCount < b_size_idx_0; trueCount++) {
    navigation_data_selected->C_rc.data[trueCount] = navigation_data->
      C_rc.data[localB->v_data_m[trueCount] - 1];
  }
  ...
  for (trueCount = 0; trueCount < b_size_idx_0; trueCount++) {
    navigation_data_selected->omega.data[trueCount] =
      navigation_data->omega.data[localB->w_data_n[trueCount] - 1];
  }
  ...
  for (trueCount = 0; trueCount < b_size_idx_0; trueCount++) {
    navigation_data_selected->OMEGADOT.data[trueCount] =
      navigation_data->OMEGADOT.data[localB->x_data_p[trueCount] - 1];
  }
  ...
  for (trueCount = 0; trueCount < b_size_idx_0; trueCount++) {
    navigation_data_selected->IDOT.data[trueCount] = navigation_data->
      IDOT.data[localB->y_data_l[trueCount] - 1];
  }
}
...
//    '<S144>/Simplify and Mask GAL Measurement Bus'
//
void DDRTCM::SimplifyandMaskGALMeasurementBu(const gnssraw_measurement_t
  ...
  DW_SimplifyandMaskGALMeasurem_T *localDW)
{
  ...
  for (localB->trueCount = 0; localB->trueCount < 200; localB->trueCount++) {
    localB->e1_mask_data[localB->trueCount] = (rtu_GAL_Measurement_Bus->
      Type[localB->trueCount] == 17);
  }

  DDRTCM_any_lh(localB->e1_mask_data, localB->mask_available_SV_data);
  for (localB->trueCount = 0; localB->trueCount < 200; localB->trueCount++) {
    localB->e1_mask_data[localB->trueCount] = (rtu_GAL_Measurement_Bus->
      Type[localB->trueCount] == 20);
  }

  DDRTCM_any_lh(localB->e1_mask_data, localB->nc);
  for (localB->trueCount = 0; localB->trueCount < 200; localB->trueCount++) {
    localB->e1_mask_data[localB->trueCount] = (rtu_GAL_Measurement_Bus->
      Type[localB->trueCount] == 21);
  }

  DDRTCM_any_lh(localB->e1_mask_data, localB->bv);
  for (localB->trueCount = 0; localB->trueCount < 40; localB->trueCount++) {
    localB->mc[localB->trueCount] = ((localB->mask_available_SV_data
      [localB->trueCount] && rtu_parameters_galileo->enable_galileo_e1) ||
      (localB->nc[localB->trueCount] &&
       rtu_parameters_galileo->enable_galileo_e5a) || (localB->bv
      [localB->trueCount] && rtu_parameters_galileo->enable_galileo_e5b));
  }

  for (localB->trueCount = 0; localB->trueCount < 200; localB->trueCount++) {
    localB->e1_mask_data[localB->trueCount] = (rtu_GAL_Measurement_Bus->
      Type[localB->trueCount] == 22);
  }

  DDRTCM_any_lh(localB->e1_mask_data, localB->mask_available_SV_data);
  for (localB->trueCount = 0; localB->trueCount < 40; localB->trueCount++) {
    localB->nc[localB->trueCount] = (localB->mask_available_SV_data
      [localB->trueCount] && rtu_parameters_galileo->enable_galileo_e5);
  }
  ...
  for (localB->trueCount = 0; localB->trueCount < localB->p_size_idx_1;
       localB->trueCount++) {
    localB->tmp_svid_data[localB->trueCount] = rtu_GAL_Measurement_Bus->
      SVID[localB->p_data[localB->trueCount] - 1];
  }
  ...
  for (localB->trueCount = 0; localB->trueCount < localB->loop_ub;
       localB->trueCount++) {
  ...
  for (localB->c_i = 0; localB->c_i < localB->q_size_idx_1; localB->c_i++) {
    ...
    {
      localB->rtu_GAL_Measurement_Bus_j = rtu_GAL_Measurement_Bus->Type
        [(localB->q_data[localB->c_i] - 1) * 5 + localB->c_trueCount];
      for (localB->trueCount = 0; localB->trueCount < 5; localB->trueCount++) {
        localB->rtu_GAL_Measurement_Bus[localB->trueCount] =
          (localB->rtu_GAL_Measurement_Bus_j == lc[localB->trueCount]);
      }

      DDRTCM_eml_find_d(localB->rtu_GAL_Measurement_Bus, localB->oc_data,
                        localB->oc_size);
      if (localB->oc_size[1] != 0) {
        localB->gnss_freq_Matrix_data[localB->c_trueCount + 5 * localB->c_i] =
          gnss_frequency[localB->oc_data[0] - 1];
      }
    }
  }
  ...
  if (localB->p_size_idx_1 - 1 >= 0) {
    std::memcpy(&localB->a__1_data[0], &localB->tmp_svid_data[0],
                static_cast<uint32_T>(localB->p_size_idx_1) * sizeof(uint16_T));
  }

  DDRTCM_sort_k(localB->a__1_data, localB->a__1_size, localB->iidx_data,
                localB->oc_size, localB);
  localB->loop_ub = localB->oc_size[1];
  for (localB->trueCount = 0; localB->trueCount < localB->loop_ub;
       localB->trueCount++) {
    localB->a__1_data[localB->trueCount] = localB->tmp_svid_data
      [localB->iidx_data[localB->trueCount] - 1];
  }

  localB->c_trueCount = localB->oc_size[1];
  localB->loop_ub = localB->oc_size[1];
  if (localB->loop_ub - 1 >= 0) {
    std::memcpy(&localB->tmp_svid_data[0], &localB->a__1_data[0],
                static_cast<uint32_T>(localB->loop_ub) * sizeof(uint16_T));
  }

  if (localB->c_trueCount - 1 >= 0) {
    std::memset(&localB->mask_available_SV_data[0], 0, static_cast<uint32_T>
                (localB->c_trueCount) * sizeof(boolean_T));
  }
  ...
  for (localB->c_i = 0; localB->c_i < localB->c_trueCount; localB->c_i++) {
    ...
    for (localB->trueCount = 0; localB->trueCount < localB->loop_ub;
         localB->trueCount++) {
      localB->mask_navdata_e1_data[localB->trueCount] =
        (rtu_GAL_NavigationData_Bus->SVID[localB->trueCount] ==
         localB->rtu_GAL_Measurement_Bus_j);
    }

    if (DDRTCM_any_lhp(localB->mask_navdata_e1_data,
                       &localB->mask_navdata_e1_size)) {
  ...
  localB->c_i = 0;
  localB->loop_ub = 0;
  for (localB->trueCount = 0; localB->trueCount <= localB->c_trueCount_tmp;
       localB->trueCount++) {
    if (localB->mask_available_SV_data[localB->trueCount]) {
      localB->c_i++;
      localB->tmp_svid_data[localB->loop_ub] = localB->tmp_svid_data
        [localB->trueCount];
      localB->loop_ub++;
    }
  }
  ...
  for (localB->trueCount = 0; localB->trueCount <= localB->c_trueCount_tmp;
       localB->trueCount++) {
    if (localB->mask_available_SV_data[localB->trueCount]) {
      localB->y_data[localB->loop_ub] = static_cast<int8_T>(localB->trueCount +
        1);
      localB->loop_ub++;
    }
  }
  ...
  for (localB->trueCount = 0; localB->trueCount < localB->p_size_idx_1;
    ...
    for (localB->c_trueCount = 0; localB->c_trueCount < 5; localB->c_trueCount++)
    {
      localB->tmp_type_data[localB->c_trueCount + 5 * localB->trueCount] =
        rtu_GAL_Measurement_Bus->Type[(localB->q_data[localB->iidx_data
        [localB->y_data[localB->trueCount] - 1] - 1] - 1) * 5 +
        localB->c_trueCount];
    }
  }
  ...
  for (localB->trueCount = 0; localB->trueCount <= localB->c_trueCount_tmp;
       localB->trueCount++) {
    if (localB->mask_available_SV_data[localB->trueCount]) {
      localB->ab_data[localB->loop_ub] = static_cast<int8_T>(localB->trueCount +
        1);
      localB->loop_ub++;
    }
  }

  for (localB->trueCount = 0; localB->trueCount <
       localB->rtu_GAL_Measurement_Bus_j; localB->trueCount++) {
    for (localB->c_trueCount = 0; localB->c_trueCount < 5; localB->c_trueCount++)
    {
      localB->tmp_pr_data[localB->c_trueCount + 5 * localB->trueCount] =
        rtu_GAL_Measurement_Bus->Pseudorange[(localB->r_data[localB->
        iidx_data[localB->ab_data[localB->trueCount] - 1] - 1] - 1) * 5 +
        localB->c_trueCount];
    }
  }
  ...
  for (localB->trueCount = 0; localB->trueCount <= localB->c_trueCount_tmp;
       localB->trueCount++) {
    if (localB->mask_available_SV_data[localB->trueCount]) {
      localB->bb_data[localB->loop_ub] = static_cast<int8_T>(localB->trueCount +
        1);
      localB->loop_ub++;
    }
  }
  ...
  for (localB->trueCount = 0; localB->trueCount <
    ...
    for (localB->c_trueCount = 0; localB->c_trueCount < 5; localB->c_trueCount++)
    {
      localB->tmp_pr_sigma_data[localB->c_trueCount + 5 * localB->trueCount] =
        rtu_GAL_Measurement_Bus->Pseudorange_Sigma[(localB->s_data
        [localB->iidx_data[localB->bb_data[localB->trueCount] - 1] - 1] - 1) * 5
        + localB->c_trueCount];
    }
  }
  ...
  for (localB->trueCount = 0; localB->trueCount <= localB->c_trueCount_tmp;
       localB->trueCount++) {
    if (localB->mask_available_SV_data[localB->trueCount]) {
      localB->cb_data[localB->loop_ub] = static_cast<int8_T>(localB->trueCount +
        1);
      localB->loop_ub++;
    }
  }
  ...
  for (localB->trueCount = 0; localB->trueCount <
    ...
    for (localB->c_trueCount = 0; localB->c_trueCount < 5; localB->c_trueCount++)
    {
      localB->tmp_cp_data[localB->c_trueCount + 5 * localB->trueCount] =
        rtu_GAL_Measurement_Bus->Carrier[(localB->t_data[localB->
        iidx_data[localB->cb_data[localB->trueCount] - 1] - 1] - 1) * 5 +
        localB->c_trueCount];
    }
  }
  ...
  for (localB->trueCount = 0; localB->trueCount <= localB->c_trueCount_tmp;
       localB->trueCount++) {
    if (localB->mask_available_SV_data[localB->trueCount]) {
      localB->db_data[localB->loop_ub] = static_cast<int8_T>(localB->trueCount +
        1);
      localB->loop_ub++;
    }
  }
  ...
  for (localB->trueCount = 0; localB->trueCount <
    ...
    for (localB->c_trueCount = 0; localB->c_trueCount < 5; localB->c_trueCount++)
    {
      localB->tmp_cp_sigma_data[localB->c_trueCount + 5 * localB->trueCount] =
        rtu_GAL_Measurement_Bus->Carrier_Sigma[(localB->u_data[localB->
        iidx_data[localB->db_data[localB->trueCount] - 1] - 1] - 1) * 5 +
        localB->c_trueCount];
    }
  }
  ...
  for (localB->trueCount = 0; localB->trueCount <= localB->c_trueCount_tmp;
       localB->trueCount++) {
    if (localB->mask_available_SV_data[localB->trueCount]) {
      localB->eb_data[localB->loop_ub] = static_cast<int8_T>(localB->trueCount +
        1);
      localB->loop_ub++;
    }
  }
  ...
  for (localB->trueCount = 0; localB->trueCount <
    ...
    for (localB->c_trueCount = 0; localB->c_trueCount < 5; localB->c_trueCount++)
    {
      localB->tmp_locktime_data[localB->c_trueCount + 5 * localB->trueCount] =
        rtu_GAL_Measurement_Bus->Locktime[(localB->v_data[localB->
        iidx_data[localB->eb_data[localB->trueCount] - 1] - 1] - 1) * 5 +
        localB->c_trueCount];
    }
  }
  ...
  for (localB->trueCount = 0; localB->trueCount <= localB->c_trueCount_tmp;
       localB->trueCount++) {
    if (localB->mask_available_SV_data[localB->trueCount]) {
      localB->fb_data[localB->loop_ub] = static_cast<int8_T>(localB->trueCount +
        1);
      localB->loop_ub++;
    }
  }
  ...
  if (localB->w_size[1] == static_cast<int8_T>(localB->q_size_idx_1)) {
    ...
    for (localB->trueCount = 0; localB->trueCount < localB->loop_ub;
      ...
      for (localB->c_trueCount = 0; localB->c_trueCount < 5; localB->c_trueCount
           ++) {
        localB->rtu_GAL_Measurement_Bus_j = localB->iidx_data[localB->
          fb_data[localB->trueCount] - 1] - 1;
        localB->tmp_dr_data[localB->c_trueCount + 5 * localB->trueCount] =
          -rtu_GAL_Measurement_Bus->Doppler[(localB->w_data
          [localB->rtu_GAL_Measurement_Bus_j] - 1) * 5 + localB->c_trueCount] *
          2.99792458E+8 / localB->gnss_freq_Matrix_data[5 *
          localB->rtu_GAL_Measurement_Bus_j + localB->c_trueCount];
      }
    }
  } else {
    DDRTCM_binary_expand_op_bnq(localB->tmp_dr_data, localB->a__1_size,
      rtu_GAL_Measurement_Bus, localB->w_data, localB->w_size,
      localB->gnss_freq_Matrix_data, localB->gnss_freq_Matrix_size,
      localB->iidx_data, localB->fb_data, localB->fb_size, localB);
  }
  ...
  for (localB->trueCount = 0; localB->trueCount <= localB->c_trueCount_tmp;
       localB->trueCount++) {
    if (localB->mask_available_SV_data[localB->trueCount]) {
      localB->gb_data[localB->loop_ub] = static_cast<int8_T>(localB->trueCount +
        1);
      localB->loop_ub++;
    }
  }

  for (localB->trueCount = 0; localB->trueCount < localB->q_size_idx_1;
       localB->trueCount++) {
    for (localB->c_trueCount = 0; localB->c_trueCount < 5; localB->c_trueCount++)
    {
      localB->gnss_freq_Matrix_data[localB->c_trueCount + 5 * localB->trueCount]
        = rtu_GAL_Measurement_Bus->CN0[(localB->x_data[localB->iidx_data
        [localB->gb_data[localB->trueCount] - 1] - 1] - 1) * 5 +
        localB->c_trueCount];
    }
  }
  ...
  if (localB->trueCount - 1 >= 0) {
    std::memset(&localB->e1_mask_data[0], 0, static_cast<uint32_T>
                (localB->trueCount) * sizeof(boolean_T));
  }

  localB->e5a_mask_size[0] = 5;
  localB->e5a_mask_size[1] = static_cast<int8_T>(localB->p_size_idx_1);
  if (localB->trueCount - 1 >= 0) {
    std::memset(&localB->e5a_mask_data[0], 0, static_cast<uint32_T>
                (localB->trueCount) * sizeof(boolean_T));
  }
  ...
  if (localB->trueCount - 1 >= 0) {
    std::memset(&localB->e5b_mask_data[0], 0, static_cast<uint32_T>
                (localB->trueCount) * sizeof(boolean_T));
  }
  ...
  if (localB->trueCount - 1 >= 0) {
    std::memset(&localB->e5_mask_data[0], 0, static_cast<uint32_T>
                (localB->trueCount) * sizeof(boolean_T));
  }

  for (localB->c_trueCount = 0; localB->c_trueCount < localB->c_i;
       localB->c_trueCount++) {
    for (localB->trueCount = 0; localB->trueCount < 5; localB->trueCount++) {
      uint8_T tmp_type;
      ...
      localB->e5_mask_data[localB->trueCount + 5 * localB->c_trueCount] =
        (tmp_type == 22);
    }
  }

  DDRTCM_any_lhpl(localB->e1_mask_data, localB->e1_mask_size,
                  localB->mask_available_SV_data, localB->gnss_freq_Matrix_size);
  ...
  if (localDW->SFunction_DIMS3 - 1 >= 0) {
    std::memcpy(&localB->a__1_data[0], &localB->f_data[0], static_cast<uint32_T>
                (localDW->SFunction_DIMS3) * sizeof(uint16_T));
  }

  if (localDW->SFunction_DIMS3 - 1 >= 0) {
    std::memcpy(&localB->svid_e1[0], &localB->a__1_data[0], static_cast<uint32_T>
                (localDW->SFunction_DIMS3) * sizeof(uint16_T));
  }
  ...
  for (localB->c_i = 0; localB->c_i <= localB->trueCount; localB->c_i++) {
    if (localB->e1_mask_data[localB->c_i]) {
      localB->hb_data[localB->c_trueCount] = static_cast<uint8_T>(localB->c_i +
        1);
      localB->c_trueCount++;
    }
  }
  ...
  for (localB->c_i = 0; localB->c_i <= localB->trueCount; localB->c_i++) {
    if (localB->e1_mask_data[localB->c_i]) {
      localB->ib_data[localB->c_trueCount] = static_cast<uint8_T>(localB->c_i +
        1);
      localB->c_trueCount++;
    }
  }
  ...
  for (localB->c_i = 0; localB->c_i <= localB->trueCount; localB->c_i++) {
    if (localB->e1_mask_data[localB->c_i]) {
      localB->jb_data[localB->c_trueCount] = static_cast<uint8_T>(localB->c_i +
        1);
      localB->c_trueCount++;
    }
  }
  ...
  for (localB->c_i = 0; localB->c_i <= localB->trueCount; localB->c_i++) {
    if (localB->e1_mask_data[localB->c_i]) {
      localB->kb_data[localB->c_trueCount] = static_cast<uint8_T>(localB->c_i +
        1);
      localB->c_trueCount++;
    }
  }
  ...
  for (localB->c_i = 0; localB->c_i <= localB->trueCount; localB->c_i++) {
    if (localB->e1_mask_data[localB->c_i]) {
      localB->lb_data[localB->c_trueCount] = static_cast<uint8_T>(localB->c_i +
        1);
      localB->c_trueCount++;
    }
  }
  ...
  for (localB->c_i = 0; localB->c_i <= localB->trueCount; localB->c_i++) {
    if (localB->e1_mask_data[localB->c_i]) {
      localB->mb_data[localB->c_trueCount] = static_cast<uint8_T>(localB->c_i +
        1);
      localB->c_trueCount++;
    }
  }
  ...
  for (localB->c_i = 0; localB->c_i <= localB->trueCount; localB->c_i++) {
    if (localB->e1_mask_data[localB->c_i]) {
      localB->nb_data[localB->c_trueCount] = static_cast<uint8_T>(localB->c_i +
        1);
      localB->c_trueCount++;
    }
  }
  ...
  localB->loop_ub = rtu_GAL_NavigationData_Bu_DIMS1->SVID;
  if (localB->loop_ub - 1 >= 0) {
    std::memset(&localB->mask_navdata_e1_data[0], 0, static_cast<uint32_T>
                (localB->loop_ub) * sizeof(boolean_T));
  }
  ...
  for (localB->c_i = 0; localB->c_i < localDW->SFunction_DIMS3; localB->c_i++) {
    if (localB->mask_navdata_e1_size == rtu_GAL_NavigationData_Bu_DIMS1->SVID) {
      ...
      for (localB->c_trueCount = 0; localB->c_trueCount < localB->loop_ub;
           localB->c_trueCount++) {
        localB->mask_navdata_e1_data[localB->c_trueCount] =
          (localB->mask_navdata_e1_data[localB->c_trueCount] ||
           (rtu_GAL_NavigationData_Bus->SVID[localB->c_trueCount] ==
            localB->trueCount));
      }
    } else {
      DDRTCM_binary_expand_op_bn(localB->mask_navdata_e1_data,
        &localB->mask_navdata_e1_size, rtu_GAL_NavigationData_Bus,
        rtu_GAL_NavigationData_Bu_DIMS1, localB->svid_e1, localB->c_i);
    }
  }

  localB->r4 = *rtu_GAL_NavigationData_Bus;
  emxConvertStructToEmx_gnssops_b(&localB->r, &localB->r4,
    rtu_GAL_NavigationData_Bu_DIMS1);
  DDRTCM_select_navigation_data_d(&localB->r, localB->mask_navdata_e1_data,
    &localB->mask_navdata_e1_size, &localB->expl_temp, localB);
  ...
  DDRTCM_any_lhpl(localB->e5a_mask_data, localB->e5a_mask_size,
                  localB->mask_available_SV_data, localB->gnss_freq_Matrix_size);
  localB->trueCount = localB->gnss_freq_Matrix_size[1] - 1;
  localB->c_trueCount = 0;
  for (localB->c_i = 0; localB->c_i <= localB->trueCount; localB->c_i++) {
  ...
  if (localDW->SFunction_DIMS12 - 1 >= 0) {
    std::memcpy(&localB->a__1_data[0], &localB->h_data[0], static_cast<uint32_T>
                (localDW->SFunction_DIMS12) * sizeof(uint16_T));
  }

  if (localDW->SFunction_DIMS12 - 1 >= 0) {
    std::memcpy(&localB->svid_e5a[0], &localB->a__1_data[0],
                static_cast<uint32_T>(localDW->SFunction_DIMS12) * sizeof
                (uint16_T));
  }
  ...
  for (localB->c_i = 0; localB->c_i <= localB->trueCount; localB->c_i++) {
    if (localB->e5a_mask_data[localB->c_i]) {
      localB->ob_data[localB->c_trueCount] = static_cast<uint8_T>(localB->c_i +
        1);
      localB->c_trueCount++;
    }
  }
  ...
  for (localB->c_i = 0; localB->c_i <= localB->q_size_idx_1; localB->c_i++) {
    if (localB->e5_mask_data[localB->c_i]) {
      localB->pb_data[localB->c_trueCount] = static_cast<uint8_T>(localB->c_i +
        1);
      localB->c_trueCount++;
    }
  }
  ...
  for (localB->c_i = 0; localB->c_i <= localB->trueCount; localB->c_i++) {
    if (localB->e5a_mask_data[localB->c_i]) {
      localB->qb_data[localB->c_trueCount] = static_cast<uint8_T>(localB->c_i +
        1);
      localB->c_trueCount++;
    }
  }
  ...
  for (localB->c_i = 0; localB->c_i <= localB->trueCount; localB->c_i++) {
    if (localB->e5a_mask_data[localB->c_i]) {
      localB->rb_data[localB->c_trueCount] = static_cast<uint8_T>(localB->c_i +
        1);
      localB->c_trueCount++;
    }
  }
  ...
  for (localB->c_i = 0; localB->c_i <= localB->trueCount; localB->c_i++) {
    if (localB->e5a_mask_data[localB->c_i]) {
      localB->sb_data[localB->c_trueCount] = static_cast<uint8_T>(localB->c_i +
        1);
      localB->c_trueCount++;
    }
  }
  ...
  for (localB->c_i = 0; localB->c_i <= localB->trueCount; localB->c_i++) {
    if (localB->e5a_mask_data[localB->c_i]) {
      localB->tb_data[localB->c_trueCount] = static_cast<uint8_T>(localB->c_i +
        1);
      localB->c_trueCount++;
    }
  }
  ...
  for (localB->c_i = 0; localB->c_i <= localB->trueCount; localB->c_i++) {
    if (localB->e5a_mask_data[localB->c_i]) {
      localB->ub_data[localB->c_trueCount] = static_cast<uint8_T>(localB->c_i +
        1);
      localB->c_trueCount++;
    }
  }
  ...
  for (localB->c_i = 0; localB->c_i < localDW->SFunction_DIMS12; localB->c_i++)
  {
    if (localB->mask_navdata_e1_size == rtu_GAL_NavigationData_Bu_DIMS1->SVID) {
      ...
      DDRTCM_binary_expand_op_bn(localB->mask_navdata_e1_data,
        &localB->mask_navdata_e1_size, rtu_GAL_NavigationData_Bus,
        rtu_GAL_NavigationData_Bu_DIMS1, localB->svid_e5a, localB->c_i);
    }
  }

  localB->r4 = *rtu_GAL_NavigationData_Bus;
  emxConvertStructToEmx_gnssops_b(&localB->r1, &localB->r4,
    rtu_GAL_NavigationData_Bu_DIMS1);
  DDRTCM_select_navigation_data_d(&localB->r1, localB->mask_navdata_e1_data,
    &localB->mask_navdata_e1_size, &localB->expl_temp, localB);
  ...
  if (localB->loop_ub - 1 >= 0) {
    std::memcpy(&localB->navdata_e5a.DELTA_N[0], &localB->
                expl_temp.DELTA_N.data[0], static_cast<uint32_T>(localB->loop_ub)
                * sizeof(real_T));
  }
  ...
  if (localB->loop_ub - 1 >= 0) {
    std::memcpy(&localB->navdata_e5a.OMEGA_0[0], &localB->
                expl_temp.OMEGA_0.data[0], static_cast<uint32_T>(localB->loop_ub)
                * sizeof(real_T));
  }
  ...
  DDRTCM_any_lhpl(localB->e5b_mask_data, localB->e5b_mask_size,
                  localB->mask_available_SV_data, localB->gnss_freq_Matrix_size);
  localB->trueCount = localB->gnss_freq_Matrix_size[1] - 1;
  localB->c_trueCount = 0;
  for (localB->c_i = 0; localB->c_i <= localB->trueCount; localB->c_i++) {
  ...
  if (localDW->SFunction_DIMS21 - 1 >= 0) {
    std::memcpy(&localB->a__1_data[0], &localB->l_data[0], static_cast<uint32_T>
                (localDW->SFunction_DIMS21) * sizeof(uint16_T));
  }

  if (localDW->SFunction_DIMS21 - 1 >= 0) {
    std::memcpy(&localB->svid_e5b[0], &localB->a__1_data[0],
                static_cast<uint32_T>(localDW->SFunction_DIMS21) * sizeof
                (uint16_T));
  }
  ...
  for (localB->c_i = 0; localB->c_i <= localB->trueCount; localB->c_i++) {
    if (localB->e5b_mask_data[localB->c_i]) {
      localB->vb_data[localB->c_trueCount] = static_cast<uint8_T>(localB->c_i +
        1);
      localB->c_trueCount++;
    }
  }
  ...
  for (localB->c_i = 0; localB->c_i <= localB->trueCount; localB->c_i++) {
    if (localB->e5b_mask_data[localB->c_i]) {
      localB->wb_data[localB->c_trueCount] = static_cast<uint8_T>(localB->c_i +
        1);
      localB->c_trueCount++;
    }
  }
  ...
  for (localB->c_i = 0; localB->c_i <= localB->trueCount; localB->c_i++) {
    if (localB->e5b_mask_data[localB->c_i]) {
      localB->xb_data[localB->c_trueCount] = static_cast<uint8_T>(localB->c_i +
        1);
      localB->c_trueCount++;
    }
  }
  ...
  for (localB->c_i = 0; localB->c_i <= localB->trueCount; localB->c_i++) {
    if (localB->e5b_mask_data[localB->c_i]) {
      localB->yb_data[localB->c_trueCount] = static_cast<uint8_T>(localB->c_i +
        1);
      localB->c_trueCount++;
    }
  }
  ...
  for (localB->c_i = 0; localB->c_i <= localB->trueCount; localB->c_i++) {
    if (localB->e5b_mask_data[localB->c_i]) {
      localB->ac_data[localB->c_trueCount] = static_cast<uint8_T>(localB->c_i +
        1);
      localB->c_trueCount++;
    }
  }
  ...
  for (localB->c_i = 0; localB->c_i <= localB->trueCount; localB->c_i++) {
    if (localB->e5b_mask_data[localB->c_i]) {
      localB->bc_data[localB->c_trueCount] = static_cast<uint8_T>(localB->c_i +
        1);
      localB->c_trueCount++;
    }
  }
  ...
  for (localB->c_i = 0; localB->c_i <= localB->trueCount; localB->c_i++) {
    if (localB->e5b_mask_data[localB->c_i]) {
      localB->cc_data[localB->c_trueCount] = static_cast<uint8_T>(localB->c_i +
        1);
      localB->c_trueCount++;
    }
  }
  ...
  for (localB->c_i = 0; localB->c_i < localDW->SFunction_DIMS21; localB->c_i++)
  {
    if (localB->mask_navdata_e1_size == rtu_GAL_NavigationData_Bu_DIMS1->SVID) {
      ...
      DDRTCM_binary_expand_op_bn(localB->mask_navdata_e1_data,
        &localB->mask_navdata_e1_size, rtu_GAL_NavigationData_Bus,
        rtu_GAL_NavigationData_Bu_DIMS1, localB->svid_e5b, localB->c_i);
    }
  }

  localB->r4 = *rtu_GAL_NavigationData_Bus;
  emxConvertStructToEmx_gnssops_b(&localB->r2, &localB->r4,
    rtu_GAL_NavigationData_Bu_DIMS1);
  DDRTCM_select_navigation_data_d(&localB->r2, localB->mask_navdata_e1_data,
    &localB->mask_navdata_e1_size, &localB->expl_temp, localB);
  ...
  DDRTCM_any_lhpl(localB->e5_mask_data, localB->e5_mask_size,
                  localB->mask_available_SV_data, localB->gnss_freq_Matrix_size);
  localB->trueCount = localB->gnss_freq_Matrix_size[1] - 1;
  localB->c_trueCount = 0;
  for (localB->c_i = 0; localB->c_i <= localB->trueCount; localB->c_i++) {
  ...
  if (localDW->SFunction_DIMS30 - 1 >= 0) {
    std::memcpy(&localB->a__1_data[0], &localB->n_data[0], static_cast<uint32_T>
                (localDW->SFunction_DIMS30) * sizeof(uint16_T));
  }

  if (localDW->SFunction_DIMS30 - 1 >= 0) {
    std::memcpy(&localB->svid_e5[0], &localB->a__1_data[0], static_cast<uint32_T>
                (localDW->SFunction_DIMS30) * sizeof(uint16_T));
  }
  ...
  for (localB->c_i = 0; localB->c_i <= localB->q_size_idx_1; localB->c_i++) {
    if (localB->e5_mask_data[localB->c_i]) {
      localB->dc_data[localB->c_trueCount] = static_cast<uint8_T>(localB->c_i +
        1);
      localB->c_trueCount++;
    }
  }
  ...
  for (localB->c_i = 0; localB->c_i <= localB->q_size_idx_1; localB->c_i++) {
    if (localB->e5_mask_data[localB->c_i]) {
      localB->ec_data[localB->c_trueCount] = static_cast<uint8_T>(localB->c_i +
        1);
      localB->c_trueCount++;
    }
  }
  ...
  for (localB->c_i = 0; localB->c_i <= localB->q_size_idx_1; localB->c_i++) {
    if (localB->e5_mask_data[localB->c_i]) {
      localB->fc_data[localB->c_trueCount] = static_cast<uint8_T>(localB->c_i +
        1);
      localB->c_trueCount++;
    }
  }
  ...
  for (localB->c_i = 0; localB->c_i <= localB->q_size_idx_1; localB->c_i++) {
    if (localB->e5_mask_data[localB->c_i]) {
      localB->gc_data[localB->c_trueCount] = static_cast<uint8_T>(localB->c_i +
        1);
      localB->c_trueCount++;
    }
  }
  ...
  for (localB->c_i = 0; localB->c_i <= localB->q_size_idx_1; localB->c_i++) {
    if (localB->e5_mask_data[localB->c_i]) {
      localB->hc_data[localB->c_trueCount] = static_cast<uint8_T>(localB->c_i +
        1);
      localB->c_trueCount++;
    }
  }
  ...
  for (localB->c_i = 0; localB->c_i <= localB->q_size_idx_1; localB->c_i++) {
    if (localB->e5_mask_data[localB->c_i]) {
      localB->ic_data[localB->c_trueCount] = static_cast<uint8_T>(localB->c_i +
        1);
      localB->c_trueCount++;
    }
  }
  ...
  for (localB->c_i = 0; localB->c_i <= localB->q_size_idx_1; localB->c_i++) {
    if (localB->e5_mask_data[localB->c_i]) {
      localB->jc_data[localB->c_trueCount] = static_cast<uint8_T>(localB->c_i +
        1);
      localB->c_trueCount++;
    }
  }
  ...
  for (localB->c_i = 0; localB->c_i < localDW->SFunction_DIMS30; localB->c_i++)
  {
    if (localB->mask_navdata_e1_size == rtu_GAL_NavigationData_Bu_DIMS1->SVID) {
      ...
      DDRTCM_binary_expand_op_bn(localB->mask_navdata_e1_data,
        &localB->mask_navdata_e1_size, rtu_GAL_NavigationData_Bus,
        rtu_GAL_NavigationData_Bu_DIMS1, localB->svid_e5, localB->c_i);
    }
  }

  localB->r4 = *rtu_GAL_NavigationData_Bus;
  emxConvertStructToEmx_gnssops_b(&localB->r3, &localB->r4,
    rtu_GAL_NavigationData_Bu_DIMS1);
  DDRTCM_select_navigation_data_d(&localB->r3, localB->mask_navdata_e1_data,
    &localB->mask_navdata_e1_size, &localB->expl_temp, localB);
  ...
  for (localB->trueCount = 0; localB->trueCount < localDW->SFunction_DIMS5;
       localB->trueCount++) {
    localB->pr_e1[localB->trueCount] = localB->tmp_pr_data[localB->
      hb_data[localB->trueCount] - 1];
  }

  for (localB->trueCount = 0; localB->trueCount < localDW->SFunction_DIMS6;
       localB->trueCount++) {
    localB->pr_e1_sigma[localB->trueCount] = localB->tmp_pr_sigma_data
      [localB->ib_data[localB->trueCount] - 1];
  }

  for (localB->trueCount = 0; localB->trueCount < localDW->SFunction_DIMS7;
       localB->trueCount++) {
    localB->dr_e1[localB->trueCount] = localB->tmp_dr_data[localB->
      mb_data[localB->trueCount] - 1];
  }

  for (localB->trueCount = 0; localB->trueCount < localDW->SFunction_DIMS8;
       localB->trueCount++) {
    localB->cn0_e1[localB->trueCount] = localB->gnss_freq_Matrix_data
      [localB->nb_data[localB->trueCount] - 1];
  }

  for (localB->trueCount = 0; localB->trueCount < localDW->SFunction_DIMS9;
       localB->trueCount++) {
    localB->cp_e1[localB->trueCount] = localB->tmp_cp_data[localB->
      jb_data[localB->trueCount] - 1];
  }

  for (localB->trueCount = 0; localB->trueCount < localDW->SFunction_DIMS10;
       localB->trueCount++) {
    localB->cp_e1_sigma[localB->trueCount] = localB->tmp_cp_sigma_data
      [localB->kb_data[localB->trueCount] - 1];
  }

  for (localB->trueCount = 0; localB->trueCount < localDW->SFunction_DIMS11;
       localB->trueCount++) {
    localB->locktime_e1[localB->trueCount] = localB->tmp_locktime_data
      [localB->lb_data[localB->trueCount] - 1];
  }

  for (localB->trueCount = 0; localB->trueCount < localDW->SFunction_DIMS14;
       localB->trueCount++) {
    localB->pr_e5a[localB->trueCount] = localB->tmp_pr_data[localB->
      ob_data[localB->trueCount] - 1];
  }

  for (localB->trueCount = 0; localB->trueCount < localDW->SFunction_DIMS15;
       localB->trueCount++) {
    localB->pr_e5a_sigma[localB->trueCount] = localB->tmp_pr_data
      [localB->pb_data[localB->trueCount] - 1];
  }

  for (localB->trueCount = 0; localB->trueCount < localDW->SFunction_DIMS16;
       localB->trueCount++) {
    localB->dr_e5a[localB->trueCount] = localB->tmp_dr_data[localB->
      tb_data[localB->trueCount] - 1];
  }

  for (localB->trueCount = 0; localB->trueCount < localDW->SFunction_DIMS17;
       localB->trueCount++) {
    localB->cn0_e5a[localB->trueCount] = localB->gnss_freq_Matrix_data
      [localB->ub_data[localB->trueCount] - 1];
  }

  for (localB->trueCount = 0; localB->trueCount < localDW->SFunction_DIMS18;
       localB->trueCount++) {
    localB->cp_e5a[localB->trueCount] = localB->tmp_cp_data[localB->
      qb_data[localB->trueCount] - 1];
  }

  for (localB->trueCount = 0; localB->trueCount < localDW->SFunction_DIMS19;
       localB->trueCount++) {
    localB->cp_e5a_sigma[localB->trueCount] = localB->tmp_cp_data
      [localB->rb_data[localB->trueCount] - 1];
  }

  for (localB->trueCount = 0; localB->trueCount < localDW->SFunction_DIMS20;
       localB->trueCount++) {
    localB->locktime_e5a[localB->trueCount] = localB->tmp_locktime_data
      [localB->sb_data[localB->trueCount] - 1];
  }

  for (localB->trueCount = 0; localB->trueCount < localDW->SFunction_DIMS23;
       localB->trueCount++) {
    localB->pr_e5b[localB->trueCount] = localB->tmp_pr_data[localB->
      vb_data[localB->trueCount] - 1];
  }

  for (localB->trueCount = 0; localB->trueCount < localDW->SFunction_DIMS24;
       localB->trueCount++) {
    localB->pr_e5b_sigma[localB->trueCount] = localB->tmp_pr_sigma_data
      [localB->wb_data[localB->trueCount] - 1];
  }

  for (localB->trueCount = 0; localB->trueCount < localDW->SFunction_DIMS25;
       localB->trueCount++) {
    localB->dr_e5b[localB->trueCount] = localB->tmp_dr_data[localB->
      bc_data[localB->trueCount] - 1];
  }

  for (localB->trueCount = 0; localB->trueCount < localDW->SFunction_DIMS26;
       localB->trueCount++) {
    localB->cn0_e5b[localB->trueCount] = localB->gnss_freq_Matrix_data
      [localB->cc_data[localB->trueCount] - 1];
  }

  for (localB->trueCount = 0; localB->trueCount < localDW->SFunction_DIMS27;
       localB->trueCount++) {
    localB->cp_e5b[localB->trueCount] = localB->tmp_cp_data[localB->
      xb_data[localB->trueCount] - 1];
  }

  for (localB->trueCount = 0; localB->trueCount < localDW->SFunction_DIMS28;
       localB->trueCount++) {
    localB->cp_e5b_sigma[localB->trueCount] = localB->tmp_cp_sigma_data
      [localB->yb_data[localB->trueCount] - 1];
  }

  for (localB->trueCount = 0; localB->trueCount < localDW->SFunction_DIMS29;
       localB->trueCount++) {
    localB->locktime_e5b[localB->trueCount] = localB->tmp_locktime_data
      [localB->ac_data[localB->trueCount] - 1];
  }

  for (localB->trueCount = 0; localB->trueCount < localDW->SFunction_DIMS32;
       localB->trueCount++) {
    localB->pr_e5[localB->trueCount] = localB->tmp_pr_data[localB->
      dc_data[localB->trueCount] - 1];
  }

  for (localB->trueCount = 0; localB->trueCount < localDW->SFunction_DIMS33;
       localB->trueCount++) {
    localB->pr_e5_sigma[localB->trueCount] = localB->tmp_pr_sigma_data
      [localB->ec_data[localB->trueCount] - 1];
  }

  for (localB->trueCount = 0; localB->trueCount < localDW->SFunction_DIMS34;
       localB->trueCount++) {
    localB->dr_e5[localB->trueCount] = localB->tmp_dr_data[localB->
      ic_data[localB->trueCount] - 1];
  }

  for (localB->trueCount = 0; localB->trueCount < localDW->SFunction_DIMS35;
       localB->trueCount++) {
    localB->cn0_e5[localB->trueCount] = localB->gnss_freq_Matrix_data
      [localB->jc_data[localB->trueCount] - 1];
  }

  for (localB->trueCount = 0; localB->trueCount < localDW->SFunction_DIMS36;
       localB->trueCount++) {
    localB->cp_e5[localB->trueCount] = localB->tmp_cp_data[localB->
      fc_data[localB->trueCount] - 1];
  }

  for (localB->trueCount = 0; localB->trueCount < localDW->SFunction_DIMS37;
       localB->trueCount++) {
    localB->cp_e5_sigma[localB->trueCount] = localB->tmp_cp_sigma_data
      [localB->gc_data[localB->trueCount] - 1];
  }

  for (localB->trueCount = 0; localB->trueCount < localDW->SFunction_DIMS38;
       localB->trueCount++) {
    localB->locktime_e5[localB->trueCount] = localB->tmp_locktime_data
      [localB->hc_data[localB->trueCount] - 1];
  }
}
