...
// Function for MATLAB Function: '<S16>/Simplify and Mask GPS Measurement Bus'
void DDRTCM::DDRTCM_any_l(const boolean_T x[200], boolean_T y[40])
{
  int32_T i2;
  i2 = 1;
...
// Function for MATLAB Function: '<S16>/Simplify and Mask GPS Measurement Bus'
void DDRTCM::DDRTCM_eml_find(const boolean_T x[4], int32_T i_data[], int32_T
  i_size[2])
{
  int32_T idx;
  int32_T ii;
...
// Function for MATLAB Function: '<S16>/Simplify and Mask GPS Measurement Bus'
void DDRTCM::DDRTCM_merge_p(int32_T idx_data[], uint16_T x_data[], int32_T
...
// Function for MATLAB Function: '<S16>/Simplify and Mask GPS Measurement Bus'
void DDRTCM::DDRTCM_sort_o(uint16_T x_data[], int32_T x_size[2], int32_T
    ...
    if (x_size[1] > 1) {
      ...
      while (nLeft > 1) {
        if ((static_cast<uint32_T>(nLeft) & 1U) != 0U) {
          ...
          i = x_size[1] - i2;
          if (i > nDone) {
            DDRTCM_merge_p(idx_data, localB->b_x_data, i2, nDone, i - nDone,
        ...
        nLeft >>= 1;
        for (i2 = 0; i2 < nLeft; i2++) {
          DDRTCM_merge_p(idx_data, localB->b_x_data, i2 * i, nDone, nDone,
                         localB->iwork_data, localB->xwork_data);
        }
      ...
      if (x_size[1] > nDone) {
        DDRTCM_merge_p(idx_data, localB->b_x_data, 0, nDone, x_size[1] - nDone,
                       localB->iwork_data, localB->xwork_data);
      }
    }
  }
...
// Function for MATLAB Function: '<S16>/Simplify and Mask GPS Measurement Bus'
boolean_T DDRTCM::DDRTCM_any_ln(const boolean_T x_data[], const int32_T *x_size)
{
  int32_T ix;
  boolean_T exitg1;
  boolean_T y;
...
void DDRTCM::DDRTCM_binary_expand_op_ol2y(real_T in1_data[], int32_T in1_size[2],
...
// Function for MATLAB Function: '<S16>/Simplify and Mask GPS Measurement Bus'
void DDRTCM::DDRTCM_any_lnz(const boolean_T x_data[], const int32_T x_size[2],
...
void DDRTCM::emxConvertDynamicMatrixToEmx_37(emxArray_real_T_37_DDRTCM_T *emx,
...
void DDRTCM::emxConvertStructToEmx_gnssops_n(emxArray__gnssops_navigation__T
...
void DDRTCM::DDRTCM_binary_expand_op_ol2(boolean_T in1_data[], int32_T *in1_size,
...
// Function for MATLAB Function: '<S16>/Simplify and Mask GPS Measurement Bus'
void DDRTCM::DDRTCM_select_navigation_data(const emxArray__gnssops_navigation__T
  ...
  B_SimplifyandMaskGPSMeasureme_T *localB)
{
  ...
  for (trueCount = 0; trueCount < b_size_idx_0; trueCount++) {
    navigation_data_selected->C_us.data[trueCount] = navigation_data->
      C_us.data[localB->o_data_b[trueCount] - 1];
  }
  ...
  for (trueCount = 0; trueCount < b_size_idx_0; trueCount++) {
    navigation_data_selected->SQRT_A.data[trueCount] =
      navigation_data->SQRT_A.data[localB->p_data_p[trueCount] - 1];
  }
  ...
  for (trueCount = 0; trueCount < b_size_idx_0; trueCount++) {
    navigation_data_selected->T_oe.data[trueCount] = navigation_data->
      T_oe.data[localB->q_data_c[trueCount] - 1];
  }
  ...
  for (trueCount = 0; trueCount < b_size_idx_0; trueCount++) {
    navigation_data_selected->C_ic.data[trueCount] = navigation_data->
      C_ic.data[localB->r_data_f[trueCount] - 1];
  }
  ...
  for (trueCount = 0; trueCount < b_size_idx_0; trueCount++) {
    navigation_data_selected->OMEGA_0.data[trueCount] =
      navigation_data->OMEGA_0.data[localB->s_data_g[trueCount] - 1];
  }
  ...
  for (trueCount = 0; trueCount < b_size_idx_0; trueCount++) {
    navigation_data_selected->I_0.data[trueCount] = navigation_data->
      I_0.data[localB->u_data_m[trueCount] - 1];
  }
  ...
  for (trueCount = 0; trueCount < b_size_idx_0; trueCount++) {
    navigation_data_selected->C_rc.data[trueCount] = navigation_data->
      C_rc.data[localB->v_data_n[trueCount] - 1];
  }
  ...
  for (trueCount = 0; trueCount < b_size_idx_0; trueCount++) {
    navigation_data_selected->omega.data[trueCount] =
      navigation_data->omega.data[localB->w_data_p[trueCount] - 1];
  }
  ...
  for (trueCount = 0; trueCount < b_size_idx_0; trueCount++) {
    navigation_data_selected->OMEGADOT.data[trueCount] =
      navigation_data->OMEGADOT.data[localB->x_data_l[trueCount] - 1];
  }
  ...
  for (trueCount = 0; trueCount < b_size_idx_0; trueCount++) {
    navigation_data_selected->IDOT.data[trueCount] = navigation_data->
      IDOT.data[localB->y_data_j[trueCount] - 1];
  }
}
...
//    '<S143>/Simplify and Mask GPS Measurement Bus'
//
void DDRTCM::SimplifyandMaskGPSMeasurementBu(const gnssraw_measurement_t
  ...
  *localB, DW_SimplifyandMaskGPSMeasurem_T *localDW)
{
  ...
  for (localB->trueCount = 0; localB->trueCount < 200; localB->trueCount++) {
    localB->L1_mask_data[localB->trueCount] = (rtu_GpsMeasurementBus->
      Type[localB->trueCount] == 0);
  }

  DDRTCM_any_l(localB->L1_mask_data, localB->mask_available_SV_data);
  for (localB->trueCount = 0; localB->trueCount < 200; localB->trueCount++) {
    localB->L1_mask_data[localB->trueCount] = (rtu_GpsMeasurementBus->
      Type[localB->trueCount] == 3);
  }

  DDRTCM_any_l(localB->L1_mask_data, localB->bv);
  for (localB->trueCount = 0; localB->trueCount < 40; localB->trueCount++) {
    localB->dc[localB->trueCount] = ((localB->mask_available_SV_data
      [localB->trueCount] && rtu_parameters_gps_Bus->enable_gps_l1) ||
      (localB->bv[localB->trueCount] && rtu_parameters_gps_Bus->enable_gps_l2));
  }
  ...
  for (localB->trueCount = 0; localB->trueCount < localB->n_size_idx_1;
       localB->trueCount++) {
    localB->tmp_svid_data[localB->trueCount] = rtu_GpsMeasurementBus->
      SVID[localB->n_data[localB->trueCount] - 1];
  }
  ...
  for (localB->c_i = 0; localB->c_i < localB->o_size_idx_1; localB->c_i++) {
    for (localB->trueCount = 0; localB->trueCount < 5; localB->trueCount++) {
      localB->loop_ub = rtu_GpsMeasurementBus->Type[(localB->o_data[localB->c_i]
        - 1) * 5 + localB->trueCount];
      ...
      DDRTCM_eml_find(localB->rtu_GpsMeasurementBus, localB->ec_data,
                      localB->ec_size);
      if (localB->ec_size[1] != 0) {
        localB->gnss_freq_Matrix_data[localB->trueCount + 5 * localB->c_i] =
          gnss_frequency[localB->ec_data[0] - 1];
      }
    }
  }
  ...
  if (localB->n_size_idx_1 - 1 >= 0) {
    std::memcpy(&localB->a__1_data[0], &localB->tmp_svid_data[0],
                static_cast<uint32_T>(localB->n_size_idx_1) * sizeof(uint16_T));
  }

  DDRTCM_sort_o(localB->a__1_data, localB->a__1_size, localB->iidx_data,
                localB->ec_size, localB);
  ...
  if (localB->n_size_idx_1 - 1 >= 0) {
    std::memset(&localB->mask_available_SV_data[0], 0, static_cast<uint32_T>
                (localB->n_size_idx_1) * sizeof(boolean_T));
  }
  ...
  for (localB->c_i = 0; localB->c_i < localB->n_size_idx_1; localB->c_i++) {
    ...
    for (localB->trueCount = 0; localB->trueCount < localB->loop_ub;
         localB->trueCount++) {
      localB->mask_navdata_L1_data[localB->trueCount] =
        (rtu_GpsNavBusReshaped->SVID[localB->trueCount] == localB->tmp_svid);
    }

    if (DDRTCM_any_ln(localB->mask_navdata_L1_data,
                      &localB->mask_navdata_L1_size)) {
  ...
  for (localB->trueCount = 0; localB->trueCount <= localB->c_trueCount_tmp;
       localB->trueCount++) {
    if (localB->mask_available_SV_data[localB->trueCount]) {
      localB->w_data[localB->loop_ub] = static_cast<int8_T>(localB->trueCount +
        1);
      localB->loop_ub++;
    }
  }

  for (localB->trueCount = 0; localB->trueCount < localB->w_size_idx_1;
       localB->trueCount++) {
    for (localB->n_size_idx_1 = 0; localB->n_size_idx_1 < 5;
         localB->n_size_idx_1++) {
      localB->tmp_type_data[localB->n_size_idx_1 + 5 * localB->trueCount] =
        rtu_GpsMeasurementBus->Type[(localB->o_data[localB->iidx_data
        [localB->w_data[localB->trueCount] - 1] - 1] - 1) * 5 +
        localB->n_size_idx_1];
    }
  }
  ...
  for (localB->trueCount = 0; localB->trueCount <= localB->c_trueCount_tmp;
       localB->trueCount++) {
    if (localB->mask_available_SV_data[localB->trueCount]) {
      localB->x_data[localB->loop_ub] = static_cast<int8_T>(localB->trueCount +
        1);
      localB->loop_ub++;
    }
  }

  for (localB->trueCount = 0; localB->trueCount < localB->tmp_svid;
       localB->trueCount++) {
    for (localB->n_size_idx_1 = 0; localB->n_size_idx_1 < 5;
         localB->n_size_idx_1++) {
      localB->tmp_pr_data[localB->n_size_idx_1 + 5 * localB->trueCount] =
        rtu_GpsMeasurementBus->Pseudorange[(localB->p_data[localB->
        iidx_data[localB->x_data[localB->trueCount] - 1] - 1] - 1) * 5 +
        localB->n_size_idx_1];
    }
  }
  ...
  for (localB->trueCount = 0; localB->trueCount < localB->tmp_svid;
    ...
    for (localB->n_size_idx_1 = 0; localB->n_size_idx_1 < 5;
      ...
      localB->tmp_pr_sigma_data[localB->n_size_idx_1 + 5 * localB->trueCount] =
        rtu_GpsMeasurementBus->Pseudorange_Sigma[(localB->q_data
        [localB->iidx_data[localB->y_data[localB->trueCount] - 1] - 1] - 1) * 5
        + localB->n_size_idx_1];
    }
  }
  ...
  for (localB->trueCount = 0; localB->trueCount < localB->tmp_svid;
    ...
    for (localB->n_size_idx_1 = 0; localB->n_size_idx_1 < 5;
         localB->n_size_idx_1++) {
      localB->tmp_cp_data[localB->n_size_idx_1 + 5 * localB->trueCount] =
        rtu_GpsMeasurementBus->Carrier[(localB->r_data[localB->iidx_data
        [localB->ab_data[localB->trueCount] - 1] - 1] - 1) * 5 +
        localB->n_size_idx_1];
    }
  }
  ...
  for (localB->trueCount = 0; localB->trueCount < localB->tmp_svid;
    ...
    for (localB->n_size_idx_1 = 0; localB->n_size_idx_1 < 5;
      ...
      localB->tmp_cp_sigma_data[localB->n_size_idx_1 + 5 * localB->trueCount] =
        rtu_GpsMeasurementBus->Carrier_Sigma[(localB->s_data[localB->
        iidx_data[localB->bb_data[localB->trueCount] - 1] - 1] - 1) * 5 +
        localB->n_size_idx_1];
    }
  }
  ...
  for (localB->trueCount = 0; localB->trueCount < localB->tmp_svid;
    ...
    for (localB->n_size_idx_1 = 0; localB->n_size_idx_1 < 5;
         localB->n_size_idx_1++) {
      localB->tmp_Locktime_data[localB->n_size_idx_1 + 5 * localB->trueCount] =
        rtu_GpsMeasurementBus->Locktime[(localB->t_data[localB->iidx_data
        [localB->cb_data[localB->trueCount] - 1] - 1] - 1) * 5 +
        localB->n_size_idx_1];
    }
  }
  ...
  if (localB->u_size[1] == static_cast<int8_T>(localB->o_size_idx_1)) {
    ...
    for (localB->trueCount = 0; localB->trueCount < localB->loop_ub;
      ...
      for (localB->n_size_idx_1 = 0; localB->n_size_idx_1 < 5;
           localB->n_size_idx_1++) {
        localB->tmp_svid = localB->iidx_data[localB->db_data[localB->trueCount]
          - 1] - 1;
        localB->tmp_dr_data[localB->n_size_idx_1 + 5 * localB->trueCount] =
          -rtu_GpsMeasurementBus->Doppler[(localB->u_data[localB->tmp_svid] - 1)
          * 5 + localB->n_size_idx_1] * 2.99792458E+8 /
          localB->gnss_freq_Matrix_data[5 * localB->tmp_svid +
          localB->n_size_idx_1];
      }
    }
  } else {
    DDRTCM_binary_expand_op_ol2y(localB->tmp_dr_data, localB->a__1_size,
      rtu_GpsMeasurementBus, localB->u_data, localB->u_size,
      localB->gnss_freq_Matrix_data, localB->gnss_freq_Matrix_size,
      localB->iidx_data, localB->db_data, localB->db_size, localB);
  }
  ...
  for (localB->trueCount = 0; localB->trueCount < localB->o_size_idx_1;
       localB->trueCount++) {
    for (localB->n_size_idx_1 = 0; localB->n_size_idx_1 < 5;
         localB->n_size_idx_1++) {
      localB->gnss_freq_Matrix_data[localB->n_size_idx_1 + 5 * localB->trueCount]
        = rtu_GpsMeasurementBus->CN0[(localB->v_data[localB->iidx_data
        [localB->eb_data[localB->trueCount] - 1] - 1] - 1) * 5 +
        localB->n_size_idx_1];
    }
  }
  ...
  if (localB->trueCount - 1 >= 0) {
    std::memset(&localB->L1_mask_data[0], 0, static_cast<uint32_T>
  ...
  if (localB->trueCount - 1 >= 0) {
    std::memset(&localB->L2C_mask_data[0], 0, static_cast<uint32_T>
                (localB->trueCount) * sizeof(boolean_T));
  }
  ...
  if (localB->trueCount - 1 >= 0) {
    std::memset(&localB->L5_mask_data[0], 0, static_cast<uint32_T>
                (localB->trueCount) * sizeof(boolean_T));
  }

  for (localB->n_size_idx_1 = 0; localB->n_size_idx_1 < localB->c_i;
       localB->n_size_idx_1++) {
    for (localB->trueCount = 0; localB->trueCount < 5; localB->trueCount++) {
      uint8_T tmp_type;
  ...
  DDRTCM_any_lnz(localB->L1_mask_data, localB->L1_mask_size,
  ...
  if (localDW->SFunction_DIMS3 - 1 >= 0) {
    std::memcpy(&localB->svid_L1[0], &localB->a__1_data[0], static_cast<uint32_T>
                (localDW->SFunction_DIMS3) * sizeof(uint16_T));
  }
  ...
  for (localB->c_i = 0; localB->c_i <= localB->trueCount; localB->c_i++) {
    if (localB->L1_mask_data[localB->c_i]) {
      localB->fb_data[localB->n_size_idx_1] = static_cast<uint8_T>(localB->c_i +
        1);
      localB->n_size_idx_1++;
    }
  }
  ...
  for (localB->c_i = 0; localB->c_i <= localB->trueCount; localB->c_i++) {
    if (localB->L1_mask_data[localB->c_i]) {
      localB->gb_data[localB->n_size_idx_1] = static_cast<uint8_T>(localB->c_i +
        1);
      localB->n_size_idx_1++;
    }
  }
  ...
  for (localB->c_i = 0; localB->c_i <= localB->trueCount; localB->c_i++) {
    if (localB->L1_mask_data[localB->c_i]) {
      localB->hb_data[localB->n_size_idx_1] = static_cast<uint8_T>(localB->c_i +
        1);
      localB->n_size_idx_1++;
    }
  }
  ...
  for (localB->c_i = 0; localB->c_i <= localB->trueCount; localB->c_i++) {
    if (localB->L1_mask_data[localB->c_i]) {
      localB->ib_data[localB->n_size_idx_1] = static_cast<uint8_T>(localB->c_i +
        1);
      localB->n_size_idx_1++;
    }
  }
  ...
  for (localB->c_i = 0; localB->c_i <= localB->trueCount; localB->c_i++) {
    if (localB->L1_mask_data[localB->c_i]) {
      localB->jb_data[localB->n_size_idx_1] = static_cast<uint8_T>(localB->c_i +
        1);
      localB->n_size_idx_1++;
    }
  }
  ...
  for (localB->c_i = 0; localB->c_i <= localB->trueCount; localB->c_i++) {
    if (localB->L1_mask_data[localB->c_i]) {
      localB->kb_data[localB->n_size_idx_1] = static_cast<uint8_T>(localB->c_i +
        1);
      localB->n_size_idx_1++;
    }
  }
  ...
  for (localB->c_i = 0; localB->c_i <= localB->trueCount; localB->c_i++) {
    if (localB->L1_mask_data[localB->c_i]) {
      localB->lb_data[localB->n_size_idx_1] = static_cast<uint8_T>(localB->c_i +
        1);
      localB->n_size_idx_1++;
    }
  }
  ...
  localB->loop_ub = rtu_GpsNavBusReshaped_DIMS1->SVID;
  if (localB->loop_ub - 1 >= 0) {
    std::memset(&localB->mask_navdata_L1_data[0], 0, static_cast<uint32_T>
  ...
  for (localB->c_i = 0; localB->c_i < localDW->SFunction_DIMS3; localB->c_i++) {
    if (localB->mask_navdata_L1_size == rtu_GpsNavBusReshaped_DIMS1->SVID) {
      ...
      for (localB->n_size_idx_1 = 0; localB->n_size_idx_1 < localB->loop_ub;
           localB->n_size_idx_1++) {
        localB->mask_navdata_L1_data[localB->n_size_idx_1] =
          (localB->mask_navdata_L1_data[localB->n_size_idx_1] ||
           (rtu_GpsNavBusReshaped->SVID[localB->n_size_idx_1] ==
            localB->trueCount));
      }
    } else {
      DDRTCM_binary_expand_op_ol2(localB->mask_navdata_L1_data,
        &localB->mask_navdata_L1_size, rtu_GpsNavBusReshaped,
        rtu_GpsNavBusReshaped_DIMS1, localB->svid_L1, localB->c_i);
    }
  }
  ...
  DDRTCM_select_navigation_data(&localB->r, localB->mask_navdata_L1_data,
    &localB->mask_navdata_L1_size, &localB->expl_temp, localB);
  ...
  DDRTCM_any_lnz(localB->L2C_mask_data, localB->L2C_mask_size,
                 localB->mask_available_SV_data, localB->gnss_freq_Matrix_size);
  localB->trueCount = localB->gnss_freq_Matrix_size[1] - 1;
  localB->n_size_idx_1 = 0;
  for (localB->c_i = 0; localB->c_i <= localB->trueCount; localB->c_i++) {
  ...
  if (localDW->SFunction_DIMS12 - 1 >= 0) {
    std::memcpy(&localB->svid_L2C[0], &localB->a__1_data[0],
  ...
  for (localB->c_i = 0; localB->c_i <= localB->trueCount; localB->c_i++) {
    if (localB->L2C_mask_data[localB->c_i]) {
      localB->mb_data[localB->n_size_idx_1] = static_cast<uint8_T>(localB->c_i +
        1);
      localB->n_size_idx_1++;
    }
  }
  ...
  for (localB->c_i = 0; localB->c_i <= localB->trueCount; localB->c_i++) {
    if (localB->L2C_mask_data[localB->c_i]) {
      localB->nb_data[localB->n_size_idx_1] = static_cast<uint8_T>(localB->c_i +
        1);
      localB->n_size_idx_1++;
    }
  }
  ...
  for (localB->c_i = 0; localB->c_i <= localB->trueCount; localB->c_i++) {
    if (localB->L2C_mask_data[localB->c_i]) {
      localB->ob_data[localB->n_size_idx_1] = static_cast<uint8_T>(localB->c_i +
        1);
      localB->n_size_idx_1++;
    }
  }
  ...
  for (localB->c_i = 0; localB->c_i <= localB->trueCount; localB->c_i++) {
    if (localB->L2C_mask_data[localB->c_i]) {
      localB->pb_data[localB->n_size_idx_1] = static_cast<uint8_T>(localB->c_i +
        1);
      localB->n_size_idx_1++;
    }
  }
  ...
  for (localB->c_i = 0; localB->c_i <= localB->trueCount; localB->c_i++) {
    if (localB->L2C_mask_data[localB->c_i]) {
      localB->qb_data[localB->n_size_idx_1] = static_cast<uint8_T>(localB->c_i +
        1);
      localB->n_size_idx_1++;
    }
  }
  ...
  for (localB->c_i = 0; localB->c_i <= localB->trueCount; localB->c_i++) {
    if (localB->L2C_mask_data[localB->c_i]) {
      localB->rb_data[localB->n_size_idx_1] = static_cast<uint8_T>(localB->c_i +
        1);
      localB->n_size_idx_1++;
    }
  }
  ...
  for (localB->c_i = 0; localB->c_i <= localB->trueCount; localB->c_i++) {
    if (localB->L2C_mask_data[localB->c_i]) {
      localB->sb_data[localB->n_size_idx_1] = static_cast<uint8_T>(localB->c_i +
        1);
      localB->n_size_idx_1++;
    }
  }
  ...
  for (localB->c_i = 0; localB->c_i < localDW->SFunction_DIMS12; localB->c_i++)
  {
    if (localB->mask_navdata_L1_size == rtu_GpsNavBusReshaped_DIMS1->SVID) {
      ...
      DDRTCM_binary_expand_op_ol2(localB->mask_navdata_L1_data,
        &localB->mask_navdata_L1_size, rtu_GpsNavBusReshaped,
        rtu_GpsNavBusReshaped_DIMS1, localB->svid_L2C, localB->c_i);
    }
  }
  ...
  emxConvertStructToEmx_gnssops_n(&localB->r1, &localB->r3,
    rtu_GpsNavBusReshaped_DIMS1);
  DDRTCM_select_navigation_data(&localB->r1, localB->mask_navdata_L1_data,
    &localB->mask_navdata_L1_size, &localB->expl_temp, localB);
  ...
  DDRTCM_any_lnz(localB->L5_mask_data, localB->L5_mask_size,
                 localB->mask_available_SV_data, localB->gnss_freq_Matrix_size);
  localB->trueCount = localB->gnss_freq_Matrix_size[1] - 1;
  localB->n_size_idx_1 = 0;
  for (localB->c_i = 0; localB->c_i <= localB->trueCount; localB->c_i++) {
  ...
  if (localDW->SFunction_DIMS21 - 1 >= 0) {
    std::memcpy(&localB->svid_L5[0], &localB->a__1_data[0], static_cast<uint32_T>
                (localDW->SFunction_DIMS21) * sizeof(uint16_T));
  }
  ...
  for (localB->c_i = 0; localB->c_i <= localB->trueCount; localB->c_i++) {
    if (localB->L5_mask_data[localB->c_i]) {
      localB->tb_data[localB->n_size_idx_1] = static_cast<uint8_T>(localB->c_i +
        1);
      localB->n_size_idx_1++;
    }
  }
  ...
  for (localB->c_i = 0; localB->c_i <= localB->trueCount; localB->c_i++) {
    if (localB->L5_mask_data[localB->c_i]) {
      localB->ub_data[localB->n_size_idx_1] = static_cast<uint8_T>(localB->c_i +
        1);
      localB->n_size_idx_1++;
    }
  }
  ...
  for (localB->c_i = 0; localB->c_i <= localB->trueCount; localB->c_i++) {
    if (localB->L5_mask_data[localB->c_i]) {
      localB->vb_data[localB->n_size_idx_1] = static_cast<uint8_T>(localB->c_i +
        1);
      localB->n_size_idx_1++;
    }
  }
  ...
  for (localB->c_i = 0; localB->c_i <= localB->trueCount; localB->c_i++) {
    if (localB->L5_mask_data[localB->c_i]) {
      localB->wb_data[localB->n_size_idx_1] = static_cast<uint8_T>(localB->c_i +
        1);
      localB->n_size_idx_1++;
    }
  }
  ...
  for (localB->c_i = 0; localB->c_i <= localB->trueCount; localB->c_i++) {
    if (localB->L5_mask_data[localB->c_i]) {
      localB->xb_data[localB->n_size_idx_1] = static_cast<uint8_T>(localB->c_i +
        1);
      localB->n_size_idx_1++;
    }
  }
  ...
  for (localB->c_i = 0; localB->c_i <= localB->trueCount; localB->c_i++) {
    if (localB->L5_mask_data[localB->c_i]) {
      localB->yb_data[localB->n_size_idx_1] = static_cast<uint8_T>(localB->c_i +
        1);
      localB->n_size_idx_1++;
    }
  }
  ...
  for (localB->c_i = 0; localB->c_i <= localB->trueCount; localB->c_i++) {
    if (localB->L5_mask_data[localB->c_i]) {
      localB->ac_data[localB->n_size_idx_1] = static_cast<uint8_T>(localB->c_i +
        1);
      localB->n_size_idx_1++;
    }
  }
  ...
  for (localB->c_i = 0; localB->c_i < localDW->SFunction_DIMS21; localB->c_i++)
  {
    if (localB->mask_navdata_L1_size == rtu_GpsNavBusReshaped_DIMS1->SVID) {
      ...
      DDRTCM_binary_expand_op_ol2(localB->mask_navdata_L1_data,
        &localB->mask_navdata_L1_size, rtu_GpsNavBusReshaped,
        rtu_GpsNavBusReshaped_DIMS1, localB->svid_L5, localB->c_i);
    }
  }
  ...
  emxConvertStructToEmx_gnssops_n(&localB->r2, &localB->r3,
    rtu_GpsNavBusReshaped_DIMS1);
  DDRTCM_select_navigation_data(&localB->r2, localB->mask_navdata_L1_data,
    &localB->mask_navdata_L1_size, &localB->expl_temp, localB);
