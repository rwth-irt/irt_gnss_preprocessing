...
//
// File: ApplyDifferentialCorrectionMa_b.cpp
//
...
// Function for MATLAB Function: '<S117>/Apply Differential Correction Mask1'
void GNSSPreProcessingDualAntenna::GNSSPreProcessingD_do_vectors_c(const uint16_T a_data[], const int32_T *a_size, const
...
void GNSSPreProcessingDualAntenna::GNSSPrePro_binary_expand_op_pxm(real_T in1_data[], int32_T *in1_size, const
...
void GNSSPreProcessingDualAntenna::GNSSPreProc_binary_expand_op_px(real_T in1_data[], int32_T *in1_size, const
    GNSS_Measurement *in2, const int32_T in4_data[], const int32_T *in4_size, const real_T in5[40], const int32_T
    in7_data[], const int32_T *in7_size)
{
    int32_T loop_ub;
...
//    '<S117>/Apply Differential Correction Mask1'
//    '<S244>/Apply Differential Correction Mask1'
//
void GNSSPreProcessingDualAntenna::ApplyDifferentialCorrectionMa_b(const GNSS_Measurement *rtu_GpsMeasurementBus, const
    ...
    const real_T rtu_rtcm_base_position[3], boolean_T *rty_MeasurementCorrected, B_ApplyDifferentialCorrecti_g_T *localB,
    DW_ApplyDifferentialCorrect_n_T *localDW)
{
    int32_T iia_size;
    int32_T iib_size;
    ...
    *rty_MeasurementCorrected = true;
    ...
    {
        int32_T tmp;
        GNSSPreProcessingD_do_vectors_c(rtu_diffCorrAvailableSvid, rtu_diffCorrAvailableSvidS1_DIM,
        ...
        {
            GNSSPrePro_binary_expand_op_pxm(localB->tmp_data, &rtu_GpsMeasurementBus_DIMS1_idx, rtu_GpsMeasurementBus,
        ...
        {
            GNSSPreProc_binary_expand_op_px(localB->tmp_data, &rtu_GpsMeasurementBus_DIMS1_idx, rtu_GpsMeasurementBus,
                localB->iib_data, &iib_size, rtu_diffPseudorangeCorrections, localB->iia_data, &iia_size);
        }
