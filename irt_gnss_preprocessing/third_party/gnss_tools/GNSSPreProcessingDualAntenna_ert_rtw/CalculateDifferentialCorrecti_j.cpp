...
//
// File: CalculateDifferentialCorrecti_j.cpp
//
...
#include "CalculateDifferentialCorrecti_j.h"

// Function for MATLAB Function: '<S76>/Calculate Differential Corrections'
void GNSSPreProcessingDualAntenna::GNSSPreProcessingDualAn_merge_g(int32_T idx_data[], uint16_T x_data[], int32_T offset,
    int32_T np, int32_T nq, int32_T iwork_data[], uint16_T xwork_data[], B_CalculateDifferentialCorr_m_T *localB)
{
    if (nq != 0)
    {
        int32_T iout;
...
// Function for MATLAB Function: '<S76>/Calculate Differential Corrections'
void GNSSPreProcessingDualAntenna::GNSSPreProcessingDualAnt_sort_l(uint16_T x_data[], const int32_T *x_size, int32_T
    idx_data[], int32_T *idx_size, B_CalculateDifferentialCorr_m_T *localB)
{
    localB->dim = 0;
    if (*x_size != 1)
    {
            ...
            if (localB->vwork_size_idx_0 > 1)
            {
                ...
                while (localB->nLeft > 1)
                {
                    if ((static_cast<uint32_T>(localB->nLeft) & 1U) != 0U)
                    {
                        ...
                        {
                            GNSSPreProcessingDualAn_merge_g(localB->b_idx_data, localB->b_x_data, localB->i1_b,
                    ...
                    for (localB->i1_b = 0; localB->i1_b < localB->nLeft; localB->i1_b++)
                    {
                        GNSSPreProcessingDualAn_merge_g(localB->b_idx_data, localB->b_x_data, localB->i1_b * localB->b_i,
                ...
                {
                    GNSSPreProcessingDualAn_merge_g(localB->b_idx_data, localB->b_x_data, 0, localB->nDone,
...
// Function for MATLAB Function: '<S76>/Calculate Differential Corrections'
void GNSSPreProcessingDualAntenna::GNSSPreProcessingD_do_vectors_f(const uint16_T a_data[], const int32_T *a_size, const
...
void GNSSPreProcessingDualAntenna::GNSS_binary_expand_op_a5nemerfj(real_T in1_data[], int32_T in1_size[2], const real_T
...
void GNSSPreProcessingDualAntenna::GNSSPreProcessingDualA_minus_ey(real_T in1_data[], int32_T in1_size[2], const real_T
...
real_T GNSSPreProcessingDualAntenna::GNSSPreProcessing_rt_powd_snf_m(real_T u0, real_T u1,
...
void GNSSPreProcessingDualAntenna::GNSSP_binary_expand_op_a5nemerf(real_T in1_data[], int32_T in1_size[2], const real_T
    in2_data[], const int32_T in2_size[2], const real_T in3_data[], const int32_T in3_size[2], const real_T in4_data[],
    const int32_T in4_size[2], B_CalculateDifferentialCorr_m_T *localB)
{
...
void GNSSPreProcessingDualAntenna::GNSSPr_binary_expand_op_a5nemer(real_T in1_data[], int32_T in1_size[2], const real_T
    in2_data[], const int32_T in2_size[2], const real_T in3_data[], const int32_T in3_size[2],
    B_CalculateDifferentialCorr_m_T *localB)
{
    in1_size[0] = 1;
...
// Function for MATLAB Function: '<S76>/Calculate Differential Corrections'
boolean_T GNSSPreProcessingDualAntenna::GNSSPreProcessingDualAnte_any_m(const boolean_T x_data[], const int32_T x_size[2],
    B_CalculateDifferentialCorr_m_T *localB)
{
    boolean_T exitg1;
    boolean_T y;
...
void GNSSPreProcessingDualAntenna::GNSSPreProc_binary_expand_op_a5(real_T in1_data[], int32_T in1_size[2], const real_T
    in2_data[], const int32_T in2_size[2], const real_T in3_data[], const int32_T in3_size[2],
    B_CalculateDifferentialCorr_m_T *localB)
{
...
void GNSSPreProcessingDualAntenna::GNSSPreProcessingDualAn_minus_e(real_T in1_data[], int32_T in1_size[2], const real_T
    in2_data[], const int32_T in2_size[2], B_CalculateDifferentialCorr_m_T *localB)
{
...
void GNSSPreProcessingDualAntenna::GNSSPre_binary_expand_op_a5neme(real_T in1_data[], int32_T in1_size[2], const
    ...
    in7_size[2], B_CalculateDifferentialCorr_m_T *localB)
{
    int32_T in2_size_idx_1;
    int32_T loop_ub;
    int32_T stride_6_1;
...
// Function for MATLAB Function: '<S76>/Calculate Differential Corrections'
void GNSSPreProcessingDualAntenna::correct_Gps_Time_At_Week_Cros_l(real_T b_time_data[], int32_T b_time_size[2])
{
    int32_T loop_ub;
    b_time_size[0] = 1;
...
void GNSSPreProcessingDualAntenna::GNSSPreProcessingDualAnt_plus_l(real_T in1_data[], int32_T in1_size[2], const real_T
    in2_data[], const int32_T in2_size[2], B_CalculateDifferentialCorr_m_T *localB)
{
...
void GNSSPreProcessingDualAntenna::GNSSPreProc_binary_expand_op_pn(real_T in1_data[], int32_T in1_size[2], const real_T
    in2_data[], const int32_T in2_size[2], const real_T in3_data[], const int32_T in3_size[2], const real_T in4_data[],
    const int32_T in4_size[2], B_CalculateDifferentialCorr_m_T *localB)
{
    in1_size[0] = 1;
...
void GNSSPreProcessingDualAntenna::GNSSPrePro_binary_expand_op_lco(real_T in1_data[], int32_T in1_size[2], const real_T
    in2_data[], const int32_T in2_size[2], const real_T in3_data[], const int32_T in3_size[2],
    B_CalculateDifferentialCorr_m_T *localB)
{
...
// Function for MATLAB Function: '<S76>/Calculate Differential Corrections'
void GNSSPreProcessingDualAntenna::Get_Kepler_Eccentric_Anomaly_f(const real_T t_k_data[], const int32_T t_k_size[2],
    ...
    real_T E_k_Dot_data[], int32_T E_k_Dot_size[2], B_CalculateDifferentialCorr_m_T *localB)
{
    __m128d tmp;
    __m128d tmp_0;
    E_k_Dot_size[0] = 1;
    ...
    for (localB->varargin_1_tmp = 0; localB->varargin_1_tmp < localB->loop_ub_e; localB->varargin_1_tmp++)
    {
        ...
        E_k_Dot_data[localB->varargin_1_tmp] = 3.986005E+14 / GNSSPreProcessing_rt_powd_snf_m(localB->varargin_1_m *
    ...
    {
        GNSSPreProcessingDualAnt_plus_l(E_k_Dot_data, E_k_Dot_size, Ephemeris_DELTA_N_data, Ephemeris_DELTA_N_size,
            localB);
    }
    ...
    {
        GNSSPreProc_binary_expand_op_pn(localB->M_k_data, localB->M_k_size, Ephemeris_M_0_data, Ephemeris_M_0_size,
    ...
    {
        GNSSPr_binary_expand_op_a5nemer(E_k_data, E_k_size, Ephemeris_E_data, Ephemeris_E_size, localB->M_k_data,
    ...
    do
    {
        ...
        if (GNSSPreProcessingDualAnte_any_m(localB->eps_data_i, localB->eps_size, localB) && (localB->i_p < 20))
        {
            ...
            {
                GNSSPreProc_binary_expand_op_a5(E_k_data, E_k_size, localB->M_k_data, localB->M_k_size, Ephemeris_E_data,
            ...
            {
                GNSSPreProcessingDualAn_minus_e(localB->E_k_old_data_d, localB->E_k_old_size_c, E_k_data, E_k_size,
                    localB);
            }
    ...
    {
        GNSSPrePro_binary_expand_op_lco(E_k_Dot_data, E_k_Dot_size, Ephemeris_E_data, Ephemeris_E_size, localB->M_k_data,
            localB->M_k_size, localB);
    }
}

// Function for MATLAB Function: '<S76>/Calculate Differential Corrections'
void GNSSPreProcessingDualAntenna::GNSSPreProcessingDualAnte_cos_e(real_T x_data[], const int32_T x_size[2])
{
    int32_T b;
    b = x_size[1];
...
// Function for MATLAB Function: '<S76>/Calculate Differential Corrections'
void GNSSPreProcessingDualAntenna::GNSSPreProcessingDualAnte_sin_m(real_T x_data[], const int32_T x_size[2])
{
    int32_T b;
    b = x_size[1];
    for (int32_T k{0}; k < b; k++)
...
void GNSSPreProcessingDualAntenna::GNSSPreProcessingDualA_times_jg(real_T in1_data[], int32_T in1_size[2], const real_T
    in2_data[], const int32_T in2_size[2], const real_T in3_data[], const int32_T in3_size[2])
{
    int32_T loop_ub;
    int32_T stride_0_1;
...
// Function for MATLAB Function: '<S76>/Calculate Differential Corrections'
void GNSSPreProcessingDualAntenna::GNSSPreProcessingDualAnt_sqrt_p(real_T x_data[], const int32_T x_size[2],
    B_CalculateDifferentialCorr_m_T *localB)
{
    localB->b_f = x_size[1];
...
real_T GNSSPreProcessingDualAntenna::GNSSPreProcess_rt_atan2d_snf_pm(real_T u0, real_T u1,
    B_CalculateDifferentialCorr_m_T *localB)
{
    real_T y;
    if (std::isnan(u0) || std::isnan(u1))
...
// Function for MATLAB Function: '<S76>/Calculate Differential Corrections'
void GNSSPreProcessingDualAntenna::GNSSPreProcessin_expand_atan2_p(const real_T a_data[], const int32_T a_size[2], const
    real_T b_data[], const int32_T b_size[2], real_T c_data[], int32_T c_size[2], B_CalculateDifferentialCorr_m_T
    *localB)
{
    if (b_size[1] == 1)
    {
    ...
    if (localB->csz_idx_1 != 0)
    {
        ...
        {
            c_data[localB->k_p] = GNSSPreProcess_rt_atan2d_snf_pm(a_data[localB->d_i * localB->k_p], b_data[localB->e *
                localB->k_p], localB);
        }
    }
}
...
// Function for MATLAB Function: '<S76>/Calculate Differential Corrections'
void GNSSPreProcessingDualAntenna::GNSSPreProcessingDualAn_atan2_i(const real_T y_data[], const int32_T y_size[2], const
    real_T x_data[], const int32_T x_size[2], real_T r_data[], int32_T r_size[2], B_CalculateDifferentialCorr_m_T
    *localB)
{
    if (y_size[1] == x_size[1])
    {
        ...
        {
            r_data[localB->r_data_tmp] = GNSSPreProcess_rt_atan2d_snf_pm(y_data[localB->r_data_tmp], x_data
                [localB->r_data_tmp], localB);
        }
    }
    else
    {
        GNSSPreProcessin_expand_atan2_p(y_data, y_size, x_data, x_size, r_data, r_size, localB);
    }
}

void GNSSPreProcessingDualAntenna::GNS_binary_expand_op_a5nemerfj5(real_T in1_data[], int32_T in1_size[2], const real_T
    in2_data[], const int32_T in2_size[2], const real_T in3_data[], const int32_T in3_size[2], const real_T in4_data[],
    const int32_T in4_size[2], const real_T in5_data[], const int32_T in5_size[2], const real_T in6_data[], const
    int32_T in6_size[2], B_CalculateDifferentialCorr_m_T *localB)
{
    ...
    GNSSPreProcessingDualAn_atan2_i(localB->in2_data_o, localB->in2_size_l, localB->in5_data_b, localB->in5_size_m,
        in1_data, in1_size, localB);
}

void GNSSPreProcessingDualAntenna::GNSSPreProc_binary_expand_op_m4(real_T in1_data[], int32_T in1_size[2], const real_T
    in2_data[], const int32_T in2_size[2], const real_T in3_data[], const int32_T in3_size[2], const real_T in4_data[],
    const int32_T in4_size[2], const real_T in5_data[], const int32_T in5_size[2], const real_T in6_data[], const
    int32_T in6_size[2], const real_T in7_data[], const int32_T in7_size[2], B_CalculateDifferentialCorr_m_T *localB)
{
    localB->in2_size[0] = 1;
    ...
    GNSSPreProcessingDualAn_atan2_i(localB->in2_data_d, localB->in2_size, localB->in5_data, localB->in5_size,
...
void GNSSPreProcessingDualAntenna::GNSSPreProc_binary_expand_op_pc(real_T in1_data[], int32_T in1_size[2], const real_T
    in2_data[], const int32_T in2_size[2], const real_T in3_data[], const int32_T in3_size[2], const real_T in4_data[],
    const int32_T in4_size[2], const real_T in5_data[], const int32_T in5_size[2], B_CalculateDifferentialCorr_m_T
    *localB)
{
...
void GNSSPreProcessingDualAntenna::GNSSPreProc_binary_expand_op_n4(real_T in1_data[], int32_T in1_size[2], const real_T
    in2_data[], const int32_T in2_size[2], const real_T in3_data[], const int32_T in3_size[2], const real_T in4_data[],
    const int32_T in4_size[2], const real_T in5_data[], const int32_T in5_size[2], const real_T in6_data[], const
    int32_T in6_size[2], const real_T in7_data[], const int32_T in7_size[2], B_CalculateDifferentialCorr_m_T *localB)
{
...
void GNSSPreProcessingDualAntenna::GNSSPreProc_binary_expand_op_en(real_T in1_data[], int32_T in1_size[2], const real_T
    in2_data[], const int32_T in2_size[2], const real_T in3_data[], const int32_T in3_size[2], const real_T in4_data[],
    const int32_T in4_size[2], const real_T in5_data[], const int32_T in5_size[2], const real_T in6_data[], const
...
void GNSSPreProcessingDualAntenna::GNSSPrePro_binary_expand_op_lrv(real_T in1_data[], int32_T in1_size[2], const real_T
    in2_data[], const int32_T in2_size[2], const real_T in3_data[], const int32_T in3_size[2], const real_T in4_data[],
    const int32_T in4_size[2], B_CalculateDifferentialCorr_m_T *localB)
{
...
void GNSSPreProcessingDualAntenna::GNSSPreProcessingDual_times_jgg(real_T in1_data[], int32_T in1_size[2], const real_T
    in2_data[], const int32_T in2_size[2], B_CalculateDifferentialCorr_m_T *localB)
{
...
void GNSSPreProcessingDualAntenna::GNSSPreProc_binary_expand_op_lr(real_T in1_data[], const real_T in2_data[], const
...
void GNSSPreProcessingDualAntenna::GNSSPreProc_binary_expand_op_ow(real_T in1_data[], const int32_T in1_size[2], const
...
void GNSSPreProcessingDualAntenna::GNSSPreProc_binary_expand_op_a4(real_T in1_data[], int32_T in1_size[2], const real_T
    in2_data[], const int32_T in2_size[2], const real_T in3_data[], const int32_T in3_size[2],
    B_CalculateDifferentialCorr_m_T *localB)
{
...
void GNSSPreProcessingDualAntenna::GNSSPreProc_binary_expand_op_kh(real_T in1_data[], int32_T in1_size[2], const real_T
    in2_data[], const int32_T in2_size[2], const real_T in3_data[], const int32_T in3_size[2], const real_T in4_data[],
    const int32_T in4_size[2], const real_T in5_data[], const int32_T in5_size[2], const real_T in6_data[], const
    int32_T in6_size[2])
{
...
void GNSSPreProcessingDualAntenna::GNSSPreProc_binary_expand_op_pj(real_T in1_data[], int32_T in1_size[2], const real_T
    in2_data[], const int32_T in2_size[2], const real_T in3_data[], const int32_T in3_size[2], const real_T in4_data[],
    const int32_T in4_size[2], const real_T in5_data[], const int32_T in5_size[2], const real_T in6_data[], const
    int32_T in6_size[2], const real_T in7_data[], const int32_T in7_size[2], const real_T in8_data[], const int32_T
...
void GNSSPreProcessingDualAntenna::GNSSPreProc_binary_expand_op_lc(real_T in1_data[], int32_T in1_size[2], const real_T
    in2_data[], const int32_T in2_size[2], const real_T in3_data[], const int32_T in3_size[2], const real_T in4_data[],
    const int32_T in4_size[2], const real_T in5_data[], const int32_T in5_size[2], const real_T in6_data[], const
    int32_T in6_size[2], B_CalculateDifferentialCorr_m_T *localB)
{
...
void GNSSPreProcessingDualAntenna::GNSSPreProc_binary_expand_op_jt(real_T in1_data[], int32_T in1_size[2], const real_T
    in2_data[], const int32_T in2_size[2], const real_T in3_data[], const int32_T in3_size[2], const real_T in4_data[],
    const int32_T in4_size[2], B_CalculateDifferentialCorr_m_T *localB)
{
...
void GNSSPreProcessingDualAntenna::binary_expand_o_a5nemerfj5uawqf(real_T in1_data[], int32_T in1_size[2], const real_T
    in2_data[], const int32_T in2_size[2], const real_T in3_data[], const int32_T in3_size[2], const real_T in4_data[],
    const int32_T in4_size[2], B_CalculateDifferentialCorr_m_T *localB)
{
...
void GNSSPreProcessingDualAntenna::GNSSPreProcessingDualAn_times_j(real_T in1_data[], int32_T in1_size[2], const real_T
    in2_data[], const int32_T in2_size[2], B_CalculateDifferentialCorr_m_T *localB)
{
...
void GNSSPreProcessingDualAntenna::binary_expand_op_a5nemerfj5uawq(real_T in1_data[], const real_T in2_data[], const
    int32_T in2_size[2], const real_T in3_data[], const int32_T in3_size[2], const real_T in4_data[], const int32_T
...
void GNSSPreProcessingDualAntenna::binary_expand_op_a5nemerfj5uaw(real_T in1_data[], const int32_T in1_size[2], const
    real_T in2_data[], const int32_T in2_size[2], const real_T in3_data[], const int32_T in3_size[2], const real_T
    ...
    int32_T in8_size[2], const real_T in9_data[], const int32_T in9_size[2], B_CalculateDifferentialCorr_m_T *localB)
{
...
void GNSSPreProcessingDualAntenna::G_binary_expand_op_a5nemerfj5ua(real_T in1_data[], const int32_T in1_size[2], const
    real_T in2_data[], const int32_T in2_size[2], const real_T in3_data[], const int32_T in3_size[2], const real_T
    in4_data[], const int32_T in4_size[2], const real_T in5_data[], const int32_T in5_size[2])
{
    int32_T in1_idx_0;
...
// Function for MATLAB Function: '<S76>/Calculate Differential Corrections'
void GNSSPreProcessingDualAntenna::GNSSPreProcessingDualAn_sqrt_pb(real_T x_data[], const int32_T *x_size,
    B_CalculateDifferentialCorr_m_T *localB)
{
    localB->b_k = *x_size;
...
// Function for MATLAB Function: '<S76>/Calculate Differential Corrections'
void GNSSPreProcessingDualAntenna::Get_Kepler_Satellite_Position_h(const real_T Ephemeris_C_rs_data[], const int32_T
    ...
    B_CalculateDifferentialCorr_m_T *localB)
{
    ...
    {
        GNSSPreProcessingDualA_minus_ey(localB->t_k_data_l, localB->t_k_size_g, T_emission_data, T_emission_size,
            Ephemeris_T_oe_data, Ephemeris_T_oe_size);
    }

    correct_Gps_Time_At_Week_Cros_l(localB->t_k_data_l, localB->t_k_size_g);
    Get_Kepler_Eccentric_Anomaly_f(localB->t_k_data_l, localB->t_k_size_g, Ephemeris_DELTA_N_data,
    ...
    GNSSPreProcessingDualAnte_cos_e(localB->cosinus_E_k_data, localB->cosinus_E_k_size);
    GNSSPreProcessingDualAnte_sin_m(localB->sinus_E_k_data, localB->sinus_E_k_size);
    ...
    {
        GNSSPreProcessingDualA_times_jg(localB->r_k_Dot_data, localB->r_k_Dot_size, Ephemeris_E_data, Ephemeris_E_size,
    ...
    GNSSPreProcessingDualAnt_sqrt_p(localB->f_data, localB->f_size, localB);
    ...
    {
        GNS_binary_expand_op_a5nemerfj5(localB->tmp_data, localB->tmp_size, localB->f_data, localB->f_size,
             ...
             localB->r_k_Dot_size[1]) && (localB->tmp_size[1] == Ephemeris_omega_size[1]))
    {
        ...
        GNSSPreProcessingDualAn_atan2_i(localB->PHI_k_data, localB->PHI_k_size, localB->f_data, localB->f_size,
    ...
    {
        GNSSPreProc_binary_expand_op_m4(localB->PHI_k_data, localB->PHI_k_size, localB->f_data, localB->f_size,
            localB->sinus_E_k_data, localB->sinus_E_k_size, localB->y_tmp_data, localB->y_tmp_size,
    ...
    GNSSPreProcessingDualAnte_sin_m(localB->sin2PHI_k_data, localB->sin2PHI_k_size);
    ...
    GNSSPreProcessingDualAnte_cos_e(localB->cos2PHI_k_data, localB->cos2PHI_k_size);
    ...
    {
        GNSSPreProc_binary_expand_op_pc(localB->PHI_k_data, localB->PHI_k_size, Ephemeris_C_us_data, Ephemeris_C_us_size,
    ...
    {
        GNSSPreProc_binary_expand_op_n4(localB->r_k_data, localB->r_k_size, Ephemeris_SQRT_A_data, Ephemeris_SQRT_A_size,
    ...
    {
        GNSSPreProc_binary_expand_op_en(localB->i_k_data, localB->i_k_size, Ephemeris_I_0_data, Ephemeris_I_0_size,
    ...
    {
        GNSSPrePro_binary_expand_op_lrv(localB->t_k_data_l, localB->t_k_size_g, Ephemeris_OMEGA_0_data,
    ...
    GNSSPreProcessingDualAnte_cos_e(localB->cosinus_u_k_data, localB->cosinus_u_k_size);
    GNSSPreProcessingDualAnte_sin_m(localB->PHI_k_data, localB->PHI_k_size);
    ...
    GNSSPreProcessingDualAnte_cos_e(localB->cosinus_i_k_data, localB->cosinus_i_k_size);
    GNSSPreProcessingDualAnte_sin_m(localB->i_k_data, localB->i_k_size);
    ...
    GNSSPreProcessingDualAnte_sin_m(localB->sinus_lambda_k_data, localB->sinus_lambda_k_size);
    GNSSPreProcessingDualAnte_cos_e(localB->t_k_data_l, localB->t_k_size_g);
    ...
    {
        GNSSPreProcessingDualA_times_jg(localB->X_k_tmp_data, localB->X_k_tmp_size, localB->r_k_data, localB->r_k_size,
    ...
    {
        GNSSPreProcessingDual_times_jgg(localB->r_k_data, localB->r_k_size, localB->PHI_k_data, localB->PHI_k_size,
            localB);
    }
    ...
    {
        GNSSPreProcessingDualA_times_jg(localB->c_data, localB->c_size, localB->r_k_data, localB->r_k_size,
    ...
    {
        GNSSPreProc_binary_expand_op_lr(sv_pos_data, localB->X_k_tmp_data, localB->X_k_tmp_size, localB->t_k_data_l,
    ...
    {
        GNSSPreProc_binary_expand_op_ow(sv_pos_data, sv_pos_size, localB->X_k_tmp_data, localB->X_k_tmp_size,
    ...
    {
        GNSSPreProcessingDualA_times_jg(localB->d_data, localB->d_size, localB->r_k_data, localB->r_k_size,
    ...
    GNSSPreProcessingDualAnt_sqrt_p(localB->PHI_k_Dot_data, localB->PHI_k_Dot_size, localB);
    ...
    {
        GNSSPreProc_binary_expand_op_a4(localB->PHI_k_Dot_data, localB->PHI_k_Dot_size, localB->E_k_Dot_data,
    ...
    {
        GNSSPreProc_binary_expand_op_kh(localB->cosinus_E_k_data, localB->cosinus_E_k_size, Ephemeris_C_us_data,
    ...
    {
        GNSSPreProc_binary_expand_op_pj(localB->r_k_Dot_data, localB->r_k_Dot_size, Ephemeris_C_rs_data,
    ...
    {
        GNSSPreProc_binary_expand_op_lc(localB->cos2PHI_k_data, localB->cos2PHI_k_size, Ephemeris_C_is_data,
    ...
    {
        GNSSPreProc_binary_expand_op_jt(localB->cosinus_u_k_data, localB->cosinus_u_k_size, localB->r_k_Dot_data,
    ...
    {
        binary_expand_o_a5nemerfj5uawqf(localB->r_k_Dot_data, localB->r_k_Dot_size, localB->PHI_k_data,
    ...
    {
        GNSSPreProcessingDualAn_times_j(localB->cosinus_i_k_data, localB->cosinus_i_k_size, localB->r_k_Dot_data,
    ...
    {
        binary_expand_op_a5nemerfj5uawq(sv_vel_data, localB->cosinus_u_k_data, localB->cosinus_u_k_size,
    ...
    {
        binary_expand_op_a5nemerfj5uaw(sv_vel_data, sv_vel_size, localB->cosinus_u_k_data, localB->cosinus_u_k_size,
    ...
    {
        G_binary_expand_op_a5nemerfj5ua(sv_vel_data, sv_vel_size, localB->r_k_Dot_data, localB->r_k_Dot_size,
    ...
    GNSSPreProcessingDualAn_sqrt_pb(localB->t_k_data_l, &localB->transport_angle_size, localB);
...
void GNSSPreProcessingDualAntenna::GNSSPreP_binary_expand_op_a5nem(const gnssops_navigation_data *in1, const real_T
    ...
    in12_size[2], real_T in13_data[], int32_T in13_size[2], B_CalculateDifferentialCorr_m_T *localB)
{
    localB->in1_size[0] = 1;
    ...
    Get_Kepler_Satellite_Position_h(localB->in1_data_c, localB->in1_size, in4_data, in4_size, in5_data, in5_size,
...
void GNSSPreProcessingDualAntenna::GNSSPrePr_binary_expand_op_a5ne(real_T in1_data[], int32_T *in1_size, const real_T
...
void GNSSPreProcessingDualAntenna::GNSSPrePro_binary_expand_op_a5n(real_T in1_data[], int32_T *in1_size, const real_T
    in2_data[], const int32_T in2_size[2], B_CalculateDifferentialCorr_m_T *localB)
{
...
//    '<S76>/Calculate Differential Corrections'
//    '<S203>/Calculate Differential Corrections'
//
void GNSSPreProcessingDualAntenna::CalculateDifferentialCor_p_Init(DW_CalculateDifferentialCor_c_T *localDW)
{
...
//    '<S203>/Calculate Differential Corrections'
//
void GNSSPreProcessingDualAntenna::CalculateDifferentialCorrecti_j(const GNSS_Measurement *rtu_GalMeasurementB, const
    GNSS_Measurement_size *rtu_GalMeasurementB_DIMS1, const gnssops_navigation_data *rtu_gpsNavDataBusL1, const
    ...
    B_CalculateDifferentialCorr_m_T *localB, DW_CalculateDifferentialCor_c_T *localDW)
{
    ...
    if ((rtu_GalMeasurementB->time_receive > localDW->old_t) || (rtu_GalMeasurementB->time_receive - localDW->old_t <
            -100.0))
    {
        __m128d tmp_0;
        __m128d tmp_1;
        ...
        {
            std::memcpy(&localB->a_data[0], &rtu_GalMeasurementB->PRN[0], static_cast<uint32_T>(localB->vstride) *
                        sizeof(uint16_T));
        }

        GNSSPreProcessingDualAnt_sort_l(localB->a_data, &localB->a_size, localB->iidx_data, &localB->iidx_size, localB);
        localB->rtu_gpsNavDataBusL1_DIMS1 = rtu_gpsNavDataBusL1_DIMS1->SVID;
        GNSSPreProcessingD_do_vectors_f(localB->a_data, &localB->a_size, rtu_gpsNavDataBusL1->SVID,
        ...
        for (localB->k = 0; localB->k < localB->vstride; localB->k++)
        {
            localB->b_data[localB->k] = rtu_GalMeasurementB->pseudorange[localB->iidx_data[localB->k] - 1];
        }
        ...
        for (localB->k = 0; localB->k < localB->vstride; localB->k++)
        {
            localB->t_sv_emission_data[localB->k] = rtu_GalMeasurementB->time_receive - localB->b_data[localB->
        ...
        {
            GNSS_binary_expand_op_a5nemerfj(localB->t_d_data, localB->t_d_size, localB->t_sv_emission_data,
        ...
        {
            GNSSPreProcessingDualA_minus_ey(localB->t_k_data, localB->t_k_size, localB->t_sv_emission_data,
        ...
        for (localB->k = 0; localB->k < localB->vstride; localB->k++)
        {
            ...
            localB->n_0_data[localB->k] = 3.986005E+14 / GNSSPreProcessing_rt_powd_snf_m(localB->t_d * localB->t_d, 3.0,
                localB);
        }
        ...
        {
            GNSSP_binary_expand_op_a5nemerf(localB->n_0_data, localB->n_0_size, localB->navdata_M_0_data,
        ...
        {
            GNSSPr_binary_expand_op_a5nemer(localB->E_k_data, localB->E_k_size, localB->navdata_E_data,
        ...
        do
        {
            ...
            if (GNSSPreProcessingDualAnte_any_m(localB->t_k_data_n, localB->t_k_size_j, localB) && (localB->i < 20))
            {
                ...
                {
                    GNSSPreProc_binary_expand_op_a5(localB->E_k_data, localB->E_k_size, localB->n_0_data,
                ...
                {
                    GNSSPreProcessingDualAn_minus_e(localB->E_k_old_data, localB->E_k_old_size, localB->E_k_data,
        ...
        {
            GNSSPre_binary_expand_op_a5neme(localB->t_d_data, localB->t_d_size, rtu_gpsNavDataBusL1,
        ...
        if (localB->iia_size == localB->t_d_size[1])
        {
            ...
            Get_Kepler_Satellite_Position_h(localB->E_k_data, localB->E_k_size, localB->navdata_DELTA_N_data,
        ...
        {
            GNSSPreP_binary_expand_op_a5nem(rtu_gpsNavDataBusL1, localB->real_range_data, &localB->real_range_size,
        ...
        {
            GNSSPrePr_binary_expand_op_a5ne(localDW->delta_pr2.data, &localDW->delta_pr2.size, localB->b_data,
        ...
        {
            GNSSPrePro_binary_expand_op_a5n(localDW->delta_pr2.data, &localDW->delta_pr2.size, localB->t_d_data,
