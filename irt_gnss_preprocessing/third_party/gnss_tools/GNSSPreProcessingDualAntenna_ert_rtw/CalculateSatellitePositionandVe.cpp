...
void GNSSPreProcessingDualAntenna::GNSSPreProcessingDualAn_minus_p(real_T in1_data[], int32_T in1_size[2], const real_T
...
// Function for MATLAB Function: '<S32>/Calculate Satellite Position and Velocity'
void GNSSPreProcessingDualAntenna::correct_Gps_Time_At_Week_Crosso(real_T b_time_data[], int32_T b_time_size[2])
{
    int32_T loop_ub;
    b_time_size[0] = 1;
...
real_T GNSSPreProcessingDualAntenna::GNSSPreProcessing_rt_powd_snf_n(real_T u0, real_T u1,
...
void GNSSPreProcessingDualAntenna::GNSSPreProcessingDualAnt_plus_a(real_T in1_data[], int32_T in1_size[2], const real_T
    in2_data[], const int32_T in2_size[2], B_CalculateSatellitePositiona_T *localB)
{
    ...
    {
        localB->in1_data_b[localB->i15] = in1_data[localB->i15 * localB->stride_0_1_bp] + in2_data[localB->i15 *
            localB->stride_1_1_ch];
    }
    ...
    {
        std::memcpy(&in1_data[0], &localB->in1_data_b[0], static_cast<uint32_T>(localB->in1_size_idx_1_ij) * sizeof
                    (real_T));
    }
}

void GNSSPreProcessingDualAntenna::GNSSPreProce_binary_expand_op_i(real_T in1_data[], int32_T in1_size[2], const real_T
    in2_data[], const int32_T in2_size[2], const real_T in3_data[], const int32_T in3_size[2], const real_T in4_data[],
    const int32_T in4_size[2], B_CalculateSatellitePositiona_T *localB)
{
    in1_size[0] = 1;
    ...
    localB->loop_ub_gg = (in4_size[1] == 1 ? in3_size[1] : in4_size[1]) == 1 ? in2_size[1] : in4_size[1] == 1 ?
        in3_size[1] : in4_size[1];
    for (localB->i20 = 0; localB->i20 < localB->loop_ub_gg; localB->i20++)
    {
        in1_data[localB->i20] = in3_data[localB->i20 * localB->stride_1_1_n] * in4_data[localB->i20 *
            localB->stride_2_1_o] + in2_data[localB->i20 * localB->stride_0_1_kt];
    }
}

void GNSSPreProcessingDualAntenna::GNSSPreProce_binary_expand_op_p(real_T in1_data[], int32_T in1_size[2], const real_T
    in2_data[], const int32_T in2_size[2], const real_T in3_data[], const int32_T in3_size[2],
    B_CalculateSatellitePositiona_T *localB)
{
    in1_size[0] = 1;
    ...
    localB->loop_ub_nj = (in3_size[1] == 1 ? in2_size[1] : in3_size[1]) == 1 ? in2_size[1] : in3_size[1] == 1 ?
        in2_size[1] : in3_size[1];
    for (localB->i19 = 0; localB->i19 < localB->loop_ub_nj; localB->i19++)
    {
        in1_data[localB->i19] = static_cast<real_T>(in2_data[localB->i19 * localB->stride_0_1_fx] > 0.8) *
            3.1415926535897931 + static_cast<real_T>(in2_data[localB->i19 * localB->stride_1_1_pm] <= 0.8) *
            in3_data[localB->i19 * localB->stride_2_1_p2];
    }
}

void GNSSPreProcessingDualAntenna::GNSSPreProce_binary_expand_op_f(real_T in1_data[], int32_T in1_size[2], const real_T
    in2_data[], const int32_T in2_size[2], const real_T in3_data[], const int32_T in3_size[2],
    B_CalculateSatellitePositiona_T *localB)
{
    localB->in2_size_idx_1_h = (in1_size[1] == 1 ? in3_size[1] : in1_size[1]) == 1 ? in2_size[1] : in1_size[1] == 1 ?
        in3_size[1] : in1_size[1];
    localB->stride_0_1_e = (in2_size[1] != 1);
    localB->stride_1_1_o4 = (in3_size[1] != 1);
    localB->stride_2_1_h = (in1_size[1] != 1);
    localB->loop_ub_l = (in1_size[1] == 1 ? in3_size[1] : in1_size[1]) == 1 ? in2_size[1] : in1_size[1] == 1 ? in3_size
        [1] : in1_size[1];
    for (localB->i7 = 0; localB->i7 < localB->loop_ub_l; localB->i7++)
    {
        localB->in2_data_b[localB->i7] = in2_data[localB->i7 * localB->stride_0_1_e] / (1.0 - in3_data[localB->i7 *
            localB->stride_1_1_o4] * in1_data[localB->i7 * localB->stride_2_1_h]);
    }
    ...
    {
        std::memcpy(&in1_data[0], &localB->in2_data_b[0], static_cast<uint32_T>(localB->in2_size_idx_1_h) * sizeof
                    (real_T));
    }
}

void GNSSPreProcessingDualAntenna::GNSSPreProc_binary_expand_op_lz(real_T in1_data[], int32_T in1_size[2], const real_T
    in2_data[], const int32_T in2_size[2], const real_T in3_data[], const int32_T in3_size[2],
    B_CalculateSatellitePositiona_T *localB)
{
    ...
    localB->loop_ub_o = (in1_size[1] == 1 ? in3_size[1] : in1_size[1]) == 1 ? in2_size[1] : in1_size[1] == 1 ? in3_size
        [1] : in1_size[1];
    for (localB->i1 = 0; localB->i1 < localB->loop_ub_o; localB->i1++)
    {
        localB->in2_data[localB->i1] = in3_data[localB->i1 * localB->stride_1_1] * in1_data[localB->i1 *
            localB->stride_2_1] + in2_data[localB->i1 * localB->stride_0_1];
    }
...
void GNSSPreProcessingDualAntenna::GNSSPreProcessingDualA_minus_pv(real_T in1_data[], int32_T in1_size[2], const real_T
    in2_data[], const int32_T in2_size[2], B_CalculateSatellitePositiona_T *localB)
{
    ...
    {
        localB->in2_data_p[localB->i8] = in2_data[localB->i8 * localB->stride_0_1_me] - in1_data[localB->i8 *
            localB->stride_1_1_m];
    }
    ...
    {
        std::memcpy(&in1_data[0], &localB->in2_data_p[0], static_cast<uint32_T>(localB->in2_size_idx_1_c) * sizeof
                    (real_T));
    }
}

// Function for MATLAB Function: '<S32>/Calculate Satellite Position and Velocity'
void GNSSPreProcessingDualAntenna::GN_Get_Kepler_Eccentric_Anomaly(const real_T t_k_data[], const int32_T t_k_size[2],
    ...
    real_T E_k_Dot_data[], int32_T E_k_Dot_size[2], B_CalculateSatellitePositiona_T *localB)
{
    __m128d tmp;
    __m128d tmp_0;
    localB->n_0_size[0] = 1;
    ...
    for (localB->varargin_1_tmp = 0; localB->varargin_1_tmp < localB->loop_ub_i; localB->varargin_1_tmp++)
    {
        localB->varargin_1_a = Ephemeris_SQRT_A_data[localB->varargin_1_tmp];
        localB->n_0_data[localB->varargin_1_tmp] = 3.986005E+14 / GNSSPreProcessing_rt_powd_snf_n(localB->varargin_1_a *
            localB->varargin_1_a, 3.0, localB);
    }

    localB->i_a = Ephemeris_SQRT_A_size[1];
    localB->scalarLB_l = (Ephemeris_SQRT_A_size[1] / 2) << 1;
    localB->vectorUB_o = localB->scalarLB_l - 2;
    for (localB->loop_ub_i = 0; localB->loop_ub_i <= localB->vectorUB_o; localB->loop_ub_i += 2)
    {
        tmp_0 = _mm_loadu_pd(&localB->n_0_data[localB->loop_ub_i]);
        _mm_storeu_pd(&localB->n_0_data[localB->loop_ub_i], _mm_sqrt_pd(tmp_0));
    }

    for (localB->loop_ub_i = localB->scalarLB_l; localB->loop_ub_i < localB->i_a; localB->loop_ub_i++)
    {
        localB->n_0_data[localB->loop_ub_i] = std::sqrt(localB->n_0_data[localB->loop_ub_i]);
    }
    ...
    if (Ephemeris_SQRT_A_size[1] == Ephemeris_DELTA_N_size[1])
    {
        ...
        localB->scalarLB_l = (Ephemeris_SQRT_A_size[1] / 2) << 1;
        localB->vectorUB_o = localB->scalarLB_l - 2;
        for (localB->varargin_1_tmp = 0; localB->varargin_1_tmp <= localB->vectorUB_o; localB->varargin_1_tmp += 2)
        {
            tmp_0 = _mm_loadu_pd(&localB->n_0_data[localB->varargin_1_tmp]);
            _mm_storeu_pd(&localB->n_0_data[localB->varargin_1_tmp], _mm_add_pd(tmp_0, _mm_loadu_pd
                           (&Ephemeris_DELTA_N_data[localB->varargin_1_tmp])));
        }

        for (localB->varargin_1_tmp = localB->scalarLB_l; localB->varargin_1_tmp <= localB->loop_ub_i;
                localB->varargin_1_tmp++)
        {
            localB->n_0_data[localB->varargin_1_tmp] += Ephemeris_DELTA_N_data[localB->varargin_1_tmp];
        }
    }
    else
    {
        GNSSPreProcessingDualAnt_plus_a(localB->n_0_data, localB->n_0_size, Ephemeris_DELTA_N_data,
            Ephemeris_DELTA_N_size, localB);
    }

    if ((localB->n_0_size[1] == t_k_size[1]) && ((localB->n_0_size[1] == 1 ? t_k_size[1] : localB->n_0_size[1]) ==
            Ephemeris_M_0_size[1]))
    {
        ...
        for (localB->varargin_1_tmp = localB->scalarLB_l; localB->varargin_1_tmp < localB->loop_ub_i;
                localB->varargin_1_tmp++)
        {
            localB->M_k_data[localB->varargin_1_tmp] = localB->n_0_data[localB->varargin_1_tmp] * t_k_data
                [localB->varargin_1_tmp] + Ephemeris_M_0_data[localB->varargin_1_tmp];
        }
    }
    else
    {
        GNSSPreProce_binary_expand_op_i(localB->M_k_data, localB->M_k_size, Ephemeris_M_0_data, Ephemeris_M_0_size,
            localB->n_0_data, localB->n_0_size, t_k_data, t_k_size, localB);
    }
            ...
            Ephemeris_E_size[1]) == Ephemeris_E_size[1]))
    {
        ...
        for (localB->varargin_1_tmp = 0; localB->varargin_1_tmp < localB->loop_ub_i; localB->varargin_1_tmp++)
        {
            ...
            E_k_data[localB->varargin_1_tmp] = static_cast<real_T>(localB->varargin_1_a > 0.8) * 3.1415926535897931 +
                static_cast<real_T>(localB->varargin_1_a <= 0.8) * localB->M_k_data[localB->varargin_1_tmp];
        }
    }
    else
    {
        GNSSPreProce_binary_expand_op_p(E_k_data, E_k_size, Ephemeris_E_data, Ephemeris_E_size, localB->M_k_data,
    ...
    do
    {
        ...
        {
            localB->x_data[localB->varargin_1_tmp] = (localB->eps_data[localB->varargin_1_tmp] > 1.0E-15);
        }
        ...
        if (localB->y && (localB->i_a < 20))
        {
            ...
            {
                std::memcpy(&localB->E_k_old_data[0], &E_k_data[0], static_cast<uint32_T>(localB->loop_ub_i) * sizeof
                            (real_T));
            }

            localB->scalarLB_l = E_k_size[1];
            for (localB->vectorUB_o = 0; localB->vectorUB_o < localB->scalarLB_l; localB->vectorUB_o++)
            {
                 ...
                 localB->M_k_size[1]))
            {
                ...
                localB->vectorUB_o = localB->scalarLB_l - 2;
                for (localB->varargin_1_tmp = 0; localB->varargin_1_tmp <= localB->vectorUB_o; localB->varargin_1_tmp +=
                     2)
                {
            ...
            {
                GNSSPreProc_binary_expand_op_lz(E_k_data, E_k_size, localB->M_k_data, localB->M_k_size, Ephemeris_E_data,
            ...
            if (E_k_size[1] == localB->E_k_old_size[1])
            {
                     ...
                     2)
                {
                    ...
                    _mm_storeu_pd(&localB->E_k_old_data[localB->varargin_1_tmp], _mm_sub_pd(tmp_0, tmp));
                }

                for (localB->varargin_1_tmp = localB->scalarLB_l; localB->varargin_1_tmp <= localB->loop_ub_i;
                        localB->varargin_1_tmp++)
                {
                    localB->E_k_old_data[localB->varargin_1_tmp] = E_k_data[localB->varargin_1_tmp] -
                        localB->E_k_old_data[localB->varargin_1_tmp];
                }
            }
            else
            {
                GNSSPreProcessingDualA_minus_pv(localB->E_k_old_data, localB->E_k_old_size, E_k_data, E_k_size, localB);
            }
            ...
            for (localB->vectorUB_o = 0; localB->vectorUB_o < localB->scalarLB_l; localB->vectorUB_o++)
            {
                localB->eps_data[localB->vectorUB_o] = std::abs(localB->E_k_old_data[localB->vectorUB_o]);
            }
    ...
    if (localB->loop_ub_i - 1 >= 0)
    {
        std::memcpy(&E_k_Dot_data[0], &E_k_data[0], static_cast<uint32_T>(localB->loop_ub_i) * sizeof(real_T));
    }

    localB->i_a = E_k_size[1];
    for (localB->scalarLB_l = 0; localB->scalarLB_l < localB->i_a; localB->scalarLB_l++)
    {
            ...
            localB->n_0_size[1]))
    {
        ...
        for (localB->varargin_1_tmp = localB->scalarLB_l; localB->varargin_1_tmp <= localB->loop_ub_i;
                localB->varargin_1_tmp++)
        {
            E_k_Dot_data[localB->varargin_1_tmp] = localB->n_0_data[localB->varargin_1_tmp] / (1.0 -
                Ephemeris_E_data[localB->varargin_1_tmp] * E_k_Dot_data[localB->varargin_1_tmp]);
        }
    }
    else
    {
        GNSSPreProce_binary_expand_op_f(E_k_Dot_data, E_k_Dot_size, localB->n_0_data, localB->n_0_size, Ephemeris_E_data,
            Ephemeris_E_size, localB);
    }
}

// Function for MATLAB Function: '<S32>/Calculate Satellite Position and Velocity'
void GNSSPreProcessingDualAntenna::GNSSPreProcessingDualAntenn_cos(real_T x_data[], const int32_T x_size[2])
{
    int32_T b;
    b = x_size[1];
...
// Function for MATLAB Function: '<S32>/Calculate Satellite Position and Velocity'
void GNSSPreProcessingDualAntenna::GNSSPreProcessingDualAntenn_sin(real_T x_data[], const int32_T x_size[2])
{
    int32_T b;
    b = x_size[1];
    for (int32_T k{0}; k < b; k++)
...
void GNSSPreProcessingDualAntenna::GNSSPreProcessingDualAn_times_h(real_T in1_data[], int32_T in1_size[2], const real_T
    in2_data[], const int32_T in2_size[2], const real_T in3_data[], const int32_T in3_size[2])
{
    int32_T loop_ub;
    int32_T stride_0_1;
...
// Function for MATLAB Function: '<S32>/Calculate Satellite Position and Velocity'
void GNSSPreProcessingDualAntenna::GNSSPreProcessingDualAnten_sqrt(real_T x_data[], const int32_T x_size[2],
    B_CalculateSatellitePositiona_T *localB)
{
    localB->b_n = x_size[1];
...
real_T GNSSPreProcessingDualAntenna::GNSSPreProcessi_rt_atan2d_snf_p(real_T u0, real_T u1,
    B_CalculateSatellitePositiona_T *localB)
{
    real_T y;
    if (std::isnan(u0) || std::isnan(u1))
...
// Function for MATLAB Function: '<S32>/Calculate Satellite Position and Velocity'
void GNSSPreProcessingDualAntenna::GNSSPreProcessingD_expand_atan2(const real_T a_data[], const int32_T a_size[2], const
    real_T b_data[], const int32_T b_size[2], real_T c_data[], int32_T c_size[2], B_CalculateSatellitePositiona_T
    *localB)
{
    if (b_size[1] == 1)
    {
    ...
    if (localB->csz_idx_1 != 0)
    {
        ...
        {
            c_data[localB->k] = GNSSPreProcessi_rt_atan2d_snf_p(a_data[localB->d_e * localB->k], b_data[localB->e *
                localB->k], localB);
        }
    }
}
...
// Function for MATLAB Function: '<S32>/Calculate Satellite Position and Velocity'
void GNSSPreProcessingDualAntenna::GNSSPreProcessingDualAnte_atan2(const real_T y_data[], const int32_T y_size[2], const
    real_T x_data[], const int32_T x_size[2], real_T r_data[], int32_T r_size[2], B_CalculateSatellitePositiona_T
    *localB)
{
    if (y_size[1] == x_size[1])
    {
        ...
        for (localB->r_data_tmp = 0; localB->r_data_tmp < localB->loop_ub_g; localB->r_data_tmp++)
        {
            r_data[localB->r_data_tmp] = GNSSPreProcessi_rt_atan2d_snf_p(y_data[localB->r_data_tmp], x_data
                [localB->r_data_tmp], localB);
        }
    }
    else
    {
        GNSSPreProcessingD_expand_atan2(y_data, y_size, x_data, x_size, r_data, r_size, localB);
    }
}

void GNSSPreProcessingDualAntenna::GNSSPreProc_binary_expand_op_hi(real_T in1_data[], int32_T in1_size[2], const real_T
    in2_data[], const int32_T in2_size[2], const real_T in3_data[], const int32_T in3_size[2], const real_T in4_data[],
    const int32_T in4_size[2], const real_T in5_data[], const int32_T in5_size[2], const real_T in6_data[], const
    int32_T in6_size[2], B_CalculateSatellitePositiona_T *localB)
{
    localB->in2_size_e[0] = 1;
    localB->in2_size_e[1] = in4_size[1] == 1 ? in3_size[1] == 1 ? in2_size[1] : in3_size[1] : in4_size[1];
    localB->stride_0_1_c = (in2_size[1] != 1);
    localB->stride_1_1_o = (in3_size[1] != 1);
    localB->stride_2_1_l = (in4_size[1] != 1);
    localB->loop_ub_m = in4_size[1] == 1 ? in3_size[1] == 1 ? in2_size[1] : in3_size[1] : in4_size[1];
    for (localB->i5 = 0; localB->i5 < localB->loop_ub_m; localB->i5++)
    {
        localB->in2_data_k[localB->i5] = in2_data[localB->i5 * localB->stride_0_1_c] * in3_data[localB->i5 *
            localB->stride_1_1_o] / in4_data[localB->i5 * localB->stride_2_1_l];
    }
    ...
    localB->stride_2_1_l = (in4_size[1] != 1);
    localB->loop_ub_m = in4_size[1] == 1 ? in6_size[1] == 1 ? in5_size[1] : in6_size[1] : in4_size[1];
    for (localB->i5 = 0; localB->i5 < localB->loop_ub_m; localB->i5++)
    {
        localB->in5_data[localB->i5] = (in5_data[localB->i5 * localB->stride_0_1_c] - in6_data[localB->i5 *
            localB->stride_1_1_o]) / in4_data[localB->i5 * localB->stride_2_1_l];
    }

    GNSSPreProcessingDualAnte_atan2(localB->in2_data_k, localB->in2_size_e, localB->in5_data, localB->in5_size, in1_data,
        in1_size, localB);
}

void GNSSPreProcessingDualAntenna::GNSSPreProce_binary_expand_op_m(real_T in1_data[], int32_T in1_size[2], const real_T
    in2_data[], const int32_T in2_size[2], const real_T in3_data[], const int32_T in3_size[2], const real_T in4_data[],
    const int32_T in4_size[2], const real_T in5_data[], const int32_T in5_size[2], const real_T in6_data[], const
    int32_T in6_size[2], B_CalculateSatellitePositiona_T *localB)
{
    ...
    localB->loop_ub_f = in4_size[1] == 1 ? in3_size[1] == 1 ? in2_size[1] : in3_size[1] : in4_size[1];
    for (localB->i2 = 0; localB->i2 < localB->loop_ub_f; localB->i2++)
    {
        localB->in2_data_m[localB->i2] = in2_data[localB->i2 * localB->stride_0_1_i] * in3_data[localB->i2 *
            localB->stride_1_1_f] / in4_data[localB->i2 * localB->stride_2_1_i];
    }

    localB->in1_size[0] = 1;
    localB->in1_size[1] = in4_size[1] == 1 ? in5_size[1] == 1 ? in1_size[1] : in5_size[1] : in4_size[1];
    localB->stride_0_1_i = (in1_size[1] != 1);
    localB->stride_1_1_f = (in5_size[1] != 1);
    localB->stride_2_1_i = (in4_size[1] != 1);
    localB->loop_ub_f = in4_size[1] == 1 ? in5_size[1] == 1 ? in1_size[1] : in5_size[1] : in4_size[1];
    for (localB->i2 = 0; localB->i2 < localB->loop_ub_f; localB->i2++)
    {
        localB->in1_data[localB->i2] = (in1_data[localB->i2 * localB->stride_0_1_i] - in5_data[localB->i2 *
            localB->stride_1_1_f]) / in4_data[localB->i2 * localB->stride_2_1_i];
    }

    GNSSPreProcessingDualAnte_atan2(localB->in2_data_m, localB->in2_size, localB->in1_data, localB->in1_size,
        localB->tmp_data_c, localB->tmp_size_a, localB);
    in1_size[0] = 1;
    ...
    for (localB->i2 = 0; localB->i2 < localB->loop_ub_f; localB->i2++)
    {
        in1_data[localB->i2] = localB->tmp_data_c[localB->i2 * localB->stride_0_1_i] + in6_data[localB->i2 *
            localB->stride_1_1_f];
    }
}

void GNSSPreProcessingDualAntenna::GNSSPreProce_binary_expand_op_l(real_T in1_data[], int32_T in1_size[2], const real_T
    in2_data[], const int32_T in2_size[2], const real_T in3_data[], const int32_T in3_size[2], const real_T in4_data[],
    const int32_T in4_size[2], const real_T in5_data[], const int32_T in5_size[2], B_CalculateSatellitePositiona_T
    *localB)
{
    localB->in1_size_idx_1 = ((in5_size[1] == 1 ? in4_size[1] : in5_size[1]) == 1 ? in3_size[1] == 1 ? in2_size[1] :
    ...
    localB->loop_ub_o3 = ((in5_size[1] == 1 ? in4_size[1] : in5_size[1]) == 1 ? in3_size[1] == 1 ? in2_size[1] :
    ...
    {
        localB->in1_data_g[localB->i11] = (in2_data[localB->i11 * localB->stride_1_1_d] * in3_data[localB->i11 *
            localB->stride_2_1_a] + in4_data[localB->i11 * localB->stride_3_1_pb] * in5_data[localB->i11 *
    ...
    {
        std::memcpy(&in1_data[0], &localB->in1_data_g[0], static_cast<uint32_T>(localB->in1_size_idx_1) * sizeof(real_T));
    }
}

void GNSSPreProcessingDualAntenna::GNSSPreProce_binary_expand_op_c(real_T in1_data[], int32_T in1_size[2], const real_T
    in2_data[], const int32_T in2_size[2], const real_T in3_data[], const int32_T in3_size[2], const real_T in4_data[],
    const int32_T in4_size[2], const real_T in5_data[], const int32_T in5_size[2], const real_T in6_data[], const
    int32_T in6_size[2], B_CalculateSatellitePositiona_T *localB)
{
    localB->tmp_size_idx_1_o = ((in6_size[1] == 1 ? in5_size[1] : in6_size[1]) == 1 ? in4_size[1] == 1 ? in3_size[1] :
        in4_size[1] : in6_size[1] == 1 ? in5_size[1] : in6_size[1]) == 1 ? in1_size[1] == 1 ? in2_size[1] : in1_size[1] :
        (in6_size[1] == 1 ? in5_size[1] : in6_size[1]) == 1 ? in4_size[1] == 1 ? in3_size[1] : in4_size[1] : in6_size[1]
        == 1 ? in5_size[1] : in6_size[1];
    ...
    localB->loop_ub_e = ((in6_size[1] == 1 ? in5_size[1] : in6_size[1]) == 1 ? in4_size[1] == 1 ? in3_size[1] :
                         in4_size[1] : in6_size[1] == 1 ? in5_size[1] : in6_size[1]) == 1 ? in1_size[1] == 1 ? in2_size
        [1] : in1_size[1] : (in6_size[1] == 1 ? in5_size[1] : in6_size[1]) == 1 ? in4_size[1] == 1 ? in3_size[1] :
        in4_size[1] : in6_size[1] == 1 ? in5_size[1] : in6_size[1];
    for (localB->i9 = 0; localB->i9 < localB->loop_ub_e; localB->i9++)
    {
        localB->varargin_1_jz = in2_data[localB->i9 * localB->stride_0_1_k];
        localB->tmp_data_cv[localB->i9] = (1.0 - in1_data[localB->i9 * localB->stride_1_1_p]) * (localB->varargin_1_jz *
            localB->varargin_1_jz) + (in3_data[localB->i9 * localB->stride_2_1_p] * in4_data[localB->i9 *
            localB->stride_3_1_p] + in5_data[localB->i9 * localB->stride_4_1_a] * in6_data[localB->i9 *
            localB->stride_5_1_j]);
    }
    ...
    {
        std::memcpy(&in1_data[0], &localB->tmp_data_cv[0], static_cast<uint32_T>(localB->tmp_size_idx_1_o) * sizeof
                    (real_T));
    }
}

void GNSSPreProcessingDualAntenna::GNSSPreProc_binary_expand_op_ap(real_T in1_data[], int32_T in1_size[2], const real_T
    in2_data[], const int32_T in2_size[2], const real_T in3_data[], const int32_T in3_size[2], const real_T in4_data[],
    const int32_T in4_size[2], const real_T in5_data[], const int32_T in5_size[2], const real_T in6_data[], const
    ...
    in8_size[2], B_CalculateSatellitePositiona_T *localB)
{
    ...
    localB->loop_ub_d = (in8_size[1] == 1 ? in7_size[1] : in8_size[1]) == 1 ? ((in6_size[1] == 1 ? in5_size[1] :
    ...
    {
        in1_data[localB->i23] = ((in3_data[localB->i23 * localB->stride_1_1_cx] * in4_data[localB->i23 *
            localB->stride_2_1_if] + in5_data[localB->i23 * localB->stride_3_1_d] * in6_data[localB->i23 *
            localB->stride_4_1_g]) + in2_data[localB->i23 * localB->stride_0_1_c3]) + in7_data[localB->i23 *
            localB->stride_5_1_l] * in8_data[localB->i23 * localB->stride_6_1_f];
    }
}

void GNSSPreProcessingDualAntenna::binary_expand_o_hiccmd4tjww0ixx(real_T in1_data[], int32_T in1_size[2], const real_T
    in2_data[], const int32_T in2_size[2], const real_T in3_data[], const int32_T in3_size[2], const real_T in4_data[],
    const int32_T in4_size[2], B_CalculateSatellitePositiona_T *localB)
{
    localB->in2_size_idx_1_p = in4_size[1] == 1 ? (in1_size[1] == 1 ? in3_size[1] : in1_size[1]) == 1 ? in2_size[1] :
    ...
    localB->loop_ub_k = in4_size[1] == 1 ? (in1_size[1] == 1 ? in3_size[1] : in1_size[1]) == 1 ? in2_size[1] : in1_size
        [1] == 1 ? in3_size[1] : in1_size[1] : in4_size[1];
    for (localB->i14 = 0; localB->i14 < localB->loop_ub_k; localB->i14++)
    {
        localB->in2_data_n[localB->i14] = (in3_data[localB->i14 * localB->stride_1_1_h] * in1_data[localB->i14 *
            localB->stride_2_1_m] + in2_data[localB->i14 * localB->stride_0_1_f]) - in4_data[localB->i14 *
    ...
    {
        std::memcpy(&in1_data[0], &localB->in2_data_n[0], static_cast<uint32_T>(localB->in2_size_idx_1_p) * sizeof
                    (real_T));
    }
}

void GNSSPreProcessingDualAntenna::GNSSPreProcessingDualA_times_hi(real_T in1_data[], int32_T in1_size[2], const real_T
    in2_data[], const int32_T in2_size[2], B_CalculateSatellitePositiona_T *localB)
{
    ...
    {
        localB->in1_data_j[localB->i18] = in1_data[localB->i18 * localB->stride_0_1_nr] * in2_data[localB->i18 *
            localB->stride_1_1_d3];
    }
    ...
    {
        std::memcpy(&in1_data[0], &localB->in1_data_j[0], static_cast<uint32_T>(localB->in1_size_idx_1_c) * sizeof
                    (real_T));
    }
}

void GNSSPreProcessingDualAntenna::binary_expand_op_hiccmd4tjww0ix(real_T in1_data[], const real_T in2_data[], const
...
void GNSSPreProcessingDualAntenna::binary_expand_op_hiccmd4tjww0i(real_T in1_data[], const int32_T in1_size[2], const
...
void GNSSPreProcessingDualAntenna::G_binary_expand_op_hiccmd4tjww0(real_T in1_data[], int32_T in1_size[2], const real_T
    in2_data[], const int32_T in2_size[2], const real_T in3_data[], const int32_T in3_size[2],
    B_CalculateSatellitePositiona_T *localB)
{
    localB->in2_size_idx_1_m = in1_size[1] == 1 ? in3_size[1] == 1 ? in2_size[1] : in3_size[1] : in1_size[1];
    localB->stride_0_1_my = (in2_size[1] != 1);
    localB->stride_1_1_j = (in3_size[1] != 1);
    localB->stride_2_1_e = (in1_size[1] != 1);
    localB->loop_ub_mv = in1_size[1] == 1 ? in3_size[1] == 1 ? in2_size[1] : in3_size[1] : in1_size[1];
    for (localB->i16 = 0; localB->i16 < localB->loop_ub_mv; localB->i16++)
    {
        localB->in2_data_pp[localB->i16] = in2_data[localB->i16 * localB->stride_0_1_my] * in3_data[localB->i16 *
            localB->stride_1_1_j] / in1_data[localB->i16 * localB->stride_2_1_e];
    }
    ...
    {
        std::memcpy(&in1_data[0], &localB->in2_data_pp[0], static_cast<uint32_T>(localB->in2_size_idx_1_m) * sizeof
                    (real_T));
    }
}

void GNSSPreProcessingDualAntenna::GN_binary_expand_op_hiccmd4tjww(real_T in1_data[], int32_T in1_size[2], const real_T
    in2_data[], const int32_T in2_size[2], const real_T in3_data[], const int32_T in3_size[2], const real_T in4_data[],
    const int32_T in4_size[2], const real_T in5_data[], const int32_T in5_size[2], const real_T in6_data[], const
    int32_T in6_size[2])
{
...
void GNSSPreProcessingDualAntenna::GNS_binary_expand_op_hiccmd4tjw(real_T in1_data[], int32_T in1_size[2], const real_T
    in2_data[], const int32_T in2_size[2], const real_T in3_data[], const int32_T in3_size[2], const real_T in4_data[],
    const int32_T in4_size[2], const real_T in5_data[], const int32_T in5_size[2], const real_T in6_data[], const
    int32_T in6_size[2], const real_T in7_data[], const int32_T in7_size[2], const real_T in8_data[], const int32_T
    in8_size[2], const real_T in9_data[], const int32_T in9_size[2], B_CalculateSatellitePositiona_T *localB)
{
    localB->tmp_size_idx_1 = (in9_size[1] == 1 ? in1_size[1] == 1 ? in8_size[1] == 1 ? in7_size[1] : in8_size[1] :
        in1_size[1] : in9_size[1]) == 1 ? in6_size[1] == 1 ? (in5_size[1] == 1 ? in4_size[1] : in5_size[1]) == 1 ?
        in3_size[1] == 1 ? in2_size[1] : in3_size[1] : in5_size[1] == 1 ? in4_size[1] : in5_size[1] : in6_size[1] :
        in9_size[1] == 1 ? in1_size[1] == 1 ? in8_size[1] == 1 ? in7_size[1] : in8_size[1] : in1_size[1] : in9_size[1];
    ...
    localB->loop_ub_p = (in9_size[1] == 1 ? in1_size[1] == 1 ? in8_size[1] == 1 ? in7_size[1] : in8_size[1] : in1_size[1]
                         : in9_size[1]) == 1 ? in6_size[1] == 1 ? (in5_size[1] == 1 ? in4_size[1] : in5_size[1]) == 1 ?
        in3_size[1] == 1 ? in2_size[1] : in3_size[1] : in5_size[1] == 1 ? in4_size[1] : in5_size[1] : in6_size[1] :
        in9_size[1] == 1 ? in1_size[1] == 1 ? in8_size[1] == 1 ? in7_size[1] : in8_size[1] : in1_size[1] : in9_size[1];
    for (localB->i6 = 0; localB->i6 < localB->loop_ub_p; localB->i6++)
    {
        localB->varargin_1_j = in7_data[localB->i6 * localB->stride_5_1];
        localB->tmp_data_cx[localB->i6] = (in2_data[localB->i6 * localB->stride_0_1_m] * in3_data[localB->i6 *
            localB->stride_1_1_c] - in4_data[localB->i6 * localB->stride_2_1_f] * in5_data[localB->i6 *
            localB->stride_3_1]) * 2.0 * in6_data[localB->i6 * localB->stride_4_1] + localB->varargin_1_j *
            localB->varargin_1_j * in8_data[localB->i6 * localB->stride_6_1] * in1_data[localB->i6 * localB->stride_7_1]
    ...
    {
        std::memcpy(&in1_data[0], &localB->tmp_data_cx[0], static_cast<uint32_T>(localB->tmp_size_idx_1) * sizeof(real_T));
    }
}

void GNSSPreProcessingDualAntenna::GNSS_binary_expand_op_hiccmd4tj(real_T in1_data[], int32_T in1_size[2], const real_T
    in2_data[], const int32_T in2_size[2], const real_T in3_data[], const int32_T in3_size[2], const real_T in4_data[],
    const int32_T in4_size[2], const real_T in5_data[], const int32_T in5_size[2], const real_T in6_data[], const
    int32_T in6_size[2], B_CalculateSatellitePositiona_T *localB)
{
    localB->tmp_size_idx_1_c = in6_size[1] == 1 ? in5_size[1] == 1 ? (in4_size[1] == 1 ? in3_size[1] : in4_size[1]) == 1
    ...
    localB->loop_ub_ei = in6_size[1] == 1 ? in5_size[1] == 1 ? (in4_size[1] == 1 ? in3_size[1] : in4_size[1]) == 1 ?
        in1_size[1] == 1 ? in2_size[1] : in1_size[1] : in4_size[1] == 1 ? in3_size[1] : in4_size[1] : in5_size[1] :
        in6_size[1];
    for (localB->i10 = 0; localB->i10 < localB->loop_ub_ei; localB->i10++)
    {
        localB->tmp_data_f[localB->i10] = (in2_data[localB->i10 * localB->stride_0_1_b] * in1_data[localB->i10 *
            localB->stride_1_1_a] - in3_data[localB->i10 * localB->stride_2_1_g] * in4_data[localB->i10 *
            localB->stride_3_1_e]) * 2.0 * in5_data[localB->i10 * localB->stride_4_1_f] + in6_data[localB->i10 *
            localB->stride_5_1_h];
    }
    ...
    {
        std::memcpy(&in1_data[0], &localB->tmp_data_f[0], static_cast<uint32_T>(localB->tmp_size_idx_1_c) * sizeof
                    (real_T));
    }
}

void GNSSPreProcessingDualAntenna::GNSSP_binary_expand_op_hiccmd4t(real_T in1_data[], int32_T in1_size[2], const real_T
    in2_data[], const int32_T in2_size[2], const real_T in3_data[], const int32_T in3_size[2], const real_T in4_data[],
    const int32_T in4_size[2], B_CalculateSatellitePositiona_T *localB)
{
    localB->in2_size_idx_1_cu = (in4_size[1] == 1 ? in3_size[1] : in4_size[1]) == 1 ? in1_size[1] == 1 ? in2_size[1] :
    ...
    localB->loop_ub_m4 = (in4_size[1] == 1 ? in3_size[1] : in4_size[1]) == 1 ? in1_size[1] == 1 ? in2_size[1] :
        in1_size[1] : in4_size[1] == 1 ? in3_size[1] : in4_size[1];
    for (localB->i13 = 0; localB->i13 < localB->loop_ub_m4; localB->i13++)
    {
        localB->in2_data_me[localB->i13] = in2_data[localB->i13 * localB->stride_0_1_o] * in1_data[localB->i13 *
            localB->stride_1_1_k] - in3_data[localB->i13 * localB->stride_2_1_ie] * in4_data[localB->i13 *
            localB->stride_3_1_o];
    }
    ...
    {
        std::memcpy(&in1_data[0], &localB->in2_data_me[0], static_cast<uint32_T>(localB->in2_size_idx_1_cu) * sizeof
                    (real_T));
    }
}

void GNSSPreProcessingDualAntenna::GNSSPr_binary_expand_op_hiccmd4(real_T in1_data[], int32_T in1_size[2], const real_T
    in2_data[], const int32_T in2_size[2], const real_T in3_data[], const int32_T in3_size[2], const real_T in4_data[],
    const int32_T in4_size[2], B_CalculateSatellitePositiona_T *localB)
{
    localB->in1_size_idx_1_i = (in4_size[1] == 1 ? in3_size[1] : in4_size[1]) == 1 ? in2_size[1] == 1 ? in1_size[1] :
    ...
    localB->loop_ub_ft = (in4_size[1] == 1 ? in3_size[1] : in4_size[1]) == 1 ? in2_size[1] == 1 ? in1_size[1] :
        in2_size[1] : in4_size[1] == 1 ? in3_size[1] : in4_size[1];
    for (localB->i12 = 0; localB->i12 < localB->loop_ub_ft; localB->i12++)
    {
        localB->in1_data_g1[localB->i12] = in1_data[localB->i12 * localB->stride_0_1_n] * in2_data[localB->i12 *
            localB->stride_1_1_l] + in3_data[localB->i12 * localB->stride_2_1_pe] * in4_data[localB->i12 *
    ...
    {
        std::memcpy(&in1_data[0], &localB->in1_data_g1[0], static_cast<uint32_T>(localB->in1_size_idx_1_i) * sizeof
                    (real_T));
    }
}

void GNSSPreProcessingDualAntenna::GNSSPreProcessingDualAnte_times(real_T in1_data[], int32_T in1_size[2], const real_T
    in2_data[], const int32_T in2_size[2], B_CalculateSatellitePositiona_T *localB)
{
    ...
    {
        localB->in2_data_l[localB->i17] = in2_data[localB->i17 * localB->stride_0_1_j] * in1_data[localB->i17 *
            localB->stride_1_1_fo];
    }
    ...
    {
        std::memcpy(&in1_data[0], &localB->in2_data_l[0], static_cast<uint32_T>(localB->in2_size_idx_1_g) * sizeof
                    (real_T));
    }
}

void GNSSPreProcessingDualAntenna::GNSSPre_binary_expand_op_hiccmd(real_T in1_data[], const real_T in2_data[], const
    int32_T in2_size[2], const real_T in3_data[], const int32_T in3_size[2], const real_T in4_data[], const int32_T
    ...
    in9_data[], const int32_T in9_size[2], B_CalculateSatellitePositiona_T *localB)
{
    ...
    {
        in1_data[localB->i22] = ((in2_data[localB->i22 * localB->stride_0_0_c] * in3_data[localB->i22 *
            localB->stride_1_0_c] - in4_data[localB->i22 * localB->stride_2_0_m] * in5_data[localB->i22 *
            localB->stride_3_0_j]) + in6_data[localB->i22 * localB->stride_4_0_k] * in5_data[localB->i22 *
            localB->stride_5_0_m] * in7_data[localB->i22 * localB->stride_6_0_p]) - in8_data[localB->i22 *
            localB->stride_7_0_d + in8_size[0]] * in9_data[localB->i22 * localB->stride_8_0_g];
    }
}

void GNSSPreProcessingDualAntenna::GNSSPreP_binary_expand_op_hiccm(real_T in1_data[], const int32_T in1_size[2], const
    real_T in2_data[], const int32_T in2_size[2], const real_T in3_data[], const int32_T in3_size[2], const real_T
    ...
    int32_T in8_size[2], const real_T in9_data[], const int32_T in9_size[2], B_CalculateSatellitePositiona_T *localB)
{
    ...
    {
        in1_data[localB->i21 + in1_size[0]] = ((in2_data[localB->i21 * localB->stride_0_0] * in3_data[localB->i21 *
            localB->stride_1_0] + in4_data[localB->i21 * localB->stride_2_0] * in5_data[localB->i21 * localB->stride_3_0])
            - in6_data[localB->i21 * localB->stride_4_0] * in5_data[localB->i21 * localB->stride_5_0] * in7_data
            [localB->i21 * localB->stride_6_0]) + in8_data[localB->i21 * localB->stride_7_0] * in9_data[localB->i21 *
            localB->stride_8_0];
    }
}

void GNSSPreProcessingDualAntenna::GNSSPrePr_binary_expand_op_hicc(real_T in1_data[], const int32_T in1_size[2], const
    real_T in2_data[], const int32_T in2_size[2], const real_T in3_data[], const int32_T in3_size[2], const real_T
    in4_data[], const int32_T in4_size[2], const real_T in5_data[], const int32_T in5_size[2])
{
    int32_T in1_idx_0;
...
// Function for MATLAB Function: '<S32>/Calculate Satellite Position and Velocity'
void GNSSPreProcessingDualAntenna::GNSSPreProcessingDualAnt_sqrt_h(real_T x_data[], const int32_T *x_size,
    B_CalculateSatellitePositiona_T *localB)
{
    localB->b = *x_size;
...
// Function for MATLAB Function: '<S32>/Calculate Satellite Position and Velocity'
void GNSSPreProcessingDualAntenna::Get_Kepler_Satellite_Position_A(const real_T Ephemeris_C_rs_data[], const int32_T
    ...
    B_CalculateSatellitePositiona_T *localB)
{
    ...
    if (T_emission_size[1] == Ephemeris_T_oe_size[1])
    {
        ...
        {
            _mm_storeu_pd(&localB->t_k_data[localB->t_k_data_tmp], _mm_sub_pd(_mm_loadu_pd(&T_emission_data
                            [localB->t_k_data_tmp]), _mm_loadu_pd(&Ephemeris_T_oe_data[localB->t_k_data_tmp])));
        }

        for (localB->t_k_data_tmp = localB->scalarLB; localB->t_k_data_tmp < localB->loop_ub_a; localB->t_k_data_tmp++)
        {
            localB->t_k_data[localB->t_k_data_tmp] = T_emission_data[localB->t_k_data_tmp] - Ephemeris_T_oe_data
                [localB->t_k_data_tmp];
        }
    }
    else
    {
        GNSSPreProcessingDualAn_minus_p(localB->t_k_data, localB->t_k_size, T_emission_data, T_emission_size,
            Ephemeris_T_oe_data, Ephemeris_T_oe_size);
    }

    correct_Gps_Time_At_Week_Crosso(localB->t_k_data, localB->t_k_size);
    GN_Get_Kepler_Eccentric_Anomaly(localB->t_k_data, localB->t_k_size, Ephemeris_DELTA_N_data, Ephemeris_DELTA_N_size,
        Ephemeris_M_0_data, Ephemeris_M_0_size, Ephemeris_E_data, Ephemeris_E_size, Ephemeris_SQRT_A_data,
        Ephemeris_SQRT_A_size, localB->sinus_E_k_data, localB->sinus_E_k_size, localB->E_k_Dot_data,
        localB->E_k_Dot_size, localB);
    ...
    {
        std::memcpy(&localB->cosinus_E_k_data[0], &localB->sinus_E_k_data[0], static_cast<uint32_T>(localB->loop_ub_a) *
                    sizeof(real_T));
    }

    GNSSPreProcessingDualAntenn_cos(localB->cosinus_E_k_data, localB->cosinus_E_k_size);
    GNSSPreProcessingDualAntenn_sin(localB->sinus_E_k_data, localB->sinus_E_k_size);
    if (Ephemeris_E_size[1] == localB->cosinus_E_k_size[1])
    {
        ...
        for (localB->t_k_data_tmp = 0; localB->t_k_data_tmp <= localB->vectorUB; localB->t_k_data_tmp += 2)
        {
            ...
            _mm_storeu_pd(&localB->r_k_data[localB->t_k_data_tmp], _mm_mul_pd(_mm_loadu_pd(&Ephemeris_E_data
                            [localB->t_k_data_tmp]), tmp_6));
        }

        for (localB->t_k_data_tmp = localB->scalarLB; localB->t_k_data_tmp < localB->loop_ub_a; localB->t_k_data_tmp++)
        {
            localB->r_k_data[localB->t_k_data_tmp] = Ephemeris_E_data[localB->t_k_data_tmp] * localB->
                cosinus_E_k_data[localB->t_k_data_tmp];
        }
    }
    else
    {
        GNSSPreProcessingDualAn_times_h(localB->r_k_data, localB->r_k_size, Ephemeris_E_data, Ephemeris_E_size,
    ...
    for (localB->t_k_data_tmp = 0; localB->t_k_data_tmp <= localB->vectorUB; localB->t_k_data_tmp += 2)
    {
        ...
        _mm_storeu_pd(&localB->PHI_k_Dot_data[localB->t_k_data_tmp], _mm_sub_pd(_mm_set1_pd(1.0), tmp_6));
    }

    for (localB->t_k_data_tmp = localB->scalarLB; localB->t_k_data_tmp < localB->loop_ub_a; localB->t_k_data_tmp++)
    {
        localB->PHI_k_Dot_data[localB->t_k_data_tmp] = 1.0 - localB->r_k_data[localB->t_k_data_tmp];
    }
    ...
    GNSSPreProcessingDualAnten_sqrt(localB->f_data, localB->f_size, localB);
    if ((localB->f_size[1] != localB->sinus_E_k_size[1]) || ((localB->f_size[1] == 1 ? localB->sinus_E_k_size[1] :
            localB->f_size[1]) != localB->r_k_size[1]) || (localB->cosinus_E_k_size[1] != Ephemeris_E_size[1]) ||
            ((localB->cosinus_E_k_size[1] == 1 ? Ephemeris_E_size[1] : localB->cosinus_E_k_size[1]) != localB->r_k_size
             [1]))
    {
        GNSSPreProc_binary_expand_op_hi(localB->i_k_data, localB->i_k_size, localB->f_data, localB->f_size,
            localB->sinus_E_k_data, localB->sinus_E_k_size, localB->PHI_k_Dot_data, localB->PHI_k_Dot_size,
    ...
    if ((localB->f_size[1] == localB->sinus_E_k_size[1]) && ((localB->f_size[1] == 1 ? localB->sinus_E_k_size[1] :
            localB->f_size[1]) == localB->r_k_size[1]) && (localB->cosinus_E_k_size[1] == Ephemeris_E_size[1]) &&
            ((localB->cosinus_E_k_size[1] == 1 ? Ephemeris_E_size[1] : localB->cosinus_E_k_size[1]) == localB->r_k_size
             [1]) && (localB->i_k_size[1] == Ephemeris_omega_size[1]))
    {
        ...
        for (localB->t_k_data_tmp = 0; localB->t_k_data_tmp <= localB->vectorUB; localB->t_k_data_tmp += 2)
        {
            ...
            _mm_storeu_pd(&localB->sin2PHI_k_data[localB->t_k_data_tmp], _mm_div_pd(_mm_mul_pd(tmp_6, tmp_4), tmp_5));
        }

        for (localB->t_k_data_tmp = localB->scalarLB; localB->t_k_data_tmp < localB->loop_ub_a; localB->t_k_data_tmp++)
        {
            localB->sin2PHI_k_data[localB->t_k_data_tmp] = localB->f_data[localB->t_k_data_tmp] * localB->
                sinus_E_k_data[localB->t_k_data_tmp] / localB->PHI_k_Dot_data[localB->t_k_data_tmp];
        }
        ...
        for (localB->t_k_data_tmp = 0; localB->t_k_data_tmp <= localB->vectorUB; localB->t_k_data_tmp += 2)
        {
            ...
            _mm_storeu_pd(&localB->cos2PHI_k_data[localB->t_k_data_tmp], _mm_div_pd(_mm_sub_pd(tmp_6, _mm_loadu_pd
                            (&Ephemeris_E_data[localB->t_k_data_tmp])), tmp_4));
        }

        for (localB->t_k_data_tmp = localB->scalarLB; localB->t_k_data_tmp < localB->loop_ub_a; localB->t_k_data_tmp++)
        {
            localB->cos2PHI_k_data[localB->t_k_data_tmp] = (localB->cosinus_E_k_data[localB->t_k_data_tmp] -
                Ephemeris_E_data[localB->t_k_data_tmp]) / localB->PHI_k_Dot_data[localB->t_k_data_tmp];
        }

        GNSSPreProcessingDualAnte_atan2(localB->sin2PHI_k_data, localB->sin2PHI_k_size, localB->cos2PHI_k_data,
            localB->cos2PHI_k_size, localB->i_k_data, localB->i_k_size, localB);
        localB->cosinus_E_k_size[0] = 1;
        ...
        for (localB->t_k_data_tmp = 0; localB->t_k_data_tmp <= localB->vectorUB; localB->t_k_data_tmp += 2)
        {
            ...
            _mm_storeu_pd(&localB->cosinus_E_k_data[localB->t_k_data_tmp], _mm_add_pd(tmp_6, _mm_loadu_pd
                           (&Ephemeris_omega_data[localB->t_k_data_tmp])));
        }

        for (localB->t_k_data_tmp = localB->scalarLB; localB->t_k_data_tmp < localB->loop_ub_a; localB->t_k_data_tmp++)
        {
            localB->cosinus_E_k_data[localB->t_k_data_tmp] = localB->i_k_data[localB->t_k_data_tmp] +
                Ephemeris_omega_data[localB->t_k_data_tmp];
        }
    }
    else
    {
        GNSSPreProce_binary_expand_op_m(localB->cosinus_E_k_data, localB->cosinus_E_k_size, localB->f_data,
            localB->f_size, localB->sinus_E_k_data, localB->sinus_E_k_size, localB->PHI_k_Dot_data,
            localB->PHI_k_Dot_size, Ephemeris_E_data, Ephemeris_E_size, Ephemeris_omega_data, Ephemeris_omega_size,
            localB);
    }
    ...
    {
        tmp_6 = _mm_loadu_pd(&localB->cosinus_E_k_data[localB->t_k_data_tmp]);
        _mm_storeu_pd(&localB->i_k_data[localB->t_k_data_tmp], _mm_mul_pd(_mm_set1_pd(2.0), tmp_6));
    }

    for (localB->t_k_data_tmp = localB->scalarLB; localB->t_k_data_tmp < localB->loop_ub_a; localB->t_k_data_tmp++)
    {
        localB->i_k_data[localB->t_k_data_tmp] = 2.0 * localB->cosinus_E_k_data[localB->t_k_data_tmp];
    }
    ...
    if (localB->loop_ub_a - 1 >= 0)
    {
        std::memcpy(&localB->sin2PHI_k_data[0], &localB->i_k_data[0], static_cast<uint32_T>(localB->loop_ub_a) * sizeof
                    (real_T));
    }

    GNSSPreProcessingDualAntenn_sin(localB->sin2PHI_k_data, localB->sin2PHI_k_size);
    localB->cos2PHI_k_size[0] = 1;
    localB->cos2PHI_k_size[1] = localB->cosinus_E_k_size[1];
    localB->loop_ub_a = localB->cosinus_E_k_size[1];
    if (localB->loop_ub_a - 1 >= 0)
    {
        std::memcpy(&localB->cos2PHI_k_data[0], &localB->i_k_data[0], static_cast<uint32_T>(localB->loop_ub_a) * sizeof
                    (real_T));
    }

    GNSSPreProcessingDualAntenn_cos(localB->cos2PHI_k_data, localB->cos2PHI_k_size);
          ...
          : Ephemeris_C_us_size[1]) == localB->cosinus_E_k_size[1]))
    {
        ...
        for (localB->t_k_data_tmp = 0; localB->t_k_data_tmp <= localB->vectorUB; localB->t_k_data_tmp += 2)
        {
            ...
            _mm_storeu_pd(&localB->cosinus_E_k_data[localB->t_k_data_tmp], _mm_add_pd(_mm_add_pd(_mm_mul_pd(_mm_loadu_pd
        ...
        for (localB->t_k_data_tmp = localB->scalarLB; localB->t_k_data_tmp <= localB->loop_ub_a; localB->t_k_data_tmp++)
        {
            localB->cosinus_E_k_data[localB->t_k_data_tmp] += Ephemeris_C_us_data[localB->t_k_data_tmp] *
    ...
    {
        GNSSPreProce_binary_expand_op_l(localB->cosinus_E_k_data, localB->cosinus_E_k_size, Ephemeris_C_us_data,
            Ephemeris_C_us_size, localB->sin2PHI_k_data, localB->sin2PHI_k_size, Ephemeris_C_uc_data,
            Ephemeris_C_uc_size, localB->cos2PHI_k_data, localB->cos2PHI_k_size, localB);
    }
    ...
    if ((Ephemeris_SQRT_A_size[1] == localB->r_k_size[1]) && (Ephemeris_C_rs_size[1] == localB->sin2PHI_k_size[1]) &&
            (Ephemeris_C_rc_size[1] == localB->cos2PHI_k_size[1]) && ((Ephemeris_C_rs_size[1] == 1 ?
            localB->sin2PHI_k_size[1] : Ephemeris_C_rs_size[1]) == (Ephemeris_C_rc_size[1] == 1 ? localB->
            cos2PHI_k_size[1] : Ephemeris_C_rc_size[1])) && (((Ephemeris_C_rs_size[1] == 1 ? localB->sin2PHI_k_size[1] :
           Ephemeris_C_rs_size[1]) == 1 ? Ephemeris_C_rc_size[1] == 1 ? localB->cos2PHI_k_size[1] : Ephemeris_C_rc_size
            [1] : Ephemeris_C_rs_size[1] == 1 ? localB->sin2PHI_k_size[1] : Ephemeris_C_rs_size[1]) ==
            (Ephemeris_SQRT_A_size[1] == 1 ? localB->r_k_size[1] : Ephemeris_SQRT_A_size[1])))
    {
        ...
        for (localB->t_k_data_tmp = localB->scalarLB_tmp; localB->t_k_data_tmp <= localB->loop_ub_a;
                localB->t_k_data_tmp++)
        {
            localB->N = Ephemeris_SQRT_A_data[localB->t_k_data_tmp];
            localB->r_k_data[localB->t_k_data_tmp] = localB->N * localB->N * (1.0 - localB->r_k_data
    ...
    {
        GNSSPreProce_binary_expand_op_c(localB->r_k_data, localB->r_k_size, Ephemeris_SQRT_A_data, Ephemeris_SQRT_A_size,
            Ephemeris_C_rs_data, Ephemeris_C_rs_size, localB->sin2PHI_k_data, localB->sin2PHI_k_size,
            Ephemeris_C_rc_data, Ephemeris_C_rc_size, localB->cos2PHI_k_data, localB->cos2PHI_k_size, localB);
    }
    ...
    if ((Ephemeris_C_is_size[1] == localB->sin2PHI_k_size[1]) && (Ephemeris_C_ic_size[1] == localB->cos2PHI_k_size[1]) &&
        ((Ephemeris_C_is_size[1] == 1 ? localB->sin2PHI_k_size[1] : Ephemeris_C_is_size[1]) == (Ephemeris_C_ic_size[1] ==
          ...
          : Ephemeris_C_is_size[1]) == Ephemeris_I_0_size[1]) && (Ephemeris_IDOT_size[1] == localB->t_k_size[1]) &&
            ...
            Ephemeris_C_is_size[1]) == 1 ? Ephemeris_C_ic_size[1] == 1 ? localB->cos2PHI_k_size[1] :
              ...
              Ephemeris_I_0_size[1]) == (Ephemeris_IDOT_size[1] == 1 ? localB->t_k_size[1] : Ephemeris_IDOT_size[1])))
    {
        localB->i_k_size[0] = 1;
        ...
        for (localB->t_k_data_tmp = localB->scalarLB; localB->t_k_data_tmp < localB->loop_ub_a; localB->t_k_data_tmp++)
        {
            localB->i_k_data[localB->t_k_data_tmp] = ((Ephemeris_C_is_data[localB->t_k_data_tmp] *
                ...
                Ephemeris_IDOT_data[localB->t_k_data_tmp] * localB->t_k_data[localB->t_k_data_tmp];
        }
    }
    else
    {
        GNSSPreProc_binary_expand_op_ap(localB->i_k_data, localB->i_k_size, Ephemeris_I_0_data, Ephemeris_I_0_size,
            ...
            Ephemeris_IDOT_data, Ephemeris_IDOT_size, localB->t_k_data, localB->t_k_size, localB);
    }
    ...
    if ((Ephemeris_OMEGADOT_size[1] == localB->t_k_size[1]) && ((Ephemeris_OMEGADOT_size[1] == 1 ? localB->t_k_size[1] :
          Ephemeris_OMEGADOT_size[1]) == Ephemeris_OMEGA_0_size[1]) && ((Ephemeris_OMEGA_0_size[1] == 1 ?
            Ephemeris_OMEGADOT_size[1] == 1 ? localB->t_k_size[1] : Ephemeris_OMEGADOT_size[1] : Ephemeris_OMEGA_0_size
            [1]) == Ephemeris_T_oe_size[1]))
    {
        ...
        for (localB->t_k_data_tmp = 0; localB->t_k_data_tmp <= localB->vectorUB; localB->t_k_data_tmp += 2)
        {
            ...
            _mm_storeu_pd(&localB->t_k_data[localB->t_k_data_tmp], _mm_sub_pd(_mm_add_pd(_mm_mul_pd(tmp_6, tmp_4),
        ...
        for (localB->t_k_data_tmp = localB->scalarLB; localB->t_k_data_tmp <= localB->loop_ub_a; localB->t_k_data_tmp++)
        {
            localB->t_k_data[localB->t_k_data_tmp] = (localB->f_data[localB->t_k_data_tmp] * localB->t_k_data
    ...
    {
        binary_expand_o_hiccmd4tjww0ixx(localB->t_k_data, localB->t_k_size, Ephemeris_OMEGA_0_data,
    ...
    if (localB->loop_ub_a - 1 >= 0)
    {
        std::memcpy(&localB->cosinus_u_k_data[0], &localB->cosinus_E_k_data[0], static_cast<uint32_T>(localB->loop_ub_a)
                    * sizeof(real_T));
    }

    GNSSPreProcessingDualAntenn_cos(localB->cosinus_u_k_data, localB->cosinus_u_k_size);
    GNSSPreProcessingDualAntenn_sin(localB->cosinus_E_k_data, localB->cosinus_E_k_size);
    localB->cosinus_i_k_size[0] = 1;
    localB->cosinus_i_k_size[1] = localB->i_k_size[1];
    localB->loop_ub_a = localB->i_k_size[1];
    if (localB->loop_ub_a - 1 >= 0)
    {
        std::memcpy(&localB->cosinus_i_k_data[0], &localB->i_k_data[0], static_cast<uint32_T>(localB->loop_ub_a) *
                    sizeof(real_T));
    }

    GNSSPreProcessingDualAntenn_cos(localB->cosinus_i_k_data, localB->cosinus_i_k_size);
    GNSSPreProcessingDualAntenn_sin(localB->i_k_data, localB->i_k_size);
    localB->sinus_lambda_k_size[0] = 1;
    localB->sinus_lambda_k_size[1] = localB->t_k_size[1];
    localB->loop_ub_a = localB->t_k_size[1];
    if (localB->loop_ub_a - 1 >= 0)
    {
        std::memcpy(&localB->sinus_lambda_k_data[0], &localB->t_k_data[0], static_cast<uint32_T>(localB->loop_ub_a) *
                    sizeof(real_T));
    }

    GNSSPreProcessingDualAntenn_sin(localB->sinus_lambda_k_data, localB->sinus_lambda_k_size);
    GNSSPreProcessingDualAntenn_cos(localB->t_k_data, localB->t_k_size);
    ...
    {
        GNSSPreProcessingDualAn_times_h(localB->X_k_tmp_data, localB->X_k_tmp_size, localB->r_k_data, localB->r_k_size,
    ...
    if (localB->r_k_size[1] == localB->cosinus_E_k_size[1])
    {
        ...
        for (localB->t_k_data_tmp = localB->scalarLB; localB->t_k_data_tmp <= localB->loop_ub_a; localB->t_k_data_tmp++)
        {
            localB->r_k_data[localB->t_k_data_tmp] *= localB->cosinus_E_k_data[localB->t_k_data_tmp];
        }
    }
    else
    {
        GNSSPreProcessingDualA_times_hi(localB->r_k_data, localB->r_k_size, localB->cosinus_E_k_data,
    ...
    if (localB->loop_ub_a - 1 >= 0)
    {
        std::memset(&sv_pos_data[0], 0, static_cast<uint32_T>(localB->loop_ub_a) * sizeof(real_T));
    }
    ...
    {
        GNSSPreProcessingDualAn_times_h(localB->c_data, localB->c_size, localB->r_k_data, localB->r_k_size,
            localB->cosinus_i_k_data, localB->cosinus_i_k_size);
    }

    if ((localB->X_k_tmp_size[1] == localB->t_k_size[1]) && (localB->c_size[1] == localB->sinus_lambda_k_size[1]) &&
            ((localB->X_k_tmp_size[1] == 1 ? localB->t_k_size[1] : localB->X_k_tmp_size[1]) == (localB->c_size[1] == 1 ?
          localB->sinus_lambda_k_size[1] : localB->c_size[1])))
    {
        ...
        for (localB->t_k_data_tmp = localB->scalarLB; localB->t_k_data_tmp < localB->loop_ub_a; localB->t_k_data_tmp++)
        {
            sv_pos_data[localB->t_k_data_tmp] = localB->X_k_tmp_data[localB->t_k_data_tmp] * localB->t_k_data
    ...
    {
        binary_expand_op_hiccmd4tjww0ix(sv_pos_data, localB->X_k_tmp_data, localB->X_k_tmp_size, localB->t_k_data,
            localB->t_k_size, localB->c_data, localB->c_size, localB->sinus_lambda_k_data, localB->sinus_lambda_k_size);
    }

    if ((localB->X_k_tmp_size[1] == localB->sinus_lambda_k_size[1]) && (localB->c_size[1] == localB->t_k_size[1]) &&
    ...
    {
        binary_expand_op_hiccmd4tjww0i(sv_pos_data, sv_pos_size, localB->X_k_tmp_data, localB->X_k_tmp_size,
            localB->sinus_lambda_k_data, localB->sinus_lambda_k_size, localB->c_data, localB->c_size, localB->t_k_data,
            localB->t_k_size);
    }
    ...
    {
        GNSSPreProcessingDualAn_times_h(localB->d_data, localB->d_size, localB->r_k_data, localB->r_k_size,
            localB->i_k_data, localB->i_k_size);
    }

    localB->loop_ub_a = sv_pos_size[0];
    for (localB->t_k_data_tmp = 0; localB->t_k_data_tmp < localB->loop_ub_a; localB->t_k_data_tmp++)
    {
    ...
    {
        tmp_6 = _mm_loadu_pd(&Ephemeris_E_data[localB->t_k_data_tmp]);
        _mm_storeu_pd(&localB->g_data[localB->t_k_data_tmp], _mm_sub_pd(_mm_set1_pd(1.0), _mm_mul_pd(tmp_6, tmp_6)));
    }
    ...
    GNSSPreProcessingDualAnten_sqrt(localB->g_data, localB->g_size, localB);
    if ((localB->g_size[1] == localB->E_k_Dot_size[1]) && ((localB->g_size[1] == 1 ? localB->E_k_Dot_size[1] :
            localB->g_size[1]) == localB->PHI_k_Dot_size[1]))
    {
        ...
        for (localB->t_k_data_tmp = localB->scalarLB; localB->t_k_data_tmp <= localB->loop_ub_a; localB->t_k_data_tmp++)
        {
            localB->PHI_k_Dot_data[localB->t_k_data_tmp] = localB->g_data[localB->t_k_data_tmp] * localB->
                E_k_Dot_data[localB->t_k_data_tmp] / localB->PHI_k_Dot_data[localB->t_k_data_tmp];
        }
    }
    else
    {
        G_binary_expand_op_hiccmd4tjww0(localB->PHI_k_Dot_data, localB->PHI_k_Dot_size, localB->g_data, localB->g_size,
          ...
          : Ephemeris_C_us_size[1]) == localB->PHI_k_Dot_size[1]))
    {
        ...
        for (localB->t_k_data_tmp = 0; localB->t_k_data_tmp <= localB->vectorUB; localB->t_k_data_tmp += 2)
        {
            ...
            _mm_storeu_pd(&localB->u_k_Dot_data[localB->t_k_data_tmp], _mm_mul_pd(_mm_sub_pd(_mm_add_pd(_mm_mul_pd
        ...
        for (localB->t_k_data_tmp = localB->scalarLB; localB->t_k_data_tmp < localB->loop_ub_a; localB->t_k_data_tmp++)
        {
            localB->u_k_Dot_data[localB->t_k_data_tmp] = ((2.0 * Ephemeris_C_us_data[localB->t_k_data_tmp] *
    ...
    {
        GN_binary_expand_op_hiccmd4tjww(localB->u_k_Dot_data, localB->u_k_Dot_size, Ephemeris_C_us_data,
            ...
            Ephemeris_SQRT_A_size[1])))
    {
        ...
        for (localB->t_k_data_tmp = 0; localB->t_k_data_tmp <= localB->vectorUB; localB->t_k_data_tmp += 2)
        {
            ...
            _mm_storeu_pd(&localB->sinus_E_k_data[localB->t_k_data_tmp], _mm_add_pd(_mm_mul_pd(_mm_mul_pd(_mm_sub_pd
        ...
        {
            localB->N = Ephemeris_SQRT_A_data[localB->t_k_data_tmp];
            localB->sinus_E_k_data[localB->t_k_data_tmp] = (Ephemeris_C_rs_data[localB->t_k_data_tmp] *
    ...
    {
        GNS_binary_expand_op_hiccmd4tjw(localB->sinus_E_k_data, localB->sinus_E_k_size, Ephemeris_C_rs_data,
    ...
    {
        GNSS_binary_expand_op_hiccmd4tj(localB->cos2PHI_k_data, localB->cos2PHI_k_size, Ephemeris_C_is_data,
    ...
    if ((localB->sinus_E_k_size[1] == localB->cosinus_u_k_size[1]) && (localB->r_k_size[1] == localB->u_k_Dot_size[1]) &&
        ((localB->sinus_E_k_size[1] == 1 ? localB->cosinus_u_k_size[1] : localB->sinus_E_k_size[1]) == (localB->
            r_k_size[1] == 1 ? localB->u_k_Dot_size[1] : localB->r_k_size[1])))
    {
        ...
        for (localB->t_k_data_tmp = localB->scalarLB; localB->t_k_data_tmp <= localB->loop_ub_a; localB->t_k_data_tmp++)
        {
            localB->cosinus_u_k_data[localB->t_k_data_tmp] = localB->sinus_E_k_data[localB->t_k_data_tmp] *
    ...
    {
        GNSSP_binary_expand_op_hiccmd4t(localB->cosinus_u_k_data, localB->cosinus_u_k_size, localB->sinus_E_k_data,
            localB->sinus_E_k_size, localB->r_k_data, localB->r_k_size, localB->u_k_Dot_data, localB->u_k_Dot_size,
            localB);
    }

    if ((localB->sinus_E_k_size[1] == localB->cosinus_E_k_size[1]) && (localB->X_k_tmp_size[1] == localB->u_k_Dot_size[1])
        && ((localB->sinus_E_k_size[1] == 1 ? localB->cosinus_E_k_size[1] : localB->sinus_E_k_size[1]) ==
            (localB->X_k_tmp_size[1] == 1 ? localB->u_k_Dot_size[1] : localB->X_k_tmp_size[1])))
    {
        localB->loop_ub_a = localB->sinus_E_k_size[1] - 1;
        localB->sinus_E_k_size[0] = 1;
        localB->scalarLB = (localB->sinus_E_k_size[1] / 2) << 1;
        ...
        for (localB->t_k_data_tmp = 0; localB->t_k_data_tmp <= localB->vectorUB; localB->t_k_data_tmp += 2)
        {
            ...
            tmp_3 = _mm_loadu_pd(&localB->u_k_Dot_data[localB->t_k_data_tmp]);
            _mm_storeu_pd(&localB->sinus_E_k_data[localB->t_k_data_tmp], _mm_add_pd(_mm_mul_pd(tmp_6, tmp_4), _mm_mul_pd
                           (tmp_5, tmp_3)));
        }

        for (localB->t_k_data_tmp = localB->scalarLB; localB->t_k_data_tmp <= localB->loop_ub_a; localB->t_k_data_tmp++)
        {
            localB->sinus_E_k_data[localB->t_k_data_tmp] = localB->sinus_E_k_data[localB->t_k_data_tmp] *
                localB->cosinus_E_k_data[localB->t_k_data_tmp] + localB->X_k_tmp_data[localB->t_k_data_tmp] *
                localB->u_k_Dot_data[localB->t_k_data_tmp];
        }
    }
    else
    {
        GNSSPr_binary_expand_op_hiccmd4(localB->sinus_E_k_data, localB->sinus_E_k_size, localB->cosinus_E_k_data,
            localB->cosinus_E_k_size, localB->X_k_tmp_data, localB->X_k_tmp_size, localB->u_k_Dot_data,
    ...
    if (localB->loop_ub_a - 1 >= 0)
    {
        std::memset(&sv_vel_data[0], 0, static_cast<uint32_T>(localB->loop_ub_a) * sizeof(real_T));
    }
    ...
    if (localB->sinus_E_k_size[1] == localB->cosinus_i_k_size[1])
    {
        ...
        for (localB->t_k_data_tmp = localB->scalarLB; localB->t_k_data_tmp <= localB->loop_ub_a; localB->t_k_data_tmp++)
        {
            localB->cosinus_i_k_data[localB->t_k_data_tmp] *= localB->sinus_E_k_data[localB->t_k_data_tmp];
        }
    }
    else
    {
        GNSSPreProcessingDualAnte_times(localB->cosinus_i_k_data, localB->cosinus_i_k_size, localB->sinus_E_k_data,
            localB->sinus_E_k_size, localB);
    }

    if ((localB->cosinus_u_k_size[1] == localB->t_k_size[1]) && (localB->cosinus_i_k_size[1] ==
            localB->sinus_lambda_k_size[1]) && ((localB->cosinus_u_k_size[1] == 1 ? localB->t_k_size[1] :
          ...
          == 1 ? localB->sinus_lambda_k_size[1] : localB->d_size[1]) == localB->cos2PHI_k_size[1]) &&
            (((localB->cosinus_u_k_size[1] == 1 ? localB->t_k_size[1] : localB->cosinus_u_k_size[1]) == 1 ?
              localB->cosinus_i_k_size[1] == 1 ? localB->sinus_lambda_k_size[1] : localB->cosinus_i_k_size[1] :
              localB->cosinus_u_k_size[1] == 1 ? localB->t_k_size[1] : localB->cosinus_u_k_size[1]) == ((localB->d_size
            [1] == 1 ? localB->sinus_lambda_k_size[1] : localB->d_size[1]) == 1 ? localB->cos2PHI_k_size[1] :
            localB->d_size[1] == 1 ? localB->sinus_lambda_k_size[1] : localB->d_size[1])) && (sv_pos_size[0] ==
            Ephemeris_OMEGADOT_size[1]) && ((((localB->cosinus_u_k_size[1] == 1 ? localB->t_k_size[1] :
            localB->cosinus_u_k_size[1]) == 1 ? localB->cosinus_i_k_size[1] == 1 ? localB->sinus_lambda_k_size[1] :
            localB->cosinus_i_k_size[1] : localB->cosinus_u_k_size[1] == 1 ? localB->t_k_size[1] :
          ...
          : localB->d_size[1] : (localB->cosinus_u_k_size[1] == 1 ? localB->t_k_size[1] : localB->cosinus_u_k_size[1]) ==
          1 ? localB->cosinus_i_k_size[1] == 1 ? localB->sinus_lambda_k_size[1] : localB->cosinus_i_k_size[1] :
            localB->cosinus_u_k_size[1] == 1 ? localB->t_k_size[1] : localB->cosinus_u_k_size[1]) == (sv_pos_size[0] ==
            1 ? Ephemeris_OMEGADOT_size[1] : sv_pos_size[0])))
    {
        ...
        for (localB->t_k_data_tmp = localB->scalarLB; localB->t_k_data_tmp < localB->loop_ub_a; localB->t_k_data_tmp++)
        {
            ...
            sv_vel_data[localB->t_k_data_tmp] = ((localB->cosinus_u_k_data[localB->t_k_data_tmp] * localB->
                t_k_data[localB->t_k_data_tmp] - localB->cosinus_i_k_data[localB->t_k_data_tmp] * localB->sinus_lambda_k)
                + localB->d_data[localB->t_k_data_tmp] * localB->sinus_lambda_k * localB->cos2PHI_k_data
                [localB->t_k_data_tmp]) - sv_pos_data[localB->t_k_data_tmp + sv_pos_size[0]] * localB->f_data
                [localB->t_k_data_tmp];
        }
    }
    else
    {
        GNSSPre_binary_expand_op_hiccmd(sv_vel_data, localB->cosinus_u_k_data, localB->cosinus_u_k_size,
            localB->t_k_data, localB->t_k_size, localB->cosinus_i_k_data, localB->cosinus_i_k_size,
    ...
    if ((localB->cosinus_u_k_size[1] == localB->sinus_lambda_k_size[1]) && (localB->cosinus_i_k_size[1] ==
            localB->t_k_size[1]) && ((localB->cosinus_u_k_size[1] == 1 ? localB->sinus_lambda_k_size[1] :
            localB->cosinus_u_k_size[1]) == (localB->cosinus_i_k_size[1] == 1 ? localB->t_k_size[1] :
            localB->cosinus_i_k_size[1])) && (localB->d_size[1] == localB->t_k_size[1]) && ((localB->d_size[1] == 1 ?
            localB->t_k_size[1] : localB->d_size[1]) == localB->cos2PHI_k_size[1]) && (((localB->cosinus_u_k_size[1] ==
            1 ? localB->sinus_lambda_k_size[1] : localB->cosinus_u_k_size[1]) == 1 ? localB->cosinus_i_k_size[1] == 1 ?
            localB->t_k_size[1] : localB->cosinus_i_k_size[1] : localB->cosinus_u_k_size[1] == 1 ?
            localB->sinus_lambda_k_size[1] : localB->cosinus_u_k_size[1]) == ((localB->d_size[1] == 1 ? localB->
            t_k_size[1] : localB->d_size[1]) == 1 ? localB->cos2PHI_k_size[1] : localB->d_size[1] == 1 ?
            localB->t_k_size[1] : localB->d_size[1])) && (sv_pos_size[0] == Ephemeris_OMEGADOT_size[1]) &&
            ((((localB->cosinus_u_k_size[1] == 1 ? localB->sinus_lambda_k_size[1] : localB->cosinus_u_k_size[1]) == 1 ?
               localB->cosinus_i_k_size[1] == 1 ? localB->t_k_size[1] : localB->cosinus_i_k_size[1] :
               localB->cosinus_u_k_size[1] == 1 ? localB->sinus_lambda_k_size[1] : localB->cosinus_u_k_size[1]) == 1 ?
              (localB->d_size[1] == 1 ? localB->t_k_size[1] : localB->d_size[1]) == 1 ? localB->cos2PHI_k_size[1] :
              localB->d_size[1] == 1 ? localB->t_k_size[1] : localB->d_size[1] : (localB->cosinus_u_k_size[1] == 1 ?
    ...
    {
        GNSSPreP_binary_expand_op_hiccm(sv_vel_data, sv_vel_size, localB->cosinus_u_k_data, localB->cosinus_u_k_size,
            localB->sinus_lambda_k_data, localB->sinus_lambda_k_size, localB->cosinus_i_k_data, localB->cosinus_i_k_size,
            localB->t_k_data, localB->t_k_size, localB->d_data, localB->d_size, localB->cos2PHI_k_data,
            localB->cos2PHI_k_size, sv_pos_data, sv_pos_size, localB->f_data, localB->f_size, localB);
    }

    if ((localB->sinus_E_k_size[1] == localB->i_k_size[1]) && (localB->c_size[1] == localB->cos2PHI_k_size[1]) &&
            ((localB->sinus_E_k_size[1] == 1 ? localB->i_k_size[1] : localB->sinus_E_k_size[1]) == (localB->c_size[1] ==
          1 ? localB->cos2PHI_k_size[1] : localB->c_size[1])))
    {
        ...
        for (localB->t_k_data_tmp = localB->scalarLB; localB->t_k_data_tmp < localB->loop_ub_a; localB->t_k_data_tmp++)
        {
            sv_vel_data[localB->t_k_data_tmp + (sv_vel_size[0] << 1)] = localB->sinus_E_k_data[localB->t_k_data_tmp] *
    ...
    {
        GNSSPrePr_binary_expand_op_hicc(sv_vel_data, sv_vel_size, localB->sinus_E_k_data, localB->sinus_E_k_size,
    ...
    for (localB->t_k_data_tmp = 0; localB->t_k_data_tmp <= localB->vectorUB; localB->t_k_data_tmp += 2)
    {
        ...
        _mm_storeu_pd(&localB->t_k_data[localB->t_k_data_tmp], _mm_mul_pd(tmp_6, tmp_6));
    }
    ...
    for (localB->t_k_data_tmp = 0; localB->t_k_data_tmp <= localB->vectorUB; localB->t_k_data_tmp += 2)
    {
        ...
        _mm_storeu_pd(&localB->t_k_data[localB->t_k_data_tmp], _mm_add_pd(_mm_add_pd(_mm_mul_pd(tmp_6, tmp_6),
                        _mm_mul_pd(tmp_4, tmp_4)), _mm_mul_pd(tmp_5, tmp_5)));
    }

    for (localB->t_k_data_tmp = localB->scalarLB_tmp; localB->t_k_data_tmp < localB->loop_ub_a; localB->t_k_data_tmp++)
    {
        ...
        localB->varargin_1_f = sv_pos_data[(sv_pos_size[0] << 1) + localB->t_k_data_tmp] - localB->z_user;
        localB->t_k_data[localB->t_k_data_tmp] = (localB->N * localB->N + localB->varargin_1 * localB->varargin_1) +
            localB->varargin_1_f * localB->varargin_1_f;
    }

    GNSSPreProcessingDualAnt_sqrt_h(localB->t_k_data, &localB->transport_angle_size, localB);
    ...
    for (localB->t_k_data_tmp = 0; localB->t_k_data_tmp <= localB->vectorUB; localB->t_k_data_tmp += 2)
    {
        ...
        _mm_storeu_pd(&localB->t_k_data[localB->t_k_data_tmp], _mm_mul_pd(_mm_div_pd(tmp_6, _mm_set1_pd(2.99792458E+8)),
                       _mm_set1_pd(-7.2921151467E-5)));
    }

    for (localB->t_k_data_tmp = localB->scalarLB; localB->t_k_data_tmp < localB->loop_ub_a; localB->t_k_data_tmp++)
    {
        localB->t_k_data[localB->t_k_data_tmp] = localB->t_k_data[localB->t_k_data_tmp] / 2.99792458E+8 *
            -7.2921151467E-5;
    }
    ...
    for (localB->vectorUB = 0; localB->vectorUB < localB->scalarLB; localB->vectorUB++)
    {
        ...
        for (localB->t_k_data_tmp = 0; localB->t_k_data_tmp <= 0; localB->t_k_data_tmp += 2)
        {
            ...
            _mm_storeu_pd(&localB->sv_pos_tmp_j[localB->t_k_data_tmp], _mm_add_pd(_mm_mul_pd(tmp_5, _mm_set1_pd
        ...
        {
            localB->sv_pos_tmp_j[localB->t_k_data_tmp] = sv_pos_data[(sv_pos_size[0] << 1) + localB->vectorUB] *
        ...
        sv_pos_data[localB->vectorUB + (sv_pos_size[0] << 1)] = localB->sv_pos_tmp_j[2];
        for (localB->t_k_data_tmp = 0; localB->t_k_data_tmp <= 0; localB->t_k_data_tmp += 2)
        {
        ...
        for (localB->t_k_data_tmp = 2; localB->t_k_data_tmp < 3; localB->t_k_data_tmp++)
        {
            localB->sv_pos_tmp_j[localB->t_k_data_tmp] = sv_vel_data[(sv_vel_size[0] << 1) + localB->vectorUB] *
        ...
        sv_vel_data[localB->vectorUB + (sv_vel_size[0] << 1)] = localB->sv_pos_tmp_j[2];
    }
}

void GNSSPreProcessingDualAntenna::GNSSPreProce_binary_expand_op_h(real_T in1_data[], int32_T in1_size[2], const real_T
    in2_data[], const int32_T in2_size[2], const real_T in3[330], const gnssops_navigation_data *in4, const
    gnssops_navigation_data_size *in5)
{
    ...
    for (int32_T i_0{0}; i_0 < 3; i_0++)
    {
        for (int32_T i{0}; i < loop_ub; i++)
        {
            in1_data[i + in1_size[0] * i_0] = in3[(static_cast<int32_T>(in4->SVID[i * stride_1_0]) + 110 * i_0) - 1] +
                in2_data[i * stride_0_0 + in2_size[0] * i_0];
        }
    }
}
...
//    '<S32>/Calculate Satellite Position and Velocity'
//    '<S40>/Calculate Satellite Position and Velocity'
//    '<S48>/Calculate Satellite Position and Velocity'
//    '<S81>/Calculate Satellite Position and Velocity'
//    '<S89>/Calculate Satellite Position and Velocity'
//    '<S97>/Calculate Satellite Position and Velocity'
//    '<S105>/Calculate Satellite Position and Velocity'
//    '<S159>/Calculate Satellite Position and Velocity'
//    '<S167>/Calculate Satellite Position and Velocity'
//    '<S175>/Calculate Satellite Position and Velocity'
//    ...
//
void GNSSPreProcessingDualAntenna::CalculateSatellitePositionandVe(real_T rtu_enableSatPosVelCalc, const real_T
    rtu_userPosLlh[3], const gnssops_navigation_data *rtu_GnssNavBus, const gnssops_navigation_data_size
    *rtu_GnssNavBus_DIMS1, const real_T rtu_timeEmissionCorrected[40], const int32_T *rtu_timeEmissionCorrected_DIMS1,
    const real_T rtu_delta_satPosECEF_EGNOS[330], B_CalculateSatellitePositiona_T *localB,
    DW_CalculateSatellitePosition_T *localDW)
{
    if (rtu_enableSatPosVelCalc != 0.0)
    {
        ...
        {
            std::memcpy(&localB->rtu_GnssNavBus_data[0], &rtu_GnssNavBus->C_rs[0], static_cast<uint32_T>(localB->loop_ub)
                        * sizeof(real_T));
        }
        ...
        if (localB->loop_ub - 1 >= 0)
        {
            std::memcpy(&localB->rtu_GnssNavBus_data_d[0], &rtu_GnssNavBus->DELTA_N[0], static_cast<uint32_T>
        ...
        if (localB->loop_ub - 1 >= 0)
        {
            std::memcpy(&localB->rtu_GnssNavBus_data_g[0], &rtu_GnssNavBus->M_0[0], static_cast<uint32_T>
                        (localB->loop_ub) * sizeof(real_T));
        }
        ...
        if (localB->loop_ub - 1 >= 0)
        {
            std::memcpy(&localB->rtu_GnssNavBus_data_l[0], &rtu_GnssNavBus->C_uc[0], static_cast<uint32_T>
                        (localB->loop_ub) * sizeof(real_T));
        }
        ...
        if (localB->loop_ub - 1 >= 0)
        {
            std::memcpy(&localB->rtu_GnssNavBus_data_dh[0], &rtu_GnssNavBus->E[0], static_cast<uint32_T>(localB->loop_ub)
                        * sizeof(real_T));
        }
        ...
        if (localB->loop_ub - 1 >= 0)
        {
            std::memcpy(&localB->rtu_GnssNavBus_data_dy[0], &rtu_GnssNavBus->C_us[0], static_cast<uint32_T>
                        (localB->loop_ub) * sizeof(real_T));
        }
        ...
        if (localB->loop_ub - 1 >= 0)
        {
            std::memcpy(&localB->rtu_GnssNavBus_data_lx[0], &rtu_GnssNavBus->SQRT_A[0], static_cast<uint32_T>
                        (localB->loop_ub) * sizeof(real_T));
        }
        ...
        if (localB->loop_ub - 1 >= 0)
        {
            std::memcpy(&localB->rtu_GnssNavBus_data_o[0], &rtu_GnssNavBus->T_oe[0], static_cast<uint32_T>
                        (localB->loop_ub) * sizeof(real_T));
        }
        ...
        if (localB->loop_ub - 1 >= 0)
        {
            std::memcpy(&localB->rtu_GnssNavBus_data_b[0], &rtu_GnssNavBus->C_ic[0], static_cast<uint32_T>
                        (localB->loop_ub) * sizeof(real_T));
        }
        ...
        if (localB->loop_ub - 1 >= 0)
        {
            std::memcpy(&localB->rtu_GnssNavBus_data_n[0], &rtu_GnssNavBus->OMEGA_0[0], static_cast<uint32_T>
                        (localB->loop_ub) * sizeof(real_T));
        }
        ...
        if (localB->loop_ub - 1 >= 0)
        {
            std::memcpy(&localB->rtu_GnssNavBus_data_bs[0], &rtu_GnssNavBus->C_is[0], static_cast<uint32_T>
                        (localB->loop_ub) * sizeof(real_T));
        }
        ...
        if (localB->loop_ub - 1 >= 0)
        {
            std::memcpy(&localB->rtu_GnssNavBus_data_ln[0], &rtu_GnssNavBus->I_0[0], static_cast<uint32_T>
                        (localB->loop_ub) * sizeof(real_T));
        }
        ...
        if (localB->loop_ub - 1 >= 0)
        {
            std::memcpy(&localB->rtu_GnssNavBus_data_h[0], &rtu_GnssNavBus->C_rc[0], static_cast<uint32_T>
                        (localB->loop_ub) * sizeof(real_T));
        }
        ...
        if (localB->loop_ub - 1 >= 0)
        {
            std::memcpy(&localB->rtu_GnssNavBus_data_bn[0], &rtu_GnssNavBus->omega[0], static_cast<uint32_T>
                        (localB->loop_ub) * sizeof(real_T));
        }
        ...
        if (localB->loop_ub - 1 >= 0)
        {
            std::memcpy(&localB->rtu_GnssNavBus_data_da[0], &rtu_GnssNavBus->OMEGADOT[0], static_cast<uint32_T>
                        (localB->loop_ub) * sizeof(real_T));
        }
        ...
        if (localB->loop_ub - 1 >= 0)
        {
            std::memcpy(&localB->rtu_GnssNavBus_data_e[0], &rtu_GnssNavBus->IDOT[0], static_cast<uint32_T>
                        (localB->loop_ub) * sizeof(real_T));
        }
        ...
        {
            localB->rtu_timeEmissionCorrected_data[localB->i] = rtu_timeEmissionCorrected[localB->i];
        }

        Get_Kepler_Satellite_Position_A(localB->rtu_GnssNavBus_data, localB->rtu_GnssNavBus_size,
            localB->rtu_GnssNavBus_data_d, localB->rtu_GnssNavBus_size_o, localB->rtu_GnssNavBus_data_g,
            localB->rtu_GnssNavBus_size_n, localB->rtu_GnssNavBus_data_l, localB->rtu_GnssNavBus_size_i,
            localB->rtu_GnssNavBus_data_dh, localB->rtu_GnssNavBus_size_oy, localB->rtu_GnssNavBus_data_dy,
            localB->rtu_GnssNavBus_size_nv, localB->rtu_GnssNavBus_data_lx, localB->rtu_GnssNavBus_size_m,
            localB->rtu_GnssNavBus_data_o, localB->rtu_GnssNavBus_size_c, localB->rtu_GnssNavBus_data_b,
            localB->rtu_GnssNavBus_size_md, localB->rtu_GnssNavBus_data_n, localB->rtu_GnssNavBus_size_m3,
            localB->rtu_GnssNavBus_data_bs, localB->rtu_GnssNavBus_size_j, localB->rtu_GnssNavBus_data_ln,
            localB->rtu_GnssNavBus_size_h, localB->rtu_GnssNavBus_data_h, localB->rtu_GnssNavBus_size_c0,
            localB->rtu_GnssNavBus_data_bn, localB->rtu_GnssNavBus_size_ct, localB->rtu_GnssNavBus_data_da,
            localB->rtu_GnssNavBus_size_p, localB->rtu_GnssNavBus_data_e, localB->rtu_GnssNavBus_size_p5,
            localB->rtu_timeEmissionCorrected_data, localB->rtu_timeEmissionCorrected_size, rtu_userPosLlh,
            localB->satPosEcef_data, localB->satPosEcef_size, localB->satVelEcef_data, localB->satVelEcef_size, localB);
        localDW->SFunction_DIMS3[0] = localB->satVelEcef_size[0];
        localDW->SFunction_DIMS3[1] = 3;
        localB->loop_ub = localB->satVelEcef_size[0] * 3;
        if (localB->loop_ub - 1 >= 0)
        {
            std::memcpy(&localB->satVelEcef[0], &localB->satVelEcef_data[0], static_cast<uint32_T>(localB->loop_ub) *
                        sizeof(real_T));
        }
        ...
        if (localB->satPosEcef_size[0] == rtu_GnssNavBus_DIMS1->SVID)
        {
            ...
            {
                for (localB->loop_ub_tmp = 0; localB->loop_ub_tmp < localB->loop_ub; localB->loop_ub_tmp++)
                {
                    localB->tmp_data[localB->loop_ub_tmp + localB->tmp_size[0] * localB->i] =
                        rtu_delta_satPosECEF_EGNOS[(110 * localB->i + static_cast<int32_T>(rtu_GnssNavBus->SVID
                        [localB->loop_ub_tmp])) - 1] + localB->satPosEcef_data[localB->satPosEcef_size[0] * localB->i +
                        localB->loop_ub_tmp];
                }
            }
        }
        ...
        {
            GNSSPreProce_binary_expand_op_h(localB->tmp_data, localB->tmp_size, localB->satPosEcef_data,
                localB->satPosEcef_size, rtu_delta_satPosECEF_EGNOS, rtu_GnssNavBus, rtu_GnssNavBus_DIMS1);
        }
        ...
        if (localB->loop_ub - 1 >= 0)
        {
            std::memcpy(&localB->satPosEcef[0], &localB->tmp_data[0], static_cast<uint32_T>(localB->loop_ub) * sizeof
                        (real_T));
        }
    }
    else
    {
        ...
        {
            std::memset(&localB->satPosEcef[0], 0, static_cast<uint32_T>(localB->loop_ub_tmp) * sizeof(real_T));
        }

        if (localB->loop_ub_tmp - 1 >= 0)
        {
            std::memset(&localB->satVelEcef[0], 0, static_cast<uint32_T>(localB->loop_ub_tmp) * sizeof(real_T));
        }
    }
}
