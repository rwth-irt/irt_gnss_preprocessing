...
// Function for MATLAB Function: '<S76>/Calculate Tropospheric Corrections'
real_T GNSSPreProcessingDualAntenna::GNSSPreProcessingDual_interp1_c(const real_T varargin_1[5], const real_T
    varargin_2[5], real_T varargin_3, B_CalculateTroposphericCorr_k_T *localB)
{
    real_T Vq;
    int32_T low_i;
    Vq = (rtNaN);
...
real_T GNSSPreProcessingDualAntenna::GNSSPreProcessin_rt_powd_snf_ba(real_T u0, real_T u1,
...
// Function for MATLAB Function: '<S76>/Calculate Tropospheric Corrections'
void GNSSPreProcessingDualAntenna::GNSSPreProcessin_expand_power_f(const real_T a_data[], const int32_T *a_size, const
    real_T b_data[], const int32_T *b_size, real_T c_data[], int32_T *c_size, B_CalculateTroposphericCorr_k_T *localB)
{
    int8_T csz_idx_0;
    if (*b_size == 1)
    {
    ...
    *c_size = csz_idx_0;
    if (csz_idx_0 != 0)
    {
        ...
        {
            c_data[k] = GNSSPreProcessin_rt_powd_snf_ba(a_data[d * k], b_data[e * k], localB);
        }
    }
}

void GNSSPreProcessingDualAntenna::GNSSPreProc_binary_expand_op_ob(real_T in1_data[], int32_T *in1_size, const real_T
    ...
    *in5_size, const real_T in6_data[], const int32_T *in6_size, const real_T in7_data[], const int32_T *in7_size, const
    ...
    const int32_T *in11, const real_T in12_data[], const int32_T *in12_size, B_CalculateTroposphericCorr_k_T *localB)
{
...
//    '<S76>/Calculate Tropospheric Corrections'
//    '<S203>/Calculate Tropospheric Corrections'
//
void GNSSPreProcessingDualAntenna::CalculateTroposphericCorrecti_h(real_T rtu_dayOfYear, boolean_T
    rtu_enableTroposphericCorrectio, const real_T rtu_userPos_LLH[3], const real_T rtu_elevationAngle[40], const int32_T
    *rtu_elevationAngle_DIMS1, B_CalculateTroposphericCorr_k_T *localB, DW_CalculateTroposphericCor_o_T *localDW)
{
    ...
    if (rtu_enableTroposphericCorrectio)
    {
                ...
                localB->SFunction_DIMS2_tmp_tmp++)
        {
            ...
            else
            {
                ...
                localB->pressure_data[localB->SFunction_DIMS2_tmp_tmp] = GNSSPreProcessingDual_interp1_c(localB->dv, j,
                    localB->latitude, localB) - GNSSPreProcessingDual_interp1_c(localB->dv1, l, localB->latitude, localB)
                    * localB->cosinus_day;
                for (localB->k = 0; localB->k < 5; localB->k++)
                {
                    localB->d = 15.0 * static_cast<real_T>(localB->k) + 15.0;
                ...
                localB->temperature_data[localB->SFunction_DIMS2_tmp_tmp] = GNSSPreProcessingDual_interp1_c(localB->dv,
                    m, localB->latitude, localB) - GNSSPreProcessingDual_interp1_c(localB->dv1, n, localB->latitude,
                ...
                localB->water_vapour_pressure_data[localB->SFunction_DIMS2_tmp_tmp] = GNSSPreProcessingDual_interp1_c
                    (localB->dv, o, localB->latitude, localB) - GNSSPreProcessingDual_interp1_c(localB->dv1, p,
                ...
                localB->beta_data[localB->SFunction_DIMS2_tmp_tmp] = GNSSPreProcessingDual_interp1_c(localB->dv, q,
                    localB->latitude, localB) - GNSSPreProcessingDual_interp1_c(localB->dv1, r, localB->latitude, localB)
                    * localB->cosinus_day;
                for (localB->k = 0; localB->k < 5; localB->k++)
                {
                    localB->d = 15.0 * static_cast<real_T>(localB->k) + 15.0;
                ...
                localB->lambda_data[localB->SFunction_DIMS2_tmp_tmp] = GNSSPreProcessingDual_interp1_c(localB->dv, s,
                    localB->latitude, localB) - GNSSPreProcessingDual_interp1_c(localB->dv1, t, localB->latitude, localB)
                    * localB->cosinus_day;
            }
        }
        ...
        if (localB->x_tmp_size == localB->b_b_size)
        {
            ...
            {
                localB->d_data[localB->k] = GNSSPreProcessin_rt_powd_snf_ba(localB->x_tmp_data[localB->k],
        ...
        {
            GNSSPreProcessin_expand_power_f(localB->x_tmp_data, &localB->x_tmp_size, localB->b_b_data, &localB->b_b_size,
        ...
        {
            GNSSPreProc_binary_expand_op_ob(localB->pressure_data, &localB->pressure_size, localB->troposphericDelay,
