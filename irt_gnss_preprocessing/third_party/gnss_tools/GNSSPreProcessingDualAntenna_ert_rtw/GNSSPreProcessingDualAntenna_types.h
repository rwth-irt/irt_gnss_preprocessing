...
//
// File: GNSSPreProcessingDualAntenna_types.h
//
...
//
#ifndef RTW_HEADER_GNSSPreProcessingDualAntenna_types_h_
#define RTW_HEADER_GNSSPreProcessingDualAntenna_types_h_
#include "rtwtypes.h"
...
// Custom Type definition for MATLAB Function: '<S17>/Simplify and Mask GPS Measurement Bus'
...
// Custom Type definition for MATLAB Function: '<S5>/Merge GNSS Measurement'
...
// Custom Type definition for MATLAB Function: '<S3>/calculate double diff'
#ifndef struct_sk7S3MUBNIp13xZwazKdzDD_GNSSP_T
#define struct_sk7S3MUBNIp13xZwazKdzDD_GNSSP_T

struct sk7S3MUBNIp13xZwazKdzDD_GNSSP_T
{
    real_T TOW[50];
    real_T PR[2000];
    real_T DR[2000];
...
#endif                                 // struct_sk7S3MUBNIp13xZwazKdzDD_GNSSP_T
#endif                                 // RTW_HEADER_GNSSPreProcessingDualAntenna_types_h_
