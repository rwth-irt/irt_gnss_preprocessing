...
//
// File: ApplyDifferentialCorrectionMask.h
//
...
//
#ifndef RTW_HEADER_ApplyDifferentialCorrectionMask_h_
#define RTW_HEADER_ApplyDifferentialCorrectionMask_h_
#include "rtwtypes.h"
#include "GNSSPreProcessingSingleAntenna_types.h"

// Block signals for system '<S55>/Apply Differential Correction Mask1'
struct B_ApplyDifferentialCorrection_T {
  GNSS_Measurement GPS_measurement_Bus_masked;
                                 // '<S55>/Apply Differential Correction Mask1'
};

// Block states (default storage) for system '<S55>/Apply Differential Correction Mask1' 
struct DW_ApplyDifferentialCorrectio_T {
  GNSS_Measurement_size SFunction_DIMS2;
                                 // '<S55>/Apply Differential Correction Mask1'
};

#endif                         // RTW_HEADER_ApplyDifferentialCorrectionMask_h_
