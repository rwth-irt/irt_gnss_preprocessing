...
// Function for MATLAB Function: '<S23>/Calculate Differential Corrections'
void GNSS_preprocessingModelClass::GNSSPreProcessingSingleAn_merge(int32_T
...
// Function for MATLAB Function: '<S23>/Calculate Differential Corrections'
void GNSS_preprocessingModelClass::GNSSPreProcessingSingleAnt_sort(uint16_T
      ...
      if (vwork_size_idx_0 > 1) {
        ...
        while (nLeft > 1) {
          if ((static_cast<uint32_T>(nLeft) & 1U) != 0U) {
            ...
            if (b_i > nDone) {
              GNSSPreProcessingSingleAn_merge(b_idx_data, b_x_data, i1, nDone,
          ...
          nLeft >>= 1;
          for (i1 = 0; i1 < nLeft; i1++) {
            GNSSPreProcessingSingleAn_merge(b_idx_data, b_x_data, i1 * b_i,
        ...
        if (vwork_size_idx_0 > nDone) {
          GNSSPreProcessingSingleAn_merge(b_idx_data, b_x_data, 0, nDone,
...
// Function for MATLAB Function: '<S23>/Calculate Differential Corrections'
void GNSS_preprocessingModelClass::GNSSPreProcessingSin_do_vectors(const
...
void GNSS_preprocessingModelClass::GNSSP_binary_expand_op_gd41yrno(real_T
...
void GNSS_preprocessingModelClass::GNSSPreProcessingSingl_minus_pc(real_T
  in1_data[], int32_T in1_size[2], const real_T in2_data[], const int32_T
...
void GNSS_preprocessingModelClass::GNSSPr_binary_expand_op_gd41yrn(real_T
  in1_data[], int32_T in1_size[2], const real_T in2_data[], const int32_T
...
void GNSS_preprocessingModelClass::GNSSPre_binary_expand_op_gd41yr(real_T
  in1_data[], int32_T in1_size[2], const real_T in2_data[], const int32_T
  in2_size[2], const real_T in3_data[], const int32_T in3_size[2])
{
  int32_T loop_ub;
...
// Function for MATLAB Function: '<S23>/Calculate Differential Corrections'
boolean_T GNSS_preprocessingModelClass::GNSSPreProcessingSingleAnte_any(const
...
void GNSS_preprocessingModelClass::GNSSPreProce_binary_expand_op_g(real_T
  in1_data[], int32_T in1_size[2], const real_T in2_data[], const int32_T
  in2_size[2], const real_T in3_data[], const int32_T in3_size[2])
{
  real_T in2_data_0[37];
...
void GNSS_preprocessingModelClass::GNSSPreProcessingSingle_minus_p(real_T
  in1_data[], int32_T in1_size[2], const real_T in2_data[], const int32_T
  in2_size[2])
{
  real_T in2_data_0[37];
...
void GNSS_preprocessingModelClass::GNSSPreP_binary_expand_op_gd41y(real_T
...
// Function for MATLAB Function: '<S23>/Calculate Differential Corrections'
void GNSS_preprocessingModelClass::correct_Gps_Time_At_Week_Cros_l(real_T
...
void GNSS_preprocessingModelClass::GNSSPreProcessingSingleA_plus_l(real_T
  in1_data[], int32_T in1_size[2], const real_T in2_data[], const int32_T
  in2_size[2])
{
...
void GNSS_preprocessingModelClass::GNSSPreProce_binary_expand_op_i(real_T
  in1_data[], int32_T in1_size[2], const real_T in2_data[], const int32_T
  in2_size[2], const real_T in3_data[], const int32_T in3_size[2], const real_T
  in4_data[], const int32_T in4_size[2])
{
...
void GNSS_preprocessingModelClass::GNSSPreProc_binary_expand_op_ki(real_T
  in1_data[], int32_T in1_size[2], const real_T in2_data[], const int32_T
  in2_size[2], const real_T in3_data[], const int32_T in3_size[2])
{
  real_T in1_data_0[37];
...
// Function for MATLAB Function: '<S23>/Calculate Differential Corrections'
void GNSS_preprocessingModelClass::Get_Kepler_Eccentric_Anomaly_m(const real_T
  ...
  real_T E_k_Dot_data[], int32_T E_k_Dot_size[2])
{
  ...
  if (Ephemeris_SQRT_A_size[1] == Ephemeris_DELTA_N_size[1]) {
    ...
    GNSSPreProcessingSingleA_plus_l(E_k_Dot_data, E_k_Dot_size,
  ...
  if ((E_k_Dot_size[1] == t_k_size[1]) && ((E_k_Dot_size[1] == 1 ? t_k_size[1] :
    ...
    GNSSPreProce_binary_expand_op_i(M_k_data, M_k_size, Ephemeris_M_0_data,
  ...
  if ((Ephemeris_E_size[1] == M_k_size[1]) && ((Ephemeris_E_size[1] == 1 ?
    ...
    GNSSPre_binary_expand_op_gd41yr(E_k_data, E_k_size, Ephemeris_E_data,
  ...
  do {
    ...
    if (GNSSPreProcessingSingleAnte_any(eps_data_0, eps_size) && (i < 20)) {
      E_k_old_size[0] = 1;
      ...
      if ((Ephemeris_E_size[1] == E_k_size[1]) && ((Ephemeris_E_size[1] == 1 ?
        ...
        GNSSPreProce_binary_expand_op_g(E_k_data, E_k_size, M_k_data, M_k_size,
      ...
      if (E_k_size[1] == E_k_old_size[1]) {
        ...
        GNSSPreProcessingSingle_minus_p(E_k_old_data, E_k_old_size, E_k_data,
          E_k_size);
      }
  ...
  if ((Ephemeris_E_size[1] == E_k_size[1]) && ((Ephemeris_E_size[1] == 1 ?
    ...
    GNSSPreProc_binary_expand_op_ki(E_k_Dot_data, E_k_Dot_size, Ephemeris_E_data,
      Ephemeris_E_size, M_k_data, M_k_size);
  }
}

// Function for MATLAB Function: '<S23>/Calculate Differential Corrections'
void GNSS_preprocessingModelClass::GNSSPreProcessingSingleAn_cos_p(real_T
...
// Function for MATLAB Function: '<S23>/Calculate Differential Corrections'
void GNSS_preprocessingModelClass::GNSSPreProcessingSingleAn_sin_a(real_T
  x_data[], const int32_T x_size[2])
{
  int32_T b;
  b = x_size[1];
...
void GNSS_preprocessingModelClass::GNSSPreProcessingSingl_times_iy(real_T
  in1_data[], int32_T in1_size[2], const real_T in2_data[], const int32_T
  in2_size[2], const real_T in3_data[], const int32_T in3_size[2])
{
  int32_T loop_ub;
...
// Function for MATLAB Function: '<S23>/Calculate Differential Corrections'
void GNSS_preprocessingModelClass::GNSSPreProcessingSingleA_sqrt_h(real_T
  x_data[], const int32_T x_size[2])
{
  int32_T b;
  int32_T scalarLB;
...
// Function for MATLAB Function: '<S23>/Calculate Differential Corrections'
void GNSS_preprocessingModelClass::GNSSPreProcessin_expand_atan2_i(const real_T
...
// Function for MATLAB Function: '<S23>/Calculate Differential Corrections'
void GNSS_preprocessingModelClass::GNSSPreProcessingSingle_atan2_e(const real_T
  ...
  x_size[2], real_T r_data[], int32_T r_size[2])
{
  if (y_size[1] == x_size[1]) {
    ...
    GNSSPreProcessin_expand_atan2_i(y_data, y_size, x_data, x_size, r_data,
      r_size);
  }
}

void GNSS_preprocessingModelClass::GNSS_binary_expand_op_gd41yrnol(real_T
  in1_data[], int32_T in1_size[2], const real_T in2_data[], const int32_T
  in2_size[2], const real_T in3_data[], const int32_T in3_size[2], const real_T
  ...
  in5_size[2], const real_T in6_data[], const int32_T in6_size[2])
{
  ...
  GNSSPreProcessingSingle_atan2_e(in2_data_0, in2_size_0, in5_data_0, in5_size_0,
    in1_data, in1_size);
}

void GNSS_preprocessingModelClass::GNSSPreProc_binary_expand_op_hr(real_T
  in1_data[], int32_T in1_size[2], const real_T in2_data[], const int32_T
  in2_size[2], const real_T in3_data[], const int32_T in3_size[2], const real_T
  in4_data[], const int32_T in4_size[2], const real_T in5_data[], const int32_T
...
void GNSS_preprocessingModelClass::GNSSPreProc_binary_expand_op_hw(real_T
  in1_data[], int32_T in1_size[2], const real_T in2_data[], const int32_T
  in2_size[2], const real_T in3_data[], const int32_T in3_size[2], const real_T
  in4_data[], const int32_T in4_size[2], const real_T in5_data[], const int32_T
  in5_size[2])
...
void GNSS_preprocessingModelClass::GNSSPreProce_binary_expand_op_m(real_T
  in1_data[], int32_T in1_size[2], const real_T in2_data[], const int32_T
  in2_size[2], const real_T in3_data[], const int32_T in3_size[2], const real_T
  in4_data[], const int32_T in4_size[2], const real_T in5_data[], const int32_T
  in5_size[2], const real_T in6_data[], const int32_T in6_size[2], const real_T
...
void GNSS_preprocessingModelClass::GNSSPreProc_binary_expand_op_ap(real_T
  in1_data[], int32_T in1_size[2], const real_T in2_data[], const int32_T
  in2_size[2], const real_T in3_data[], const int32_T in3_size[2], const real_T
  in4_data[], const int32_T in4_size[2], const real_T in5_data[], const int32_T
  in5_size[2], const real_T in6_data[], const int32_T in6_size[2], const real_T
...
void GNSS_preprocessingModelClass::GNSSPrePro_binary_expand_op_a30(real_T
  in1_data[], int32_T in1_size[2], const real_T in2_data[], const int32_T
  in2_size[2], const real_T in3_data[], const int32_T in3_size[2], const real_T
  in4_data[], const int32_T in4_size[2])
{
...
void GNSS_preprocessingModelClass::GNSSPreProcessingSing_times_iyg(real_T
  in1_data[], int32_T in1_size[2], const real_T in2_data[], const int32_T
  in2_size[2])
{
  real_T in1_data_0[37];
...
void GNSS_preprocessingModelClass::GNSSPreProc_binary_expand_op_pq(real_T
...
void GNSS_preprocessingModelClass::GNSSPreProce_binary_expand_op_j(real_T
...
void GNSS_preprocessingModelClass::GNSSPreProce_binary_expand_op_d(real_T
  in1_data[], int32_T in1_size[2], const real_T in2_data[], const int32_T
  in2_size[2], const real_T in3_data[], const int32_T in3_size[2])
{
  real_T in1_data_0[37];
...
void GNSS_preprocessingModelClass::GNSSPreProc_binary_expand_op_c3(real_T
  in1_data[], int32_T in1_size[2], const real_T in2_data[], const int32_T
  in2_size[2], const real_T in3_data[], const int32_T in3_size[2], const real_T
  in4_data[], const int32_T in4_size[2], const real_T in5_data[], const int32_T
  in5_size[2], const real_T in6_data[], const int32_T in6_size[2])
...
void GNSS_preprocessingModelClass::GNSSPreProce_binary_expand_op_k(real_T
  in1_data[], int32_T in1_size[2], const real_T in2_data[], const int32_T
  in2_size[2], const real_T in3_data[], const int32_T in3_size[2], const real_T
  in4_data[], const int32_T in4_size[2], const real_T in5_data[], const int32_T
  in5_size[2], const real_T in6_data[], const int32_T in6_size[2], const real_T
...
void GNSS_preprocessingModelClass::GNSSPreProce_binary_expand_op_p(real_T
  in1_data[], int32_T in1_size[2], const real_T in2_data[], const int32_T
  in2_size[2], const real_T in3_data[], const int32_T in3_size[2], const real_T
  in4_data[], const int32_T in4_size[2], const real_T in5_data[], const int32_T
  in5_size[2], const real_T in6_data[], const int32_T in6_size[2])
...
void GNSS_preprocessingModelClass::binary_expand_o_gd41yrnolhmfymc(real_T
  in1_data[], int32_T in1_size[2], const real_T in2_data[], const int32_T
  in2_size[2], const real_T in3_data[], const int32_T in3_size[2], const real_T
  in4_data[], const int32_T in4_size[2])
{
...
void GNSS_preprocessingModelClass::binary_expand_op_gd41yrnolhmfym(real_T
  in1_data[], int32_T in1_size[2], const real_T in2_data[], const int32_T
  in2_size[2], const real_T in3_data[], const int32_T in3_size[2], const real_T
  in4_data[], const int32_T in4_size[2])
{
...
void GNSS_preprocessingModelClass::GNSSPreProcessingSingle_times_i(real_T
  in1_data[], int32_T in1_size[2], const real_T in2_data[], const int32_T
  in2_size[2])
{
  real_T in2_data_0[37];
...
void GNSS_preprocessingModelClass::binary_expand_op_gd41yrnolhmfy(real_T
  in1_data[], const real_T in2_data[], const int32_T in2_size[2], const real_T
  in3_data[], const int32_T in3_size[2], const real_T in4_data[], const int32_T
...
void GNSS_preprocessingModelClass::G_binary_expand_op_gd41yrnolhmf(real_T
  in1_data[], const int32_T in1_size[2], const real_T in2_data[], const int32_T
  in2_size[2], const real_T in3_data[], const int32_T in3_size[2], const real_T
  in4_data[], const int32_T in4_size[2], const real_T in5_data[], const int32_T
  in5_size[2], const real_T in6_data[], const int32_T in6_size[2], const real_T
...
void GNSS_preprocessingModelClass::GN_binary_expand_op_gd41yrnolhm(real_T
  in1_data[], const int32_T in1_size[2], const real_T in2_data[], const int32_T
  in2_size[2], const real_T in3_data[], const int32_T in3_size[2], const real_T
  in4_data[], const int32_T in4_size[2], const real_T in5_data[], const int32_T
  in5_size[2])
...
// Function for MATLAB Function: '<S23>/Calculate Differential Corrections'
void GNSS_preprocessingModelClass::GNSSPreProcessingSingle_sqrt_hf(real_T
...
// Function for MATLAB Function: '<S23>/Calculate Differential Corrections'
void GNSS_preprocessingModelClass::Get_Kepler_Satellite_Position_g(const real_T
  ...
  sv_vel_data[], int32_T sv_vel_size[2])
{
  ...
  if (T_emission_size[1] == Ephemeris_T_oe_size[1]) {
    ...
    GNSSPreProcessingSingl_minus_pc(t_k_data, t_k_size, T_emission_data,
      T_emission_size, Ephemeris_T_oe_data, Ephemeris_T_oe_size);
  }

  correct_Gps_Time_At_Week_Cros_l(t_k_data, t_k_size);
  Get_Kepler_Eccentric_Anomaly_m(t_k_data, t_k_size, Ephemeris_DELTA_N_data,
  ...
  GNSSPreProcessingSingleAn_cos_p(cosinus_E_k_data, cosinus_E_k_size);
  GNSSPreProcessingSingleAn_sin_a(sinus_E_k_data, sinus_E_k_size);
  if (Ephemeris_E_size[1] == cosinus_E_k_size[1]) {
    ...
    GNSSPreProcessingSingl_times_iy(r_k_Dot_data, r_k_Dot_size, Ephemeris_E_data,
  ...
  GNSSPreProcessingSingleA_sqrt_h(f_data, f_size);
  if ((f_size[1] != sinus_E_k_size[1]) || ((f_size[1] == 1 ? sinus_E_k_size[1] :
    ...
    GNSS_binary_expand_op_gd41yrnol(tmp_data, tmp_size, f_data, f_size,
  ...
  if ((f_size[1] == sinus_E_k_size[1]) && ((f_size[1] == 1 ? sinus_E_k_size[1] :
    ...
    GNSSPreProcessingSingle_atan2_e(PHI_k_data, PHI_k_size, f_data, f_size,
      tmp_data, tmp_size);
    PHI_k_size[0] = 1;
    ...
    GNSSPreProc_binary_expand_op_hr(PHI_k_data, PHI_k_size, f_data, f_size,
      sinus_E_k_data, sinus_E_k_size, y_tmp_data, y_tmp_size, cosinus_E_k_data,
  ...
  GNSSPreProcessingSingleAn_sin_a(sin2PHI_k_data, sin2PHI_k_size);
  cos2PHI_k_size[0] = 1;
  ...
  GNSSPreProcessingSingleAn_cos_p(cos2PHI_k_data, cos2PHI_k_size);
  if ((Ephemeris_C_us_size[1] == sin2PHI_k_size[1]) && (Ephemeris_C_uc_size[1] ==
    ...
    GNSSPreProc_binary_expand_op_hw(PHI_k_data, PHI_k_size, Ephemeris_C_us_data,
  ...
  if ((Ephemeris_SQRT_A_size[1] == r_k_Dot_size[1]) && (Ephemeris_C_rs_size[1] ==
    ...
    GNSSPreProce_binary_expand_op_m(r_k_data, r_k_size, Ephemeris_SQRT_A_data,
          ...
          (Ephemeris_IDOT_size[1] == 1 ? t_k_size[1] : Ephemeris_IDOT_size[1])))
  {
    ...
    GNSSPreProc_binary_expand_op_ap(i_k_data, i_k_size, Ephemeris_I_0_data,
  ...
  if ((Ephemeris_OMEGADOT_size[1] == t_k_size[1]) && ((Ephemeris_OMEGADOT_size[1]
    ...
    GNSSPrePro_binary_expand_op_a30(t_k_data, t_k_size, Ephemeris_OMEGA_0_data,
  ...
  GNSSPreProcessingSingleAn_cos_p(cosinus_u_k_data, cosinus_u_k_size);
  GNSSPreProcessingSingleAn_sin_a(PHI_k_data, PHI_k_size);
  ...
  GNSSPreProcessingSingleAn_cos_p(cosinus_i_k_data, cosinus_i_k_size);
  GNSSPreProcessingSingleAn_sin_a(i_k_data, i_k_size);
  ...
  GNSSPreProcessingSingleAn_sin_a(sinus_lambda_k_data, sinus_lambda_k_size);
  GNSSPreProcessingSingleAn_cos_p(t_k_data, t_k_size);
  if (r_k_size[1] == cosinus_u_k_size[1]) {
    ...
    GNSSPreProcessingSingl_times_iy(X_k_tmp_data, X_k_tmp_size, r_k_data,
  ...
  if (r_k_size[1] == PHI_k_size[1]) {
    ...
    GNSSPreProcessingSing_times_iyg(r_k_data, r_k_size, PHI_k_data, PHI_k_size);
  }
  ...
  if (r_k_size[1] == cosinus_i_k_size[1]) {
    ...
    GNSSPreProcessingSingl_times_iy(c_data, c_size, r_k_data, r_k_size,
  ...
  if ((X_k_tmp_size[1] == t_k_size[1]) && (c_size[1] == sinus_lambda_k_size[1]) &&
    ...
    GNSSPreProc_binary_expand_op_pq(sv_pos_data, X_k_tmp_data, X_k_tmp_size,
  ...
  if ((X_k_tmp_size[1] == sinus_lambda_k_size[1]) && (c_size[1] == t_k_size[1]) &&
    ...
    GNSSPreProce_binary_expand_op_j(sv_pos_data, sv_pos_size, X_k_tmp_data,
  ...
  if (r_k_size[1] == i_k_size[1]) {
    ...
    GNSSPreProcessingSingl_times_iy(d_data, d_size, r_k_data, r_k_size, i_k_data,
      i_k_size);
  }
  ...
  GNSSPreProcessingSingleA_sqrt_h(PHI_k_Dot_data, PHI_k_Dot_size);
  if ((PHI_k_Dot_size[1] == E_k_Dot_size[1]) && ((PHI_k_Dot_size[1] == 1 ?
    ...
    GNSSPreProce_binary_expand_op_d(PHI_k_Dot_data, PHI_k_Dot_size, E_k_Dot_data,
  ...
  if ((Ephemeris_C_us_size[1] == cos2PHI_k_size[1]) && (Ephemeris_C_uc_size[1] ==
    ...
    GNSSPreProc_binary_expand_op_c3(cosinus_E_k_data, cosinus_E_k_size,
  ...
  if ((Ephemeris_C_rs_size[1] == cos2PHI_k_size[1]) && (Ephemeris_C_rc_size[1] ==
    ...
    GNSSPreProce_binary_expand_op_k(r_k_Dot_data, r_k_Dot_size,
  ...
  if ((Ephemeris_C_is_size[1] == cos2PHI_k_size[1]) && (Ephemeris_C_ic_size[1] ==
    ...
    GNSSPreProce_binary_expand_op_p(cos2PHI_k_data, cos2PHI_k_size,
        ...
        r_k_Dot_size[1]) == (r_k_size[1] == 1 ? cosinus_E_k_size[1] : r_k_size[1])))
  {
    ...
    binary_expand_o_gd41yrnolhmfymc(cosinus_u_k_data, cosinus_u_k_size,
  ...
  if ((r_k_Dot_size[1] == PHI_k_size[1]) && (X_k_tmp_size[1] ==
    ...
    binary_expand_op_gd41yrnolhmfym(r_k_Dot_data, r_k_Dot_size, PHI_k_data,
  ...
  if (r_k_Dot_size[1] == cosinus_i_k_size[1]) {
    ...
    GNSSPreProcessingSingle_times_i(cosinus_i_k_data, cosinus_i_k_size,
  ...
  if ((cosinus_u_k_size[1] == t_k_size[1]) && (cosinus_i_k_size[1] ==
    ...
    binary_expand_op_gd41yrnolhmfy(sv_vel_data, cosinus_u_k_data,
  ...
  if ((cosinus_u_k_size[1] == sinus_lambda_k_size[1]) && (cosinus_i_k_size[1] ==
    ...
    G_binary_expand_op_gd41yrnolhmf(sv_vel_data, sv_vel_size, cosinus_u_k_data,
  ...
  if ((r_k_Dot_size[1] == i_k_size[1]) && (c_size[1] == cos2PHI_k_size[1]) &&
    ...
    GN_binary_expand_op_gd41yrnolhm(sv_vel_data, sv_vel_size, r_k_Dot_data,
  ...
  GNSSPreProcessingSingle_sqrt_hf(t_k_data, &transport_angle_size);
...
void GNSS_preprocessingModelClass::GNSSPrePr_binary_expand_op_gd41(const
  ...
  in13_size[2])
{
  ...
  Get_Kepler_Satellite_Position_g(in1_data, in1_size, in4_data, in4_size,
...
void GNSS_preprocessingModelClass::GNSSPrePro_binary_expand_op_gd4(real_T
...
void GNSS_preprocessingModelClass::GNSSPreProc_binary_expand_op_gd(real_T
  in1_data[], int32_T *in1_size, const real_T in2_data[], const int32_T
  in2_size[2])
{
...
// System initialize for atomic system: '<S23>/Calculate Differential Corrections'
void GNSS_preprocessingModelClass::CalculateDifferentialCorre_Init
...
// Output and update for atomic system: '<S23>/Calculate Differential Corrections'
void GNSS_preprocessingModelClass::CalculateDifferentialCorrection(const
  GNSS_Measurement *rtu_GpsMeasurementB, const GNSS_Measurement_size
  *rtu_GpsMeasurementB_DIMS1, const gnssops_navigation_data *rtu_gpsNavDataBusL1,
  ...
  DW_CalculateDifferentialCorre_T *localDW)
{
  ...
  if ((rtu_GpsMeasurementB->time_receive > localDW->old_t) ||
    ...
    if (rtu_GpsMeasurementB_DIMS1->PRN - 1 >= 0) {
      std::memcpy(&a_data[0], &rtu_GpsMeasurementB->PRN[0], static_cast<uint32_T>
                  (rtu_GpsMeasurementB_DIMS1->PRN) * sizeof(uint16_T));
    }

    GNSSPreProcessingSingleAnt_sort(a_data, &rtu_GpsMeasurementB_DIMS1->PRN,
      iidx_data, &iidx_size);
    GNSSPreProcessingSin_do_vectors(a_data, &rtu_GpsMeasurementB_DIMS1->PRN,
    ...
    for (int32_T k{0}; k < iidx_size; k++) {
      b_data[k] = rtu_GpsMeasurementB->pseudorange[iidx_data[k] - 1];
    }

    t_sv_emission_size[0] = 1;
    t_sv_emission_size[1] = iia_size;
    for (int32_T k{0}; k < iia_size; k++) {
      t_sv_emission_data[k] = rtu_GpsMeasurementB->time_receive -
    ...
    if (iib_size == iia_size) {
      ...
      GNSSP_binary_expand_op_gd41yrno(t_d_data, t_d_size, t_sv_emission_data,
    ...
    if (iia_size == iib_size) {
      ...
      GNSSPreProcessingSingl_minus_pc(t_k_data, t_k_size, t_sv_emission_data,
    ...
    if ((iib_size == t_k_size[1]) && ((iib_size == 1 ? t_k_size[1] : iib_size) ==
      ...
      GNSSPr_binary_expand_op_gd41yrn(n_0_data, n_0_size, navdata_M_0_data,
    ...
    if ((iib_size == n_0_size[1]) && ((iib_size == 1 ? n_0_size[1] : iib_size) ==
      ...
      GNSSPre_binary_expand_op_gd41yr(E_k_data, E_k_size, navdata_E_data,
    ...
    do {
      ...
      if (GNSSPreProcessingSingleAnte_any(t_k_data_0, t_k_size_0) && (i < 20)) {
        E_k_old_size[0] = 1;
        E_k_old_size[1] = E_k_size[1];
        vstride = E_k_size[1];
        if (vstride - 1 >= 0) {
        ...
        if ((navdata_E_size[1] == E_k_size[1]) && ((navdata_E_size[1] == 1 ?
          ...
          GNSSPreProce_binary_expand_op_g(E_k_data, E_k_size, n_0_data, n_0_size,
          ...
          [1] : iib_size : iib_size) == (iib_size == 1 ? E_k_size[1] : iib_size)))
    {
      ...
      GNSSPreP_binary_expand_op_gd41y(t_d_data, t_d_size, rtu_gpsNavDataBusL1,
    ...
    if (iia_size == t_d_size[1]) {
      ...
      Get_Kepler_Satellite_Position_g(E_k_data, E_k_size, navdata_DELTA_N_data,
      ...
      GNSSPrePr_binary_expand_op_gd41(rtu_gpsNavDataBusL1, real_range_data,
      ...
      for (int32_T k{0}; k < 3; k++) {
        ...
        for (iidx_size = 0; iidx_size <= i; iidx_size++) {
          real_delta_data[iidx_size + real_delta_size[0] * k] = b_a_data[acoef *
            iidx_size + t_k_size_0[0] * k] - rtu_GpsMeasurementB->
            base_position[k];
        }
      }
    }
    ...
    if (iia_size == iib_size) {
      ...
      GNSSPrePro_binary_expand_op_gd4(localDW->delta_pr2.data,
    ...
    if (localDW->delta_pr2.size == t_d_size[1]) {
      ...
      GNSSPreProc_binary_expand_op_gd(localDW->delta_pr2.data,
