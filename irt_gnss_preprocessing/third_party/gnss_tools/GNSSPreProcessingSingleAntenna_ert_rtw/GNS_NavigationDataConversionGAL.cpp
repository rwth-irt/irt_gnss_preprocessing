...
// Output and update for atomic system: '<S12>/Navigation Data Conversion GAL'
void GNSS_preprocessingModelClass::GNS_NavigationDataConversionGAL(const
  gnssraw_gal_nav_t *rtu_GAL_NAV_raw_Bus, B_NavigationDataConversionGAL_T
  *localB, DW_NavigationDataConversionGA_T *localDW)
{
  __m128d tmp;
  __m128d tmp_0;
